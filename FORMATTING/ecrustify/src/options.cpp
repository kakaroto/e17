...
static map<ecrustify_groups, group_map_value> group_map;
static ecrustify_groups current_group;
...
void unc_begin_group(ecrustify_groups id, const char *short_desc,
...
void unc_add_option(const char *name, ecrustify_options id, argtype_e type,
...
void register_options(void)
{
   ...
   unc_add_option("indent_brace_width", UO_indent_brace_width, AT_BOOL,
                  "Whether to indent an additional space for the width of a brace");
   ...
   unc_add_option("align_func_proto_star_style", UO_align_func_proto_star_style, AT_NUM,
                  "Controls the positioning of the '*' in function prototypes. Just try it.\n"
                  "0: Align on function type, ignore '*'\n"
                  "1: The '*' is part of function name: int  *pint(X);\n"
                  "2: The '*' is part of the function, but dangling: int *pint(X);", "", 0, 2);
