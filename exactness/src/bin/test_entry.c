...
TEST_START(test_entry_scrolled)
{
   Evas_Object *bg, *bx, *bx2, *bt, *en, *en_p, *sp;
...
TEST_START(test_entry4)
{
   Evas_Object *bg, *ly, *en;
   char buf[PATH_MAX];
...
TEST_START(test_entry_notepad)
{
   Evas_Object *bg, *bx, *bx2, *bt, *np;
