...
clean_caches(ImlibData * id)
{
	...
	fprintf(stderr, "--------- Image cashe zise %i / %i with %i images referenced\n",
	...
	while (ptr)
	  {
	     fprintf(stderr, "Image for file %80s REFNUM %3i SIZE %4ix%4i\n",
	...
	fprintf(stderr, "*** total image's in cache %i with %i images\n",
		total, num);
	fprintf(stderr, "*** total unreffed images's in cache %i with %i images\n\n",
		total2, num2);
#endif
	...
	fprintf(stderr, "--------- Pixmap cashe zise %i / %i with %i pixmaps referenced\n",
	...
	while (ptr)
	  {
	     fprintf(stderr, 
		     "Pmap for file %100s REFNUM %3i SIZE %4ix%4i PMAP %8x MASK %8x DIRTY %i\n",
		     ptr->file, ptr->refnum, ptr->width, ptr->height, ptr->pmap,
		     ptr->shape_mask, ptr->dirty);
	     if (ptr->refnum > 0)
	       {
	...
	fprintf(stderr, "Accounting Data:\n");
	fprintf(stderr, "*** total pixmap's in cache %i with %i pixmaps\n",
		total, num);
	fprintf(stderr, "*** total unreffed pixmap's in cache %i with %i pixmaps\n\n",
		total2, num2);
#endif
	ptr = id->cache.pixmap;
	while (ptr)
