...
__ACLASS __BGN
  __NAME DESKBINDINGS
  __TYPE __TYPE_NORMAL
  __TOOLTIP_TEXT "Klikniêcie mysz± na tym Pulpicie spowoduje"
  __TOOLTIP_TEXT "wykonanie nastêpuj±cych operacji"
  ...
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Wy¶wietlenie Menu U¿ytkownika"
    __EVENT __MOUSE_PRESS
    __BUTTON 1
    __MODIFIER_KEY __CTRL
    __ACTION __A_SHOW_MENU "named ROOT_2"
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Wy¶wietlenie Menu Ustawieñ"
    __EVENT __MOUSE_PRESS
    __BUTTON 1
    __MODIFIER_KEY __WINDOWS_KEY
    __ACTION __A_SHOW_MENU "named CONFIG_SUBMENU"
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Wy¶wietlenie Menu Enlightenment"
    __EVENT __MOUSE_PRESS
    __BUTTON 2
    __MODIFIER_KEY __NONE
    __ACTION __A_SHOW_MENU "named ROOT_2"
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Wy¶wietlenia Menu Listy Zadañ"
    __EVENT __MOUSE_PRESS
    __BUTTON 2
    __MODIFIER_KEY __ALT
    __ACTION __A_SHOW_MENU "taskmenu"
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Wy¶wietlenie Menu Pulpitu"
    __EVENT __MOUSE_PRESS
    __BUTTON 2
    __MODIFIER_KEY __CTRL
    __ACTION __A_SHOW_MENU "deskmenu"
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Wy¶wietlenie Menu Grupy"
    __EVENT __MOUSE_PRESS
    __BUTTON 2
  ...
  __NEXT_ACTION
    ...
    __ACTION __A_SHOW_MENU "named CONFIG_SUBMENU"
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Przej¶cie do poprzedniego Pulpitu"
    __EVENT __MOUSE_PRESS
    __BUTTON 4
    __ALLOW_ANY_MODIFIER_KEYS __ON
    __ACTION __A_DESKTOP_PREV
  __NEXT_ACTION
    __TOOLTIP_ACTION_TEXT "Przej¶cie do nastêpnego Pulpitu"
    __EVENT __MOUSE_PRESS
    __BUTTON 5
    __ALLOW_ANY_MODIFIER_KEYS __ON
