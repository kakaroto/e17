...
CommsFindCommsWindow()
{
   ...
   if (a != None)
	...
	if (comms_win)
	  {
	     if (!EGetGeometry(disp, comms_win, &rt, &dint, &dint,
		...
		lst[i]->client.icon_name = none;
	     if (lst[i]->border)
		  ...
		  Esnprintf(buf, sizeof(buf),
			    ...
			    lst[i]->client.w,
			    lst[i]->client.h,
			    lst[i]->client.icon_win,
			    lst[i]->client.icon_pmap,
			    lst[i]->client.icon_mask,
			    lst[i]->client.group,
			    lst[i]->client.need_input,
			    lst[i]->client.transient,
			    lst[i]->client.title,
			    lst[i]->client.class,
			    lst[i]->client.name,
			    lst[i]->client.command,
			    lst[i]->client.machine,
			    lst[i]->client.icon_name,
			    lst[i]->client.is_group_leader,
			    lst[i]->client.no_resize_h,
			    lst[i]->client.no_resize_v,
			    lst[i]->client.shaped,
			    lst[i]->client.width.min,
			    lst[i]->client.height.min,
			    lst[i]->client.width.max,
			    lst[i]->client.height.max,
			    lst[i]->client.base_w,
			    lst[i]->client.base_h,
			    lst[i]->client.w_inc,
			    lst[i]->client.h_inc,
