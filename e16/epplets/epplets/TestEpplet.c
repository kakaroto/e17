...
cb_timer(void *data)
{
   ...
   if (val)
      Epplet_change_image(im, 24, 24, 
			  "/usr/share/pixmaps/gnome-term.png");
   else
      Epplet_change_image(im, 24, 24, 
...
main(int argc, char **argv)
{
   ...
   Epplet_gadget_show(sl2 = Epplet_create_vslider(42, 2, 60, 
						  ...
						  &val2, 
						  NULL, NULL));
   Epplet_gadget_show(prog1 = Epplet_create_vbar(50, 2, 8, 60,
						 0, &val3));
   Epplet_gadget_show(prog2 = Epplet_create_hbar(58, 2, 40, 8,
						 0, &val3));
   Epplet_gadget_show(prog3 = Epplet_create_vbar(90, 12, 8, 40,
						 1, &val3));
   Epplet_gadget_show(prog4 = Epplet_create_hbar(58, 54, 40, 8,
						 1, &val3));
   ...
   Epplet_gadget_show(Epplet_create_button(NULL, NULL, 
					   ...
					   NULL, NULL));
   Epplet_gadget_show(Epplet_create_button(NULL, NULL, 
					   122, 26, 0, 0, "REWIND", 0, NULL, 
					   NULL, NULL));
   Epplet_gadget_show(Epplet_create_button(NULL, NULL, 
					   122, 38, 0, 0, "REPEAT", 0, NULL, 
					   NULL, NULL));
   Epplet_gadget_show(Epplet_create_button(NULL, NULL, 
					   122, 50, 0, 0, "SKIP", 0, NULL, 
					   NULL, NULL));
   Epplet_gadget_show(Epplet_create_button(NULL, NULL, 
					   134, 2, 0, 0, "HELP", 0, NULL, 
					   NULL, NULL));
   Epplet_gadget_show(Epplet_create_button(NULL, NULL, 
					   134, 14, 0, 0, "CONFIGURE", 0, NULL, 
					   NULL, NULL));
