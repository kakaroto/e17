...
static void _menu_dismiss_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);
static void _collection_del_cb(void        *data,
                               Evas_Object *obj,
                               void        *event_info);

Collection_Menu *
collection_menu_new(Evas_Object      *parent,
                    Enlil_Collection *col)
{
   ...
   elm_menu_item_add(menu, NULL, NULL, D_("Delete the collection"), _collection_del_cb, cm);
