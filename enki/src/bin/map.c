...
static void _mouse_wheel_cb(void        *data,
                            Evas        *e,
                            Evas_Object *obj,
                            void        *event_info);

static Evas_Object *_marker_get(Evas_Object    *obj,
                                Elm_Map_Marker *marker,
                                void           *data);
static Evas_Object *_gp_marker_get(Evas_Object    *obj,
                                   Elm_Map_Marker *marker,
                                   void           *data);
static Evas_Object *_gp_marker_icon_get(Evas_Object    *obj,
                                        Elm_Map_Marker *marker,
                                        void           *data);
static Evas_Object *_gp_group_icon_get(Evas_Object *obj,
                                       void        *data);
...
static void _photo_select_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);
static void _menu(void        *data,
                  Evas_Object *obj,
                  void        *event_info);
static void _tg_geocaching_changed_cb(void        *data,
                                      Evas_Object *obj,
                                      void        *event_info);
static void _tg_photos_changed_cb(void        *data,
                                  Evas_Object *obj,
                                  void        *event_info);
static void _bt_geocaching_cb(void        *data,
                              Evas_Object *obj,
                              void        *event_info);
...
static Evas_Object *
_gp_marker_get(Evas_Object    *obj,
               Elm_Map_Marker *marker,
               void           *data)
{
   char buf[PATH_MAX];
...
static Evas_Object *
_gp_marker_icon_get(Evas_Object    *obj,
                    Elm_Map_Marker *marker,
                    void           *data)
{
   char buf[PATH_MAX];
...
static void
_tg_geocaching_changed_cb(void        *data,
                          Evas_Object *obj,
                          void        *event_info)
{
   Map *map = data;
...
static void
_tg_photos_changed_cb(void        *data,
                      Evas_Object *obj,
                      void        *event_info)
{
   Map *map = data;
