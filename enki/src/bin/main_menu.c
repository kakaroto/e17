...
static char *_library_get(void        *data,
                          Evas_Object *obj,
                          const char  *part);
static void         _library_del(void        *data,
                                 Evas_Object *obj);
static Evas_Object *_library_icon_get(void        *data,
                                      Evas_Object *obj,
                                      const char  *part);

static void _library_select(void        *data,
                            Evas_Object *obj,
                            void        *event_info);
static void _new_library();
static void _new_library_done_cb(void        *data,
                                 Evas_Object *obj,
                                 void        *event_info);
...
static void _slideshow_cb(void        *data,
                          Evas_Object *obj,
                          void        *event_info);
static void _album_new_cb(void        *data,
                          Evas_Object *obj,
                          void        *event_info);
static void _import_cb(void        *data,
                       Evas_Object *obj,
                       void        *event_info);
static void _del_bg_cb(void        *data,
                       Evas_Object *obj,
                       void        *event_info);
...
static void _geocaching_import_done_cb(void        *data,
                                       Evas_Object *obj,
                                       void        *event_info);
static void _preferences_cb(void        *data,
                            Evas_Object *obj,
                            void        *event_info);
static void _quit_cb(void        *data,
                     Evas_Object *obj,
                     void        *event_info);
static void _sync_cb(void        *data,
                     Evas_Object *obj,
                     void        *event_info);
...
static void
_new_library_done_cb(void        *data,
                     Evas_Object *obj,
                     void        *event_info)
{
...
static void
_geocaching_import_cb(void        *data,
                      Evas_Object *obj,
                      void        *event_info)
{
   Evas_Object *fs, *vbox;
...
static void
_geocaching_import_done_cb(void        *data,
                           Evas_Object *obj,
                           void        *event_info)
{
   const char *selected = event_info;
