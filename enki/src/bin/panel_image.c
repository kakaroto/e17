...
static void _bt_menu_undo_open_cb(void *data, Evas_Object *obj, void *event_info);
static void _bt_menu_redo_open_cb(void *data, Evas_Object *obj, void *event_info);
