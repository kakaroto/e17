...
static void
_tabpanel_select_page1_cb(void          *data,
                          Tabpanel      *tabpanel,
                          Tabpanel_Item *item)
{
...
static void
_photos_list_select_cb(void          *data,
                       Tabpanel      *tabpanel,
                       Tabpanel_Item *item)
{
   Enlil_Data *enlil_data = data;
...
static void
_panes_clicked_double(void        *data,
                      Evas_Object *obj,
                      void        *event_info)
{
...
void
sync_status_show(Enlil_Data *enlil_data,
                 const char *msg,
                 Eina_Bool   loading)
{
   if(loading)
...
void
loading_status_show(Enlil_Data *enlil_data,
                    const char *msg,
                    Eina_Bool   loading)
{
   if(loading)
...
void
enlil_album_data_free(Enlil_Album *album,
                      void        *_data)
{
...
void
enlil_photo_data_free(Enlil_Photo *photo,
                      void        *_data)
{
...
void
enlil_collection_data_free(Enlil_Collection *col,
                           void             *_data)
{
...
void
enlil_tag_data_free(Enlil_Tag *tag,
                    void      *_data)
{
...
void
enlil_geocaching_data_free(Enlil_Geocaching *gp,
                           void             *_data)
{
