...
static void _fs_selected_cb(void *data, Evas_Object *obj, void *event_info);
static Evas_Object *_icon_get(const void *data, Evas_Object *obj);

static void _import_thumb_done_cb(void *data, Enlil_Photo *photo, const char *file);
static void _import_thumb_error_cb(void *data, Enlil_Photo *photo);

void _import_photo_data_free(Enlil_Photo *photo, void *_data);

static void _bt_select_all_cb(void *data, Evas_Object *obj, void *event_info);
