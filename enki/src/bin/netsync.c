...
void
netsync_album_header_get_cb(void          *data,
...
void
netsync_album_new_cb(void          *data,
                     Enlil_Library *library,
                     int            album_id)
{
...
void
netsync_album_netsyncnotuptodate_cb(void          *data,
                                    Enlil_Library *library,
                                    Enlil_Album   *album)
{
...
void
netsync_album_notuptodate_cb(void          *data,
                             Enlil_Library *library,
                             Enlil_Album   *album)
{
   Enlil_Album_Data *album_data = enlil_album_user_data_get(album);
...
void
netsync_album_notinnetsync_cb(void          *data,
                              Enlil_Library *library,
                              Enlil_Album   *album)
{
   Enlil_Album_Data *album_data = enlil_album_user_data_get(album);
...
void
netsync_album_uptodate_cb(void          *data,
                          Enlil_Library *library,
                          Enlil_Album   *album)
{
   Enlil_Album_Data *album_data = enlil_album_user_data_get(album);
...
void
netsync_photo_new_cb(void        *data,
                     Enlil_Album *album,
                     int          id)
{
...
void
netsync_photo_notinnetsync_cb(void        *data,
                              Enlil_Album *album,
                              Enlil_Photo *photo)
{
...
void
netsync_photo_notuptodate_cb(void        *data,
                             Enlil_Album *album,
                             Enlil_Photo *photo)
{
   Enlil_Photo_Data *photo_data = enlil_photo_user_data_get(photo);
...
void
netsync_photo_netsyncnotuptodate_cb(void        *data,
                                    Enlil_Album *album,
                                    Enlil_Photo *photo)
{
   Enlil_Photo_Data *photo_data = enlil_photo_user_data_get(photo);
...
void
netsync_photo_uptodate_cb(void        *data,
                          Enlil_Album *album,
                          Enlil_Photo *photo)
{
   Enlil_Photo_Data *photo_data = enlil_photo_user_data_get(photo);
...
void
netsync_photo_tags_notuptodate_cb(void        *data,
                                  Enlil_Album *album,
                                  Enlil_Photo *photo)
{
   Enlil_Photo_Data *photo_data = enlil_photo_user_data_get(photo);
...
void
netsync_photo_tags_netsyncnotuptodate_cb(void        *data,
                                         Enlil_Album *album,
                                         Enlil_Photo *photo)
{
   Enlil_Photo_Data *photo_data = enlil_photo_user_data_get(photo);
...
void
netsync_photo_tags_uptodate_cb(void        *data,
                               Enlil_Album *album,
                               Enlil_Photo *photo)
{
   Enlil_Photo_Data *photo_data = enlil_photo_user_data_get(photo);
...
void
netsync_album_error_cb(void        *data,
                       Enlil_Album *album)
{
   printf("ALBUM ERROR \n");
}
...
void
netsync_photo_error_cb(void        *data,
                       Enlil_Photo *photo)
{
...
void
netsync_job_start_cb(void              *data,
...
void
netsync_login_failed_cb(void       *data,
                        const char *username,
                        const char *password)
{
...
void
netsync_job_error_cb(void              *data,
                     Enlil_NetSync_Job *job,
                     Enlil_Album       *album,
                     Enlil_Photo       *photo,
                     const char        *error)
{
   ...
   if(album)
     prefix = "Synchronization of an album";
   if(photo)
     prefix = "Synchronization of a photo";
   if(!album && !photo)
