...
static void _tag_photo_add_cb(void        *data,
                              Evas_Object *obj,
                              void        *event_info);
static void _tag_photo_remove_cb(void        *data,
                                 Evas_Object *obj,
                                 void        *event_info);
static void _tag_new_cb(void        *data,
                        Evas_Object *obj,
                        void        *event_info);
...
static void _photo_exif_reload_cb(void        *data,
                                  Evas_Object *obj,
                                  void        *event_info);
static void _photo_move_album_cb(void        *data,
                                 Evas_Object *obj,
                                 void        *event_info);
static void _photo_move_album_list_cb(void        *data,
                                      Evas_Object *obj,
                                      void        *event_info);
static void _wall_app_set_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);
static void _library_photo1_set_cb(void        *data,
                                   Evas_Object *obj,
                                   void        *event_info);
static void _library_photo2_set_cb(void        *data,
                                   Evas_Object *obj,
                                   void        *event_info);
...
void
photo_menu_init(List_Photo  *enlil_photo,
                Evas_Object *edje)
{
   Evas_Object *bt;
   ...
   if(!_init)
     {
        _init = EINA_TRUE;
        bt = edje_object_part_external_object_get(edje, "object.photo_menu.tools.reload_thumb");
        evas_object_smart_callback_add(bt, "clicked", _photo_thumb_reload_cb, enlil_photo);

        bt = edje_object_part_external_object_get(edje, "object.photo_menu.tools.reload_exifs");
        evas_object_smart_callback_add(bt, "clicked", _photo_exif_reload_cb, enlil_photo);

        bt = edje_object_part_external_object_get(edje, "object.photo_menu.tools.reload_iptcs");
        evas_object_smart_callback_add(bt, "clicked", _photo_iptc_reload_cb, enlil_photo);

        bt = edje_object_part_external_object_get(edje, "object.photo_menu.wallpaper.application");
        evas_object_smart_callback_add(bt, "clicked", _wall_app_set_cb, enlil_photo);

        bt = edje_object_part_external_object_get(edje, "object.photo_menu.delete");
        evas_object_smart_callback_add(bt, "clicked", _photo_delete_cb, enlil_photo);

        bt = edje_object_part_external_object_get(edje, "object.photo_menu.album.move");
        evas_object_smart_callback_add(bt, "clicked", _photo_move_album_list_cb, enlil_photo);

        bt = edje_object_part_external_object_get(edje, "object.photo_menu.library.photo.front");
        evas_object_smart_callback_add(bt, "clicked", _library_photo1_set_cb, enlil_photo);

        bt = edje_object_part_external_object_get(edje, "object.photo_menu.library.photo.back");
        evas_object_smart_callback_add(bt, "clicked", _library_photo2_set_cb, enlil_photo);
     }

   //tags to remove
   bt = edje_object_part_external_object_get(edje, "object.photo_menu.tags_remove.list");
   elm_list_clear(bt);
   ...
   if(empty)
     elm_list_item_append(bt, D_("No tags"), NULL, NULL, NULL, NULL);
   elm_list_go(bt);
   //

   //add tags
   bt = edje_object_part_external_object_get(edje, "object.photo_menu.tags_add.list");
   elm_list_clear(bt);
...
static void
_tag_photo_remove_cb(void        *data,
                     Evas_Object *obj,
                     void        *event_info)
{
   List_Photo *enlil_photo = data;
...
static void
_photo_move_album_list_cb(void        *data,
                          Evas_Object *obj,
                          void        *event_info)
{
   List_Photo *enlil_photo = data;
...
static void
_library_photo1_set_cb(void        *data,
                       Evas_Object *obj,
                       void        *event_info)
{
   List_Photo *enlil_photo = data;
...
static void
_library_photo2_set_cb(void        *data,
                       Evas_Object *obj,
                       void        *event_info)
{
   List_Photo *enlil_photo = data;
