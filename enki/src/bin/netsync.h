...
void netsync_job_error_cb(void *data, Enlil_NetSync_Job* job, Enlil_Album *album, Enlil_Photo *photo, const char *error);
...
void netsync_album_notuptodate_cb(void *data, Enlil_Library *root, Enlil_Album *album);
void netsync_album_notinnetsync_cb(void *data, Enlil_Library *root, Enlil_Album *album);
void netsync_album_uptodate_cb(void *data, Enlil_Library *root, Enlil_Album *album);

void netsync_photo_known_cb(void *data, Enlil_Album *album, Enlil_Photo *photo);

void netsync_album_error_cb(void *data, Enlil_Album *album);

void netsync_photos_notinlocal_sizes_get_cb(void *data, Eina_List *sizes, Eina_Bool error);
