...
static void _netsync_notuptodate_cb(void *data, Evas_Object *obj, void *event_info);
...
static void _album_notinnetsync_cb(void *data, Evas_Object *obj, void *event_info);
static void _photos_notinnetsync_cb(void *data, Evas_Object *obj, void *event_info);
...
Evas_Object *netsync_album_new(Evas_Object *win, Enlil_Album *album)
{
