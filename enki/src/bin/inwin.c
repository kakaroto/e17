...
static void _bt_library_delete_cancel_cb(void *data, Evas_Object *obj, void *event_info);
static void _bt_library_delete_apply_cb(void *data, Evas_Object *obj, void *event_info);
