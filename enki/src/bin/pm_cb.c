...
void
sync_album_update_cb(void          *data,
                     Enlil_Sync    *sync,
                     Enlil_Library *library,
                     Enlil_Album   *album)
{
...
void
sync_album_disappear_cb(void          *data,
                        Enlil_Sync    *sync,
                        Enlil_Library *library,
                        Enlil_Album   *album)
{
...
void
sync_photo_update_cb(void        *data,
                     Enlil_Sync  *sync,
                     Enlil_Album *album,
                     Enlil_Photo *photo)
{
...
void
sync_photo_disappear_cb(void        *data,
                        Enlil_Sync  *sync,
                        Enlil_Album *album,
                        Enlil_Photo *photo)
{
...
void
monitor_album_new_cb(void          *data,
                     Enlil_Library *library,
                     const char    *path)
{
   Enlil_Data *enlil_data = (Enlil_Data *)data;
...
void
monitor_album_update_cb(void          *data,
                        Enlil_Library *library,
                        Enlil_Album   *album)
{
   Enlil_Data *enlil_data = (Enlil_Data *)data;
...
void
monitor_album_delete_cb(void          *data,
                        Enlil_Library *library,
                        const char    *path)
{
   Enlil_Data *enlil_data = (Enlil_Data *)data;
...
void
monitor_enlil_delete_cb(void          *data,
                        Enlil_Library *library)
{
   printf("Enlil delete !!!\n");
}
...
void
monitor_photo_new_cb(void          *data,
                     Enlil_Library *library,
                     Enlil_Album   *album,
                     const char    *path)
{
...
void
monitor_photo_delete_cb(void          *data,
                        Enlil_Library *library,
                        Enlil_Album   *album,
                        const char    *path)
{
...
void
monitor_photo_update_cb(void          *data,
                        Enlil_Library *library,
                        Enlil_Album   *album,
                        const char    *path)
{
...
void
collection_delete_cb(void             *data,
                     Enlil_Library    *library,
                     Enlil_Collection *col)
{
   //Enlil_Data *enlil_data = data;
...
void
collection_album_new_cb(void             *data,
                        Enlil_Library    *library,
                        Enlil_Collection *col,
                        Enlil_Album      *album)
{
...
void
collection_album_delete_cb(void             *data,
                           Enlil_Library    *library,
                           Enlil_Collection *col,
                           Enlil_Album      *album)
{
...
static Eina_Bool
_geocaching_foreach_cb(const Eina_Hash *hash,
                       const void      *key,
                       void            *data,
                       void            *fdata)
{
...
static Eina_Bool
_geocaching_remove_marker_foreach_cb(const Eina_Hash *hash,
                                     const void      *key,
                                     void            *data,
                                     void            *fdata)
{
...
void
geocaching_remove_marker_cb(void      *data,
                            Eina_Hash *db)
{
...
void
album_version_header_increase_cb(void        *data,
                                 Enlil_Album *album)
{
   //Enlil_NetSync_Job *job =
...
void
photo_version_header_increase_cb(void        *data,
                                 Enlil_Photo *photo)
{
...
void
photo_version_tags_increase_cb(void        *data,
                               Enlil_Photo *photo)
{
   Enlil_NetSync_Job *job = enlil_netsync_job_sync_photos_append(enlil_photo_album_get(photo),
                                                                 netsync_photo_new_cb,
