...
static char *_gl_label_get(void        *data,
                           Evas_Object *obj,
                           const char  *part);
static void _gl_sel(void        *data,
                    Evas_Object *obj,
                    void        *event_info);
static void _right_click_cb(void        *data,
                            Evas        *e,
                            Evas_Object *obj,
                            void        *event_info);

static char *_gl_col_label_get(void        *data,
                               Evas_Object *obj,
                               const char  *part);
static void _gl_col_sel(void        *data,
                        Evas_Object *obj,
                        void        *event_info);
static char *_gl_col_album_label_get(void        *data,
                                     Evas_Object *obj,
                                     const char  *part);
static void _gl_col_album_sel(void        *data,
                              Evas_Object *obj,
                              void        *event_info);
static void _col_right_click_cb(void        *data,
                                Evas        *e,
                                Evas_Object *obj,
                                void        *event_info);

static void _gl_col_exp(void        *data,
                        Evas_Object *obj,
                        void        *event_info);
static void _gl_col_con(void        *data,
                        Evas_Object *obj,
                        void        *event_info);
static void _gl_col_exp_req(void        *data,
                            Evas_Object *obj,
                            void        *event_info);
static void _gl_col_con_req(void        *data,
                            Evas_Object *obj,
                            void        *event_info);

static char *_gl_tag_label_get(void        *data,
                               Evas_Object *obj,
                               const char  *part);
static void _gl_tag_sel(void        *data,
                        Evas_Object *obj,
                        void        *event_info);
static void _tag_right_click_cb(void        *data,
                                Evas        *e,
                                Evas_Object *obj,
                                void        *event_info);

static void _tabpanel_album_select_cb(void          *data,
                                      Tabpanel      *tabpanel,
                                      Tabpanel_Item *item);
static void _tabpanel_collection_select_cb(void          *data,
                                           Tabpanel      *tabpanel,
                                           Tabpanel_Item *item);
static void _tabpanel_tag_select_cb(void          *data,
                                    Tabpanel      *tabpanel,
                                    Tabpanel_Item *item);

static void _library_delete_cb(void        *data,
                               Evas_Object *obj,
                               void        *event_info);
...
void
list_left_data_set(List_Left  *list_left,
...
void
list_left_add(List_Left   *list_left,
              Enlil_Album *album)
{
...
void
list_left_append_relative(List_Left        *list_left,
                          Enlil_Album      *album,
...
void
list_left_col_add(List_Left        *list_left,
...
void
list_left_col_album_add(List_Left        *list_left,
                        Enlil_Collection *col,
                        Enlil_Album      *album)
{
...
void
list_left_tag_add(List_Left *list_left,
                  Enlil_Tag *tag)
{
...
void
list_left_col_album_remove(List_Left        *list_left,
                           Enlil_Collection *col,
                           Enlil_Album      *album)
{
   Eina_List *l;
...
void
list_left_remove(List_Left   *list_left,
                 Enlil_Album *album)
{
   Enlil_Album_Data *enlil_album_data = enlil_album_user_data_get(album);
...
void
list_left_update(List_Left   *list_left,
                 Enlil_Album *album)
{
   Enlil_Album_Data *enlil_album_data = enlil_album_user_data_get(album);
...
static void
_tabpanel_album_select_cb(void          *data,
                          Tabpanel      *tabpanel,
                          Tabpanel_Item *item)
{
...
static void
_tabpanel_tag_select_cb(void          *data,
                        Tabpanel      *tabpanel,
                        Tabpanel_Item *item)
{
   List_Left *list_left = data;
...
static void
_tabpanel_collection_select_cb(void          *data,
                               Tabpanel      *tabpanel,
                               Tabpanel_Item *item)
{
   List_Left *list_left = data;
...
static char *
_gl_col_album_label_get(void        *data,
                        Evas_Object *obj,
                        const char  *part)
{
