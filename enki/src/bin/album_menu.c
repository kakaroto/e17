...
static void _menu_dismiss_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);
static void _collection_album_add_cb(void        *data,
                                     Evas_Object *obj,
                                     void        *event_info);
static void _collection_album_remove_cb(void        *data,
                                        Evas_Object *obj,
                                        void        *event_info);
static void _collection_new_cb(void        *data,
                               Evas_Object *obj,
                               void        *event_info);

static void _tag_album_add_cb(void        *data,
                              Evas_Object *obj,
                              void        *event_info);
static void _tag_album_remove_cb(void        *data,
                                 Evas_Object *obj,
                                 void        *event_info);
...
static void _album_rename_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);
static void _album_exifs_reload_cb(void        *data,
                                   Evas_Object *obj,
                                   void        *event_info);
static void _album_iptcs_reload_cb(void        *data,
                                   Evas_Object *obj,
                                   void        *event_info);
static void _album_delete_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);

static void _sort_by_name_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);
static void _sort_by_date_cb(void        *data,
                             Evas_Object *obj,
                             void        *event_info);
...
Album_Menu *
album_menu_new(Evas_Object *parent,
               Enlil_Album *album)
{
   Evas_Object *menu;
   ...
   if(enlil_album_collections_get(album))
     {
        ...
        mi = elm_menu_item_add(menu, NULL, NULL, D_("Remove from the collection"), NULL, NULL);
     }
   ...
   mi = elm_menu_item_add(menu, NULL, NULL, D_("Add to the collection"), NULL, NULL);
   ...
   elm_menu_item_separator_add(menu, NULL);
   mi = elm_menu_item_add(menu, NULL, NULL, D_("Rename the album"), _album_rename_cb, am);
   mi = elm_menu_item_add(menu, NULL, NULL, D_("Reload all exifs data"), _album_exifs_reload_cb, am);
   mi = elm_menu_item_add(menu, NULL, NULL, D_("Reload all iptcs data"), _album_iptcs_reload_cb, am);
   elm_menu_item_separator_add(menu, NULL);
   mi = elm_menu_item_add(menu, NULL, NULL, D_("Delete the album"), _album_delete_cb, am);
...
Album_Menu *
album_collection_menu_new(Evas_Object *parent,
                          Enlil_Album *album)
{
   Evas_Object *menu;
   Elm_Menu_Item *mi = NULL;
...
Album_Menu *
album_tag_menu_new(Evas_Object *parent,
                   Enlil_Album *album)
{
   Evas_Object *menu;
   Elm_Menu_Item *mi = NULL;
   ...
   mi = elm_menu_item_add(menu, NULL, NULL, D_("Add the tag to all photos"), NULL, am);
...
Album_Menu *
album_sorts_menu_new(Evas_Object *parent,
                     Enlil_Album *album)
{
   Evas_Object *menu;
   Elm_Menu_Item *mi = NULL;
...
static void
_collection_album_add_cb(void        *data,
                         Evas_Object *obj,
                         void        *event_info)
{
   Album_Menu *am = data;
...
static void
_collection_album_remove_cb(void        *data,
                            Evas_Object *obj,
                            void        *event_info)
{
   Album_Menu *am = data;
...
static void
_tag_album_remove_cb(void        *data,
                     Evas_Object *obj,
                     void        *event_info)
{
   Album_Menu *am = data;
...
static void
_album_exifs_reload_cb(void        *data,
                       Evas_Object *obj,
                       void        *event_info)
{
   Album_Menu *album_menu = data;
...
static void
_album_iptcs_reload_cb(void        *data,
                       Evas_Object *obj,
                       void        *event_info)
{
   Album_Menu *album_menu = data;
