...
static void _collection_album_add_cb(void *data, Evas_Object *obj, void *event_info);
static void _collection_album_remove_cb(void *data, Evas_Object *obj, void *event_info);
static void _collection_new_cb(void *data, Evas_Object *obj, void *event_info);

static void _tag_album_add_cb(void *data, Evas_Object *obj, void *event_info);
static void _tag_album_remove_cb(void *data, Evas_Object *obj, void *event_info);
static void _tag_new_cb(void *data, Evas_Object *obj, void *event_info);

static void _album_rename_cb(void *data, Evas_Object *obj, void *event_info);
static void _album_exifs_reload_cb(void *data, Evas_Object *obj, void *event_info);
static void _album_iptcs_reload_cb(void *data, Evas_Object *obj, void *event_info);
static void _album_delete_cb(void *data, Evas_Object *obj, void *event_info);

static void _sort_by_name_cb(void *data, Evas_Object *obj, void *event_info);
static void _sort_by_date_cb(void *data, Evas_Object *obj, void *event_info);
