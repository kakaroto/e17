...
static void _panel_select_cb(void          *data,
                             Tabpanel      *tabpanel,
                             Tabpanel_Item *item);

static void _map_mouse_wheel_cb(void        *data,
                                Evas        *e,
                                Evas_Object *obj,
                                void        *event_info);
static void _map_move_resize_cb(void        *data,
                                Evas        *e,
                                Evas_Object *obj,
                                void        *event_info);

static Evas_Object *_map_icon_get(Evas_Object    *obj,
                                  Elm_Map_Marker *marker,
                                  void           *data);

Panel_Geocaching *
panel_geocaching_new(Evas_Object      *obj,
