...
typedef Evas_Object *             (*PLHeaderItemIconGetFunc)(const void *data, Evas_Object *obj);

typedef struct PL_Child_Item        PL_Child_Item;
typedef struct PL_Child_Item_Class  PL_Child_Item_Class;
typedef Evas_Object *             (*PLChildItemIconGetFunc)(const void *data, Evas_Object *obj);
...
void photos_list_object_freeze(Evas_Object *obj,
			       int freeze);
void photos_list_object_clear(Evas_Object *obj);

void photos_list_object_sub_items_size_set(Evas_Object *obj,
					   int w,
					   int h);
void photos_list_object_header_height_set(Evas_Object *obj,
					  int h);

void photos_list_object_multiselect_set(Evas_Object *obj,
					Eina_Bool b);
Eina_Bool photos_list_object_multiselect_get(Evas_Object *obj);

PL_Header_Item *photos_list_object_item_header_append(Evas_Object *obj,
						      PL_Header_Item_Class *itc,
						      void *data);
PL_Header_Item *photos_list_object_item_header_append_relative(Evas_Object *obj,
                                                               PL_Header_Item_Class *itc,
                                                               void *data,
                                                               PL_Header_Item *relative);
void photos_list_object_header_move_after(PL_Header_Item *header,
					  PL_Header_Item *relative);
void photos_list_object_header_bring_in(PL_Header_Item *item);
void photos_list_object_header_goto(PL_Header_Item *item);
void photos_list_object_top_goto(Evas_Object *obj);

void photos_list_object_header_childs_del(PL_Header_Item *item);

void photos_list_object_child_move_after(PL_Child_Item *item,
...
PL_Child_Item *photos_list_object_item_append(Evas_Object *obj,
					      PL_Child_Item_Class *itc,
					      PL_Header_Item *header,
					      void *data);
PL_Child_Item *photos_list_object_item_append_relative(Evas_Object *obj,
                                                       PL_Child_Item_Class *itc,
                                                       PL_Header_Item *header,
                                                       void *data,
                                                       PL_Child_Item *relative);
...
void photos_list_object_item_selected_set(PL_Child_Item *item,
					  Eina_Bool selected);
