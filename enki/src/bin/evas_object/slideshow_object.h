...
typedef Evas_Object *              (*SlideshowIconGet)(const void *data, Evas_Object *obj);
...
void slideshow_object_file_set(Evas_Object *obj,
			       const char *file,
			       const char *group);
Slideshow_Item *slideshow_object_item_append(Evas_Object *obj,
                             Slideshow_Item_Class *itc,
                             void *data);
void slideshow_object_item_select(Evas_Object *obj,
				  Slideshow_Item *item);
