                                                    ...
                                                    Evas_Smart_Cb func, const void *func_data)
{
   ...
   if( IFTREE(edje) )
   {
      ...
      if((int)data == MENU_ALBUM_NEW)
      {
         ...
         item_album_new = elm_genlist_item_append(tree, itc,
                                                  data, header_albums, ELM_GENLIST_ITEM_NONE,
                                                  func, func_data);
         return item_album_new;
      }
      else if((int)data == MENU_SLIDESHOW
               || (int)data == MENU_IMPORT_PHOTOS
               || (int)data == MENU_DEL_BG
               || (int)data == MENU_WEBSYNC
               )
      {
                                                      ...
                                                      Evas_Smart_Cb func, const void *func_data)
{
   ...
   if( IFTREE(edje) )
   {
      ...
      return elm_genlist_item_insert_after(tree, itc,
                                           data, header_albums, item_album_new, ELM_GENLIST_ITEM_NONE,
                                           func, func_data);
   }
   else
   {
