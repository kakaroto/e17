...
static void _bt_left_cb(void        *data,
                        Evas_Object *obj,
                        void        *event_info);
static void _bt_right_cb(void        *data,
                         Evas_Object *obj,
                         void        *event_info);

static void _right_done_cb(void        *data,
                           Evas_Object *obj,
                           const char  *signal,
                           const char  *source);
static void _left_done_cb(void        *data,
                          Evas_Object *obj,
                          const char  *signal,
                          const char  *source);
...
void
slideshow_object_file_set(Evas_Object *obj,
                          const char  *file,
                          const char  *group)
{
   Evas_Object *bt, *icon;
...
Slideshow_Item *
slideshow_object_item_append(Evas_Object          *obj,
                             Slideshow_Item_Class *itc,
                             void                 *data)
{
   Smart_Data *sd = evas_object_smart_data_get(obj);
...
void
slideshow_object_item_select(Evas_Object    *obj,
                             Slideshow_Item *item)
{
   Eina_List *l;
