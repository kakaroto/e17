...
static void _menu_open_cb(void        *data,
                          Evas_Object *obj,
                          void        *event_info);
static void _account_set_cb(void        *data,
                            Evas_Object *obj,
                            void        *event_info);
static void _account_set_apply_cb(void        *data,
                                  Evas_Object *obj,
                                  void        *event_info);
static void _account_set_cancel_cb(void        *data,
                                   Evas_Object *obj,
                                   void        *event_info);
static void _account_set_entry_changed_cb(void        *data,
                                          Evas_Object *obj,
                                          void        *event_info);
                ...
                void        *event_info)
{
   ...
   evas_object_smart_callback_add(text, "changed", _account_set_entry_changed_cb, bt);
...
static void
_account_set_apply_cb(void        *data,
                      Evas_Object *obj,
                      void        *event_info)
{
...
static void
_account_set_cancel_cb(void        *data,
                       Evas_Object *obj,
                       void        *event_info)
{
   evas_object_del(set_account.inwin);
...
static void
_account_set_entry_changed_cb(void        *data,
                              Evas_Object *obj,
                              void        *event_info)
{
