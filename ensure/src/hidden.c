...
/*
   static Eina_Bool
   hiddenclass_state_get(void *data __UNUSED__, Evas_Object *obj __UNUSED__,
...
view_set_hidden(void *ensurev, Evas_Object *button __UNUSED__, void *event_info __UNUSED__)
{
   ...
   EINA_LIST_FOREACH (ensure->hidden, l, o)
     {
        elm_genlist_item_append(ensure->view, &hiddenclass, o, NULL, ELM_GENLIST_ITEM_NONE, hidden_sel, o);
     }
}
...
static void
hidden_sel(void *objv, Evas_Object *gl __UNUSED__, void *event __UNUSED__)
{
   Evas_Object *o = objv;
