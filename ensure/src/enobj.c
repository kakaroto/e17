...
static Eina_Bool
enobj_prepare_object(const Eina_Hash *hash __UNUSED__, const void *key __UNUSED__, void *obj, void *ensurev)
{
...
#if 0
static Eina_Bool
enobj_hash_del_cb(const Eina_Hash *hash __UNUSED__, const void *key __UNUSED__, void *enobjv, void *ensure __UNUSED__)
{
   enobj_free(enobjv);
   return true;
}
