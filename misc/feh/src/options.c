...
show_usage (void)
{
  fprintf (stdout,
	   ...
	   "                            Montage mode creates a new image consisting of a grid\n"
	   "                            of thumbnails of the images specified using FILE...\n"
	   "                            When montage mode is selected, certain other options\n"
	   "                            become available. See MONTAGE MODE OPTIONS\n"
	   ...
	   "                            This will prevent any whitespace in the final montage\n"
	   "  -s, --stretch             Normally, if an image is smaller than the specified thumbnail\n"
	   "                            size, it will not be enlarged. If this option is set, the\n"
	   "                            image will be scaled up to fit the thumnail size. (Aspect\n"
	   "                            ratio will be maintained unless --ignoreaspect is specified)\n"
	   ...
	   "                            These options can be used together (to define the image \n"
	   "                            size exactly), or separately. If only one is specified, the\n"
	   "                            other is calculated from the number of files specified and\n"
	   "                            the size of the thumbnails.  The default is to limit width\n"
	   "                            to 800 pixels and calculate the height\n"
	   "      --bg FILE             Use FILE as a background for your montage. With this\n"
	   "                            option specified, the size of the montage will default\n"
	   "                            to the size of FILE if no size restrictions are specified.\n"
