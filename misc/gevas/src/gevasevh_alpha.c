...
static void
gevasevh_alpha_get_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);
static void
gevasevh_alpha_set_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);
...
GEVASEV_HANDLER_RET 
gevasev_alpha_mouse_in( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	GtkgEvasEvHAlpha* ev;
	g_return_val_if_fail(object != NULL,GEVASEV_HANDLER_RET_NEXT);
	g_return_val_if_fail(GTK_IS_GEVASEVH_ALPHA(object),GEVASEV_HANDLER_RET_NEXT);
...
GEVASEV_HANDLER_RET 
gevasev_alpha_mouse_out( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	GtkgEvasEvHAlpha* ev;
	g_return_val_if_fail(object != NULL,GEVASEV_HANDLER_RET_NEXT);
	g_return_val_if_fail(GTK_IS_GEVASEVH_ALPHA(object),GEVASEV_HANDLER_RET_NEXT);
...
GEVASEV_HANDLER_RET 
gevasev_alpha_mouse_down( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_alpha_mouse_up( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_alpha_mouse_move( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}
...
static void
gevasevh_alpha_class_init (GtkgEvasEvHAlphaClass *klass)
{
...
static void
gevasevh_alpha_init (GtkgEvasEvHAlpha *ev)
{
	ev->hot_value = 255;
}

GtkObject*
gevasevh_alpha_new (void)
{
	GtkgEvasEvHAlpha *ev;
	GtkgEvasEvH* hev;
...
static void   
gevasevh_alpha_destroy       (GtkObject   *object)
{
	GtkgEvasEvHAlpha* ev;
