...
static void gevasobj_get_arg(GtkObject* object,
                                  GtkArg* arg,
                                  guint arg_id);
static void gevasobj_set_arg(GtkObject* object,
                                  GtkArg* arg,
                                  guint arg_id);
...
void
_gevas_set_obj( GtkObject *object, Evas_Object eobj ) 
{
  GtkgEvasObj* ev;
  ...
  evas_put_data(EVAS(ev), eobj, PRIVATE_GTK_GEVASOBJ, object);
	...
	evas_callback_add(EVAS(ev), eobj, CALLBACK_MOUSE_IN, __gevas_mouse_in, object);
	evas_callback_add(EVAS(ev), eobj, CALLBACK_MOUSE_OUT, __gevas_mouse_out, object);
	evas_callback_add(EVAS(ev), eobj, CALLBACK_MOUSE_DOWN, __gevas_mouse_down, object);
	evas_callback_add(EVAS(ev), eobj, CALLBACK_MOUSE_UP, __gevas_mouse_up, object);
	evas_callback_add(EVAS(ev), eobj, CALLBACK_MOUSE_MOVE, __gevas_mouse_move, object);	

}

Evas_Object
_gevas_get_obj( GtkObject *object ) 
{
  GtkgEvasObj* ev;
  g_return_val_if_fail(object != NULL,NULL);
  g_return_val_if_fail(GTK_IS_GEVASOBJ(object),NULL);
...
Evas_Object 
gevasobj_get_evasobj( GtkObject *object ) 
{
...
GtkgEvas*
gevasobj_get_gevas( GtkObject *object ) 
{
	GtkgEvasObj* ev;
	g_return_val_if_fail(object != NULL,NULL);
	g_return_val_if_fail(GTK_IS_GEVASOBJ(object),NULL);
...
Evas 
gevasobj_get_evas( GtkObject *object )
{
...
void 
_gevasobj_ensure_obj_free( GtkObject *object )
{
  GtkgEvasObj* ev;
...
void
_gevasobj_set_color(GtkgEvasObj *object, int r, int g, int b, int a) {
	evas_set_color(EVAS(object), EVASO(object), r,g,b,a);
}

void
_gevasobj_set_alpha(GtkgEvasObj *object, int a) {
...
void
_gevasobj_set_angle(GtkgEvasObj *object, double angle) {
...
void _gevasobj_get_geometry(GtkgEvasObj *object, double *x, double *y, double *w, double *h) {
...
void
_gevasobj_add_evhandler( GtkgEvasObj *object, GtkObject* h ) 
{
	GtkgEvasObj* ev;
	g_return_if_fail(object != NULL);
	g_return_if_fail(GTK_IS_GEVASOBJ(object));
...
void
_gevasobj_remove_evhandler( GtkgEvasObj *object, GtkObject* h ) 
{
	GtkgEvasObj* ev;
	g_return_if_fail(object != NULL);
	g_return_if_fail(GTK_IS_GEVASOBJ(object));
...
GSList*
gevasobj_get_evhandlers( GtkgEvasObj *object ) 
{
	GtkgEvasObj* ev;
...
static void
gevasobj_class_init (GtkgEvasObjClass *klass)
{
...
static void   
gevasobj_destroy       (GtkObject   *object)
{
	GtkgEvasObj* ev;
	g_return_if_fail(object != NULL);
	g_return_if_fail(GTK_IS_GEVASOBJ(object));
...
static void
gevasobj_finalize        (GtkObject      *object)
{
	GtkgEvasObj* ev;
	g_return_if_fail(object != NULL);
	g_return_if_fail(GTK_IS_GEVASOBJ(object));
...
void
gevasobj_add_evhandler( GtkgEvasObj *object, GtkObject* h ) 
{
	return VTAB->add_evhandler( object, h );
}

void
gevasobj_remove_evhandler( GtkgEvasObj *object, GtkObject* h ) 
{
...
static void
gevasobj_set_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id)
{
  GtkgEvasObj* ev;
...
static void
gevasobj_get_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id)
{
  GtkgEvasObj* ev;
