...
GtkObject* gevas_object_in_rect(GtkgEvas* ev, double x, double y, double w, double h);
...
void __gevas_mouse_in (void *_data, Evas _e, Evas_Object _o, int _b, int _x, int _y);
void __gevas_mouse_out (void *_data, Evas _e, Evas_Object _o, int _b, int _x, int _y);
void __gevas_mouse_down (void *_data, Evas _e, Evas_Object _o, int _b, int _x, int _y);
void __gevas_mouse_up (void *_data, Evas _e, Evas_Object _o, int _b, int _x, int _y);
void __gevas_mouse_move (void *_data, Evas _e, Evas_Object _o, int _b, int _x, int _y);
