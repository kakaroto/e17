...
static void
gevasevh_popup_get_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);
static void
gevasevh_popup_set_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);
...
GEVASEV_HANDLER_RET 
gevasev_to_popup_mouse_in( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_to_popup_mouse_out( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_to_popup_mouse_down( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	gboolean return_val;
	GtkgEvasEvHPopup* ev;
	g_return_val_if_fail(object != NULL,GEVASEV_HANDLER_RET_NEXT);
	g_return_val_if_fail(GTK_IS_GEVASEVH_POPUP_SIGNAL(object),GEVASEV_HANDLER_RET_NEXT);
	...
	if( _b == 3 ) {
		...
		evas_event_button_up( gevasobj_get_evas(gevasobj), _x, _y, _b);
...
GEVASEV_HANDLER_RET 
gevasev_to_popup_mouse_up( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_to_popup_mouse_move( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}
...
static void
gevasevh_popup_class_init (GtkgEvasEvHPopupClass *klass)
{
	...
	gtk_object_class_add_signals (object_class, _gevasevh_popup_signals, LAST_SIGNAL);
...
static void
gevasevh_popup_init (GtkgEvasEvHPopup *ev)
{
	ev->user_gtk_menu = 0;
}

GtkObject*
gevasevh_popup_new (void)
{
	GtkgEvasEvHPopup *ev;
	GtkgEvasEvH* hev;
...
static void   
gevasevh_popup_destroy       (GtkObject   *object)
{
	GtkgEvasEvHPopup* ev;
