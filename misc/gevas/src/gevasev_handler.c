...
static void gevasevh_get_arg(GtkObject* object,
                                  GtkArg* arg,
                                  guint arg_id);
static void gevasevh_set_arg(GtkObject* object,
                                  GtkArg* arg,
                                  guint arg_id);

GEVASEV_HANDLER_RET 
gevasev_handler_mouse_in( GtkObject* object, GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_handler_mouse_out( GtkObject* object, GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_handler_mouse_down( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
  GtkgEvasEvH* ev;
...
GEVASEV_HANDLER_RET 
gevasev_handler_mouse_up( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_handler_mouse_move( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}
...
static void
gevasevh_class_init (GtkgEvasEvHClass *klass)
{
...
static void   
gevasevh_destroy       (GtkObject   *object)
{
  GtkgEvasEvH* ev;
...
static void
gevasevh_set_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id)
{
  GtkgEvasEvH* ev;
...
static void
gevasevh_get_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id)
{
  GtkgEvasEvH* ev;
