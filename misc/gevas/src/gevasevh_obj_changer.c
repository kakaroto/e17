...
static void
gevasevh_obj_changer_get_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);
static void
gevasevh_obj_changer_set_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);
...
void
gevasev_obj_changer_show( GtkgEvasEvHObjChanger* ev, GtkgEvasObj* newobj )
{
...
GEVASEV_HANDLER_RET 
gevasev_obj_changer_mouse_in( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	GtkgEvasEvHObjChanger* ev;
	g_return_val_if_fail(object != NULL,GEVASEV_HANDLER_RET_NEXT);
	g_return_val_if_fail(GTK_IS_GEVASEVH_OBJ_CHANGER(object),GEVASEV_HANDLER_RET_NEXT);
...
GEVASEV_HANDLER_RET 
gevasev_obj_changer_mouse_out( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	GtkgEvasEvHObjChanger* ev;
	g_return_val_if_fail(object != NULL,GEVASEV_HANDLER_RET_NEXT);
	g_return_val_if_fail(GTK_IS_GEVASEVH_OBJ_CHANGER(object),GEVASEV_HANDLER_RET_NEXT);
...
GEVASEV_HANDLER_RET 
gevasev_obj_changer_mouse_down( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	GtkgEvasEvHObjChanger* ev;
	g_return_val_if_fail(object != NULL,GEVASEV_HANDLER_RET_NEXT);
	g_return_val_if_fail(GTK_IS_GEVASEVH_OBJ_CHANGER(object),GEVASEV_HANDLER_RET_NEXT);
...
GEVASEV_HANDLER_RET 
gevasev_obj_changer_mouse_up( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	GtkgEvasEvHObjChanger* ev;
	g_return_val_if_fail(object != NULL,GEVASEV_HANDLER_RET_NEXT);
	g_return_val_if_fail(GTK_IS_GEVASEVH_OBJ_CHANGER(object),GEVASEV_HANDLER_RET_NEXT);
...
GEVASEV_HANDLER_RET 
gevasev_obj_changer_mouse_move( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}
...
guint
gevasevh_obj_changer_get_type (void)
{
...
static void
gevasevh_obj_changer_class_init (GtkgEvasEvHObjChangerClass *klass)
{
	...
	gtk_object_add_arg_type( GTK_GEVASEVH_OBJ_CHANGER_HOTCLK1_OBJ,
             GTK_TYPE_POINTER, GTK_ARG_READWRITE, ARG_HOTCLK1_OBJ);		
	gtk_object_add_arg_type( GTK_GEVASEVH_OBJ_CHANGER_HOTCLK2_OBJ,
             GTK_TYPE_POINTER, GTK_ARG_READWRITE, ARG_HOTCLK2_OBJ);		
	gtk_object_add_arg_type( GTK_GEVASEVH_OBJ_CHANGER_HOTCLK3_OBJ,
             GTK_TYPE_POINTER, GTK_ARG_READWRITE, ARG_HOTCLK3_OBJ);		


}

static void
gevasevh_obj_changer_init (GtkgEvasEvHObjChanger *ev)
{
	ev->cold = 0;
	ev->hot = 0;
}
...
static void   
gevasevh_obj_changer_destroy       (GtkObject   *object)
{
	GtkgEvasEvHObjChanger* ev;
