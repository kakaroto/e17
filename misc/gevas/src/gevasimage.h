...
struct _GtkgEvasImageClass
{
  ...
  void (*set_image_fill)( GtkgEvasObj* object, double x, double y, double w, double h);
  void (*get_image_size)( GtkgEvasObj* object, int *w, int *h);
  void (*set_image_border)( GtkgEvasObj* object, int l, int r, int t, int b);
  void (*get_image_border)( GtkgEvasObj* object, int *l, int *r, int *t, int *b);
...
void gevasimage_set_image_fill( GtkgEvasObj* object, double x, double y, double w, double h);
void gevasimage_set_image_border( GtkgEvasObj* object, int l, int r, int t, int b);
void gevasimage_get_image_size( GtkgEvasObj* object, int *w, int *h);
void gevasimage_get_image_border( GtkgEvasObj* object, int *l, int *r, int *t, int *b);
