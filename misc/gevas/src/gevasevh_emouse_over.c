...
static void
gevasevh_emouse_over_get_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);
static void
gevasevh_emouse_over_set_arg (GtkObject    *object,
                       GtkArg       *arg,
                       guint         arg_id);


GEVASEV_HANDLER_RET 
gevasev_emouse_over_mouse_in( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	...
	g_return_val_if_fail(GTK_IS_GEVASEVH_EMOUSE_OVER(object),GEVASEV_HANDLER_RET_NEXT);
...
GEVASEV_HANDLER_RET 
gevasev_emouse_over_mouse_out( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
...
GEVASEV_HANDLER_RET 
gevasev_emouse_over_mouse_down( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_emouse_over_mouse_up( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}

GEVASEV_HANDLER_RET 
gevasev_emouse_over_mouse_move( GtkObject* object,  GtkObject* gevasobj, int _b, int _x, int _y )
{
	return GEVASEV_HANDLER_RET_NEXT;
}
...
guint
gevasevh_emouse_over_get_type (void)
{
...
static void
gevasevh_emouse_over_class_init (GtkgEvasEvHEMouseOverClass *klass)
{
...
static void
gevasevh_emouse_over_init (GtkgEvasEvHEMouseOver *ev)
{
...
static void   
gevasevh_emouse_over_destroy       (GtkObject   *object)
{
	GtkgEvasEvHEMouseOver* ev;
