...
menus_init(void)
{
  ...
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(filemenu_cb), (gpointer) 1);
  gtk_widget_show(item);
  item = gtk_menu_item_new_with_label("Save");
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(filemenu_cb), (gpointer) 2);
  gtk_widget_show(item);
  item = gtk_menu_item_new_with_label("Save As...");
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(filemenu_cb), (gpointer) 3);
  gtk_widget_show(item);
  ...
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 1);
  gtk_widget_show(item);
  item = gtk_menu_item_new();  /* Separator */
  gtk_widget_set_sensitive(item, FALSE);
  gtk_menu_append(GTK_MENU(menu), item);
  ...
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 2);
  gtk_widget_show(item);
  item = gtk_menu_item_new_with_label("Sharpen");
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 3);
  gtk_widget_show(item);
  item = gtk_menu_item_new_with_label("Blur More");
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 4);
  gtk_widget_show(item);
  item = gtk_menu_item_new_with_label("Sharpen More");
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 5);
  gtk_widget_show(item);
  item = gtk_menu_item_new();  /* Separator */
  gtk_widget_set_sensitive(item, FALSE);
  gtk_menu_append(GTK_MENU(menu), item);
  ...
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 7);
  gtk_widget_show(item);
  item = gtk_menu_item_new_with_label("Flip Diagonally");
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 8);
  gtk_widget_show(item);
  item = gtk_menu_item_new();  /* Separator */
  gtk_widget_set_sensitive(item, FALSE);
  gtk_menu_append(GTK_MENU(menu), item);
  ...
  gtk_menu_append(GTK_MENU(menu), item);
  gtk_signal_connect_object(GTK_OBJECT(item), "activate",
														GTK_SIGNAL_FUNC(imagemenu_cb), (gpointer) 9);
  gtk_widget_show(item);
  ...
  gtk_widget_set_sensitive(item, FALSE);
  gtk_widget_show(item);
	item = gtk_menu_item_new_with_label("About EE2");
	gtk_menu_append(GTK_MENU(RootMenu), item);
	gtk_signal_connect_object(GTK_OBJECT(item), "activate",
