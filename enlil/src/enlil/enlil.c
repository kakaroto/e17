 ...
 */
int enlil_eet_app_data_save(Eet_Data_Descriptor *edd, const char *key, void *data)
{
   int res;
   Eet_File *f;
 ...
 */
void *enlil_eet_app_data_load(Eet_Data_Descriptor *edd, const char *key)
{
   void *res;
   Eet_File *f;
   char path[PATH_MAX], buf[PATH_MAX];
...
Eet_Data_Descriptor *enlil_string_edd_new()
{
   ...
   EAPI Eina_List *
eina_list_sorted_diff(Eina_List *list1, Eina_List *list2, Eina_List **elt_list1, Eina_List **elt_list2, Eina_Compare_Cb func)
{
...
eina_list_left_sorted_diff(Eina_List *sorted_list, Eina_List *list2, Eina_List **elt_list1, Eina_List **elt_list2, Eina_Compare_Cb func)
{
   ...
   *elt_list2 = NULL;
   ...
   EAPI Eina_List *
eina_list_right_sorted_diff(Eina_List *list1, Eina_List *sorted_list, Eina_List **elt_list1, Eina_List **elt_list2, Eina_Compare_Cb func)
{
   Eina_List *elt_common = NULL;
   Eina_List *l1, *l2;
