...
static int  _sort_photos_name_cb(const void *d1,
                                 const void *d2);
static int  _sort_photos_date_cb(const void *d1,
                                 const void *d2);

static void _album_eet_photos_load(Enlil_Album *album);
static int  _album_eet_photos_save(Enlil_Album *album);
static void _album_monitor_cb(void               *data,
 ...
 */
Enlil_Album *
enlil_album_copy_new(const Enlil_Album *album)
{
...
void
enlil_album_free(Enlil_Album **album)
{
   Enlil_Photo *photo;
...
void
enlil_album_list_print(Eina_List *l_enlil)
{
   Eina_List *l;
   Enlil_Album *album;
...
void
enlil_album_print(Enlil_Album *album)
{
   ASSERT_RETURN_VOID(album != NULL);
   printf("\t## ALBUM ##\n");
   printf("\t###########\n");
...
void
enlil_album_monitor_start(Enlil_Album *album)
{
   char buf[PATH_MAX];
...
void
enlil_album_monitor_stop(Enlil_Album *album)
{
   ASSERT_RETURN_VOID(album != NULL);
...
void
enlil_album_name_set(Enlil_Album *album,
                     const char  *name)
{
   ASSERT_RETURN_VOID(album != NULL);
...
void
enlil_album_access_type_set(Enlil_Album            *album,
                            Enlil_Album_Access_Type access_type)
{
   ASSERT_RETURN_VOID(album != NULL);
...
void
enlil_album_description_set(Enlil_Album *album,
                            const char  *desc)
{
...
void
enlil_album_photos_sort_set(Enlil_Album     *album,
                            Enlil_Photo_Sort photos_sort)
{
   ASSERT_RETURN_VOID(album != NULL);
...
void
enlil_album_user_data_set(Enlil_Album        *album,
                          void               *user_data,
...
void
enlil_album_path_set(Enlil_Album *album,
                     const char  *path)
{
   ASSERT_RETURN_VOID(album != NULL);
...
int
enlil_album_netsync_id_get(Enlil_Album *album)
{
   ASSERT_RETURN(album != NULL);
...
int
enlil_album_netsync_version_header_get(Enlil_Album *album)
{
   ASSERT_RETURN(album != NULL);
...
int
enlil_album_netsync_version_header_net_get(Enlil_Album *album)
{
   ASSERT_RETURN(album != NULL);
...
void
_enlil_album_netsync_version_header_inc(Enlil_Album *album)
{
   ASSERT_RETURN_VOID(album != NULL);
...
void
_enlil_album_netsync_version_header_both_set(Enlil_Album *album,
                                             int          version)
{
   ASSERT_RETURN_VOID(album != NULL);
...
int
enlil_album_netsync_timestamp_last_update_collections_get(Enlil_Album *album)
{
   ASSERT_RETURN(album != NULL);
...
void
_enlil_album_netsync_timestamp_last_update_collections_set(Enlil_Album *album,
                                                           int          timestamp)
{
   ASSERT_RETURN_VOID(album != NULL);
...
void
_enlil_album_netsync_id_set(Enlil_Album *album,
                            int          id)
{
   ASSERT_RETURN_VOID(album != NULL);
...
Eina_List *
enlil_album_photos_get(Enlil_Album *album)
{
   ASSERT_RETURN(album != NULL);
...
int
enlil_album_photos_count_get(Enlil_Album *album)
{
   ASSERT_RETURN(album != NULL);
   ALBUM_PHOTOS_LOAD(album);
 ...
 */
void
enlil_album_collection_process(Enlil_Album *album)
{
   Eina_List *l;
   Enlil_Album_Collection *album_col;
   ASSERT_RETURN_VOID(album != NULL);
 ...
 */
void
enlil_album_collection_add(Enlil_Album *album,
                           const char  *col_name)
{
   Enlil_Album_Collection *album_col;
   ASSERT_RETURN_VOID(album != NULL);
 ...
 */
void
enlil_album_collection_remove(Enlil_Album            *album,
                              Enlil_Album_Collection *album_col)
{
   ASSERT_RETURN_VOID(album != NULL);
 ...
 */
Enlil_Photo *
enlil_album_photo_search_file_name(Enlil_Album *album,
                                   const char  *file_name)
{
   Eina_List *l;
   Enlil_Photo *photo;
...
void
enlil_album_photo_add(Enlil_Album *album,
                      Enlil_Photo *photo)
{
   ASSERT_RETURN_VOID(album != NULL);
...
void
_enlil_album_photo_name_changed(Enlil_Album *album,
                                Enlil_Photo *photo)
{
   ASSERT_RETURN_VOID(album != NULL);
   ASSERT_RETURN_VOID(photo != NULL);
...
void
_enlil_album_photo_datetimeoriginal_changed(Enlil_Album *album,
                                            Enlil_Photo *photo)
{
   ASSERT_RETURN_VOID(album != NULL);
   ASSERT_RETURN_VOID(photo != NULL);
...
Enlil_Photo *
enlil_album_photo_prev_get(Enlil_Album *album,
                           Enlil_Photo *photo)
{
   ASSERT_RETURN(album != NULL);
...
void
enlil_album_photo_remove(Enlil_Album *album,
                         Enlil_Photo *photo)
{
   ASSERT_RETURN_VOID(album != NULL);
   ASSERT_RETURN_VOID(photo != NULL);
...
int
enlil_album_eet_photos_save(Enlil_Album *album)
{
   ASSERT_RETURN(album != NULL);
...
int
enlil_album_eet_header_save(Enlil_Album *album)
{
...
static void
_sort_photos(Enlil_Album *album)
{
   ASSERT_RETURN_VOID(album != NULL);
   enlil_album_photos_get(album);
...
static int
_sort_photos_name_cb(const void *d1,
                     const void *d2)
{
...
static int
_sort_photos_date_cb(const void *d1,
                     const void *d2)
{
   const Enlil_Photo *photo1 = d1;
   const Enlil_Photo *photo2 = d2;
...
static Enlil_Album *
_enlil_album_eet_photos_list_load(Enlil_Album *album)
{
...
int
enlil_album_eet_photos_list_save(Enlil_Album *album)
{
   int res;
   Eet_Data_Descriptor *edd, *edd_photo;
   Eet_File *f;
...
static void
_album_eet_photos_load(Enlil_Album *album)
{
   Enlil_Photo *photo;
   char path[PATH_MAX];
   Eina_List *l;
...
static int
_album_eet_photos_save(Enlil_Album *album)
{
   Eina_List *l;
   Enlil_Photo *photo;
   char path[PATH_MAX];
...
_enlil_album_photos_file_name_edd_new(Eet_Data_Descriptor *edd_file_name)
{
   Eet_Data_Descriptor *edd;
   Eet_Data_Descriptor_Class eddc;
...
Eet_Data_Descriptor *
_enlil_album_header_edd_new(Eet_Data_Descriptor *edd_collection)
{
   Eet_Data_Descriptor *edd;
   Eet_Data_Descriptor_Class eddc;
