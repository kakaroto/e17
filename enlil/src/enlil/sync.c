...
static void _enlil_sync_message_cb(void        *data,
                                   void        *buffer,
                                   unsigned int nbyte);
...
static void _enlil_sync_album_folder_run(Enlil_Sync *_sync,
                                         const char *file);
static void _enlil_sync_photo_file_run(Enlil_Sync *_sync,
                                       const char *folder,
                                       const char *file);

//method used to synchronise a photo
static void _enlil_sync_photo_file_start(Enlil_Sync *_sync,
                                         const char *folder,
                                         const char *file);

//method used to synchronise an album folder
static void _enlil_sync_album_folder_start(Enlil_Sync *_sync,
                                           const char *file);

//methods used to do a global synchronisation
static void _enlil_sync_all_start(void         *data,
                                  Ecore_Thread *thread);
static void _enlil_sync_all_album_sync(Enlil_Sync  *_sync,
                                       Enlil_Album *album);
static void _enlil_sync_all_photo_new(Enlil_Sync  *_sync,
                                      Enlil_Album *album,
                                      const char  *file);
static int _enlil_sync_all_photo_update(Enlil_Sync  *_sync,
                                        Enlil_Album *album,
                                        Enlil_Photo *photo);
static void _enlil_sync_all_album_new(Enlil_Sync    *_sync,
                                      Enlil_Library *library_list,
                                      const char    *file);
static int _enlil_sync_all_album_update(Enlil_Sync    *_sync,
                                        Enlil_Library *library_list,
                                        Enlil_Album   *_album);

static void            _enlil_sync_next_job_process(Enlil_Sync *_sync);
static void            _enlil_sync_job_free(Enlil_Sync_Job **job);
static Enlil_Sync_Job *_enlil_sync_job_equivalent_search(Enlil_Sync     *_sync,
                                                         Enlil_Sync_Job *job);

static int
file_album_comp_cb(const void *d1,
                   const void *d2);
static int
file_photo_comp_cb(const void *d1,
                   const void *d2);
 ...
 */
Enlil_Sync *
enlil_sync_new(const char                   *path,
               Enlil_Sync_Album_New_Cb       album_new_cb,
               Enlil_Sync_Album_Update_Cb    album_update_cb,
               Enlil_Sync_Album_Disappear_Cb album_disappear_cb,
               Enlil_Sync_Photo_New_Cb       photo_new_cb,
 ...
 */
void
enlil_sync_free(Enlil_Sync **_sync)
{
...
int
enlil_sync_jobs_count_get(Enlil_Sync *_sync)
{
   ASSERT_RETURN(_sync != NULL);
 ...
 */
void
enlil_sync_job_all_add(Enlil_Sync *_sync)
{
 ...
 */
void
enlil_sync_job_album_folder_add(Enlil_Sync *_sync,
                                const char *folder)
{
   Enlil_Sync_Job *job, *_job;
 ...
 */
void
enlil_sync_job_photo_file_add(Enlil_Sync *_sync,
                              const char *folder,
                              const char *file)
{
   Enlil_Sync_Job *job, *_job;
...
static Enlil_Sync_Job *
_enlil_sync_job_equivalent_search(Enlil_Sync     *_sync,
                                  Enlil_Sync_Job *job)
{
   Eina_List *l;
...
static void
_enlil_sync_job_free(Enlil_Sync_Job **job)
{
...
static void
_enlil_sync_next_job_process(Enlil_Sync *_sync)
{
   Enlil_Sync_Job *job;
...
static void
_enlil_sync_run(Enlil_Sync *_sync)
{
   ASSERT_RETURN_VOID(_sync != NULL);
...
static void
_enlil_sync_album_folder_run(Enlil_Sync *_sync,
                             const char *folder)
{
   ASSERT_RETURN_VOID(_sync != NULL);
   ASSERT_RETURN_VOID(folder != NULL);
...
static void
_enlil_sync_album_folder_thread(void         *data,
...
static void
_enlil_sync_photo_file_run(Enlil_Sync *_sync,
                           const char *folder,
                           const char *file)
{
   ASSERT_RETURN_VOID(_sync != NULL);
...
static void
_enlil_sync_photo_file_thread(void         *data,
                              Ecore_Thread *thread __UNUSED__)
{
   Enlil_Sync *_sync = (Enlil_Sync *)data;
 ...
 */
static void
_enlil_sync_photo_file_start(Enlil_Sync *_sync,
                             const char *folder,
                             const char *file)
{
 ...
 */
static void
_enlil_sync_album_folder_start(Enlil_Sync *_sync,
                               const char *folder)
{
...
static void
_enlil_sync_all_photo_new(Enlil_Sync  *_sync,
                          Enlil_Album *album,
                          const char  *file)
{
...
static int
_enlil_sync_all_photo_update(Enlil_Sync  *_sync,
                             Enlil_Album *album,
                             Enlil_Photo *_photo)
{
   char buf_path[PATH_MAX], buf_file[PATH_MAX], buf[PATH_MAX], buf2[PATH_MAX];
...
static void
_enlil_sync_all_album_sync(Enlil_Sync  *_sync,
                           Enlil_Album *album)
{
...
static void
_enlil_sync_all_album_new(Enlil_Sync    *_sync,
                          Enlil_Library *library_list,
                          const char    *file)
{
...
static int
_enlil_sync_all_album_update(Enlil_Sync    *_sync,
                             Enlil_Library *library_list,
                             Enlil_Album   *_album)
{
   char buf[PATH_MAX];
 ...
 */
static void
_enlil_sync_all_start(void         *data,
                      Ecore_Thread *thread __UNUSED__)
{
 ...
 */
static void
_enlil_sync_message_cb(void        *data,
