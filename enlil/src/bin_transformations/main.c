...
static void _trans_rotate_180(Evas       *evas,
                              const char *file,
                              const char *res);
static void _enlil_trans_rotate_90(Evas       *evas,
                                   const char *file,
                                   const char *res);
static void _enlil_trans_rotate_R90(Evas       *evas,
                                    const char *file,
                                    const char *res);
static void _enlil_trans_flip_vertical(Evas       *evas,
                                       const char *file,
                                       const char *res);
static void _enlil_trans_flip_horizontal(Evas       *evas,
                                         const char *file,
                                         const char *res);
static void _enlil_trans_blur(Evas       *evas,
                              const char *file,
                              const char *res);
static void _enlil_trans_sharpen(Evas       *evas,
                                 const char *file,
                                 const char *res);
static void _enlil_trans_grayscale(Evas       *evas,
                                   const char *file,
                                   const char *res);
static void _enlil_trans_sepia(Evas       *evas,
                               const char *file,
                               const char *res);
...
static void
_enlil_trans_rotate_90(Evas       *evas,
                       const char *file,
                       const char *res)
{
   ASSERT_RETURN_VOID(file != NULL);
...
static void
_enlil_trans_rotate_R90(Evas       *evas,
                        const char *file,
                        const char *res)
{
   ASSERT_RETURN_VOID(file != NULL);
...
static void
_enlil_trans_flip_vertical(Evas       *evas,
                           const char *file,
                           const char *res)
{
   ASSERT_RETURN_VOID(file != NULL);
...
static void
_enlil_trans_flip_horizontal(Evas       *evas,
                             const char *file,
                             const char *res)
{
   ASSERT_RETURN_VOID(file != NULL);
...
static void
_enlil_trans_sharpen(Evas       *evas,
                     const char *file,
                     const char *res)
{
   ASSERT_RETURN_VOID(file != NULL);
...
static void
_enlil_trans_grayscale(Evas       *evas,
                       const char *file,
                       const char *res)
{
   ASSERT_RETURN_VOID(file != NULL);
