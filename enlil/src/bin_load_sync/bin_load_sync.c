...
static void _sync_done_cb(void       *data,
                          Enlil_Sync *_sync);
static void _sync_start_cb(void       *data,
                           Enlil_Sync *_sync);
static void _sync_error_cb(void       *data,
                           Enlil_Sync *_sync,
                           Sync_Error  error,
                           const char *msg);
static void _sync_album_new_cb(void          *data,
                               Enlil_Sync    *_sync,
                               Enlil_Library *library,
                               Enlil_Album   *album);
static void _sync_album_update_cb(void          *data,
                                  Enlil_Sync    *_sync,
                                  Enlil_Library *library,
                                  Enlil_Album   *album);
static void _sync_album_disappear_cb(void          *data,
                                     Enlil_Sync    *_sync,
                                     Enlil_Library *library,
                                     Enlil_Album   *album);
static void _sync_photo_new_cb(void        *data,
                               Enlil_Sync  *_sync,
                               Enlil_Album *album,
                               Enlil_Photo *photo);
static void _sync_photo_update_cb(void        *data,
                                  Enlil_Sync  *_sync,
                                  Enlil_Album *album,
                                  Enlil_Photo *photo);
static void _sync_photo_disappear_cb(void        *data,
                                     Enlil_Sync  *_sync,
                                     Enlil_Album *album,
                                     Enlil_Photo *photo);

static void _load_done_cb(void       *data,
                          Enlil_Load *load,
                          int         nb_albums,
                          int         nb_photos);
static void _load_error_cb(void       *data,
                           Enlil_Load *load,
                           Load_Error  error,
                           const char *msg);
static void _load_album_done_cb(void          *data,
                                Enlil_Load    *load,
                                Enlil_Library *library,
                                Enlil_Album   *album);

static void _monitor_album_new_cb(void          *data,
                                  Enlil_Library *library,
                                  const char    *path);
static void _monitor_album_delete_cb(void          *data,
                                     Enlil_Library *library,
                                     const char    *path);
static void _monitor_enlil_delete_cb(void          *data,
                                     Enlil_Library *library);
static void _monitor_photo_new_cb(void          *data,
                                  Enlil_Library *library,
                                  Enlil_Album   *album,
                                  const char    *path);
static void _monitor_photo_delete_cb(void          *data,
                                     Enlil_Library *library,
                                     Enlil_Album   *album,
                                     const char    *path);
static void _monitor_photo_update_cb(void          *data,
                                     Enlil_Library *library,
                                     Enlil_Album   *album,
                                     const char    *path);
...
static void
_monitor_album_new_cb(void          *data __UNUSED__,
                      Enlil_Library *library,
                      const char    *path)
{
...
static void
_monitor_album_delete_cb(void          *data __UNUSED__,
                         Enlil_Library *library,
                         const char    *path)
{
   //delete the album
...
static void
_monitor_enlil_delete_cb(void          *data __UNUSED__,
                         Enlil_Library *library __UNUSED__)
{
   printf("Enlil delete !!!\n");
}
...
static void
_monitor_photo_new_cb(void          *data __UNUSED__,
                      Enlil_Library *library,
                      Enlil_Album   *album,
                      const char    *path)
{
...
static void
_monitor_photo_delete_cb(void          *data __UNUSED__,
                         Enlil_Library *library,
                         Enlil_Album   *album,
                         const char    *path)
{
...
static void
_monitor_photo_update_cb(void          *data __UNUSED__,
                         Enlil_Library *library,
                         Enlil_Album   *album,
                         const char    *path)
{
