...
static void _sync_album_update_cb(void          *data,
                                  ...
                                  Enlil_Library *library,
                                  Enlil_Album   *album);
static void _sync_album_disapear_cb(void          *data,
                                    Enlil_Sync    *sync,
                                    Enlil_Library *library,
                                    Enlil_Album   *album);
...
static void _sync_photo_update_cb(void        *data,
                                  ...
                                  Enlil_Album *album,
                                  Enlil_Photo *photo);
static void _sync_photo_disapear_cb(void        *data,
                                    Enlil_Sync  *sync,
                                    Enlil_Album *album,
                                    Enlil_Photo *photo);
...
static void
_sync_album_new_cb(void          *data __UNUSED__,
                   Enlil_Sync    *sync __UNUSED__,
                   Enlil_Library *library __UNUSED__,
                   Enlil_Album   *album __UNUSED__)
{
}

static void
_sync_album_update_cb(void          *data __UNUSED__,
                      Enlil_Sync    *sync __UNUSED__,
                      Enlil_Library *library __UNUSED__,
                      Enlil_Album   *album __UNUSED__)
{
...
static void
_sync_album_disapear_cb(void          *data __UNUSED__,
                        Enlil_Sync    *sync __UNUSED__,
                        Enlil_Library *library __UNUSED__,
                        Enlil_Album   *album __UNUSED__)
{
...
static void
_sync_photo_new_cb(void        *data __UNUSED__ ,
                   Enlil_Sync  *sync __UNUSED__ ,
                   Enlil_Album *album __UNUSED__,
                   Enlil_Photo *photo __UNUSED__)
{
}

static void
_sync_photo_update_cb(void        *data __UNUSED__,
                      Enlil_Sync  *sync __UNUSED__,
                      Enlil_Album *album __UNUSED__,
                      Enlil_Photo *photo __UNUSED__)
{
...
static void
_sync_photo_disapear_cb(void        *data __UNUSED__,
                        Enlil_Sync  *sync __UNUSED__,
                        Enlil_Album *album __UNUSED__,
                        Enlil_Photo *photo __UNUSED__)
{
