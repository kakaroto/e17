...
Evas_Object *eyelight_object_item_edje_add(Eyelight_Viewer *pres, Eyelight_Slide *slide, int id_slide, const char *area, const char *edj_file, const char *edje_group);
