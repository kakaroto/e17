...
EAPI E_Config_Dialog *
e_int_config_apps_iiirk_other(E_Container *con, const char *path) 
{
   E_Config_Data *data;
...
_basic_create(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *cfdata) 
{
   ...
   ot = e_widget_frametable_add(evas, D_("All Applications"), 0);
   ...
   ot = e_widget_frametable_add(evas, D_("Selected Applications"), 0);
   ow = e_widget_ilist_add(evas, 24, 24, NULL);
   e_widget_ilist_multi_select_set(ow, 1);
