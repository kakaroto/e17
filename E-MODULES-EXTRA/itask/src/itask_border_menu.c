...
itask_border_menu_get(E_Border *bd, E_Menu *mn)
{
   ...
   // fullscreen toggle doesnt work here for now
   /*
...
static void
_itask_border_menu_cb_kill(void *data, E_Menu *m, E_Menu_Item *mi)
{
   E_Border *bd;
...
/*************************************************************/
static void
_itask_border_menu_cb_shade(void *data, E_Menu *m, E_Menu_Item *mi)
{
   E_Border *bd;
...
static void
_itask_border_menu_cb_fullscreen(void *data, E_Menu *m, E_Menu_Item *mi)
{
   E_Border *bd;
   int toggle;
...
static void
_itask_border_menu_cb_raise(void *data, E_Menu *m, E_Menu_Item *mi)
{
   E_Border *bd;
...
static void
_itask_border_menu_cb_lower(void *data, E_Menu *m, E_Menu_Item *mi)
{
   E_Border *bd;
