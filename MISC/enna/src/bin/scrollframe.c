...
static void _e_smart_child_del_hook(void *data, Evas *e, Evas_Object *obj,
        void *event_info);
static void _e_smart_pan_changed_hook(void *data, Evas_Object *obj,
        void *event_info);
static void _e_smart_pan_pan_changed_hook(void *data, Evas_Object *obj,
        void *event_info);
static void _e_smart_event_wheel(void *data, Evas *e, Evas_Object *obj,
        void *event_info);
...
static void _e_smart_event_mouse_move(void *data, Evas *e, Evas_Object *obj,
        void *event_info);
static void _e_smart_edje_drag_v(void *data, Evas_Object *obj,
        const char *emission, const char *source);
static void _e_smart_edje_drag_h(void *data, Evas_Object *obj,
        const char *emission, const char *source);
...
EAPI void enna_scrollframe_extern_pan_set(Evas_Object *obj, Evas_Object *pan,
        void (*pan_set) (Evas_Object *obj, Evas_Coord x, Evas_Coord y), void (*pan_get) (Evas_Object *obj, Evas_Coord *x, Evas_Coord *y), void (*pan_max_get) (Evas_Object *obj, Evas_Coord *x, Evas_Coord *y), void (*pan_child_size_get) (Evas_Object *obj, Evas_Coord *x, Evas_Coord *y))
{
    API_ENTRY
    return;
...
EAPI void enna_scrollframe_custom_theme_set(Evas_Object *obj,
        char *custom_category, char *custom_group)
{
    API_ENTRY
    return;

    edje_object_file_set(sd->edje_obj, enna_config_theme_get(),
...
EAPI void enna_scrollframe_custom_edje_file_set(Evas_Object *obj, char *file,
        char *group)
{
    API_ENTRY
    return;
...
EAPI void enna_scrollframe_child_pos_set(Evas_Object *obj, Evas_Coord x,
        Evas_Coord y)
{
...
EAPI void enna_scrollframe_child_pos_get(Evas_Object *obj, Evas_Coord *x,
        Evas_Coord *y)
{
    API_ENTRY
    return;
...
static int _e_smart_animator_cb(void *data)
{
    double t;
    E_Smart_Data *sd;
    Evas_Coord x, y;
...
EAPI void enna_scrollframe_child_region_show(Evas_Object *obj, Evas_Coord x,
...
EAPI void enna_scrollframe_child_viewport_size_get(Evas_Object *obj,
...
EAPI void enna_scrollframe_step_size_set(Evas_Object *obj, Evas_Coord x,
        Evas_Coord y)
{
    API_ENTRY
    return;
...
EAPI void enna_scrollframe_step_size_get(Evas_Object *obj, Evas_Coord *x,
        Evas_Coord *y)
{
    API_ENTRY
    return;
...
EAPI void enna_scrollframe_page_size_set(Evas_Object *obj, Evas_Coord x,
        Evas_Coord y)
{
    API_ENTRY
    return;
...
EAPI void enna_scrollframe_page_size_get(Evas_Object *obj, Evas_Coord *x,
        Evas_Coord *y)
{
    API_ENTRY
    return;
...
EAPI void enna_scrollframe_policy_set(Evas_Object *obj,
...
EAPI void enna_scrollframe_policy_get(Evas_Object *obj,
        Enna_Scrollframe_Policy *hbar, Enna_Scrollframe_Policy *vbar)
{
    API_ENTRY
    return;
...
EAPI void enna_scrollframe_single_dir_set(Evas_Object *obj, Evas_Bool single_dir)
{
    API_ENTRY
    return;
        ...
        if (sd->down.dragged)
        {
            ...
            if (at > 0)
            {
                        ...
                        > thumbscroll_momentum_threshhold))
                {
                    ...
                    edje_object_signal_emit(sd->edje_obj, "e,action,hide,vbar",
                            "e");
            }
        ...
        void *event_info)
{
    ...
    if (sd->down.now)
    {
        ...
        if (y < 0)
            y = -y;
        if ((sd->one_dir_at_a_time) && (!sd->down.dir_x) && (!sd->down.dir_y))
        {
            if (x > y)
            {
