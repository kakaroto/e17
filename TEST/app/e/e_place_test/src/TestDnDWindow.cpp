//$Id: dndwindow.cc,v 1.5 2004/03/28 18:57:59 murrayc Exp $ -*- c++ -*-
...
TestDnDWindow::TestDnDWindow (const std::string &helpImage) :
  TestWindow ("TestDnDWindow", helpImage),
  ...
  m_Label_Drop("Drop here\n")
{
  ...
  //Connect signals:
  m_Button_Drag.signal_drag_data_get().connect( sigc::mem_fun(*this, &TestDnDWindow::on_button_drag_data_get));
  ...
  //Connect signals:
  m_Label_Drop.signal_drag_data_received().connect( sigc::mem_fun(*this, &TestDnDWindow::on_label_drop_drag_data_received) );
...
TestDnDWindow::~TestDnDWindow()
{
}

void TestDnDWindow::on_button_drag_data_get(const Glib::RefPtr<Gdk::DragContext>&, Gtk::SelectionData& selection_data, guint, guint)
{
