...
_smart_add(Evas_Object *obj)
{
   ...
   edje_object_signal_callback_add(o, "drag*", "e.dragable.vbar", _smart_edje_drag_v, sd);
   edje_object_signal_callback_add(o, "drag*", "e.dragable.hbar", _smart_edje_drag_h, sd);
