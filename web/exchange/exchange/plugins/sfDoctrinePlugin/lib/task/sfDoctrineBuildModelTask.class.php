 ...
 * @version    SVN: $Id: sfDoctrineBuildModelTask.class.php 9019 2008-05-17 00:21:03Z Jonathan.Wage $
 */
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $import->importSchema(array($config['yaml_schema_path']), 'yml', $config['models_path']);
