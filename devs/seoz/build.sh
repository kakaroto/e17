...
export BUILD_ETC="editje PROTO/eyelight FORMATTING/ecrustify ephoto edje_viewer PROTO/emap PROTO/azy elmdentica eio enlil PROTO/emote emprint clouseau PROTO/enna-explorer" #enki excessive
