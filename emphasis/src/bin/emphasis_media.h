...
void emphasis_tree_mlib_set(Etk_Tree *tree, Eina_List *list,
                            MpdDataType mpd_type, char *tag);

void emphasis_tree_mlib_append(Etk_Tree *tree, Eina_List *list,
                               MpdDataType mpd_type, char *tag);

void emphasis_tree_pls_set(Etk_Tree *tree, Eina_List *playlist);
