 ...
 *
*/
class EdjeEdit : public EdjeObject
{
public:
  EdjeEdit( EvasCanvas &canvas );
  EdjeEdit( EvasCanvas &canvas, const std::string &filename, const std::string &groupname );

  //~EdjeObject(); // TODO: needed?
