...
static void
my_notepad_bt_1(Evas_Object *obj, void *event_info, ElmNotepad *np)
{
  // TODO
}

static void
my_notepad_bt_2(Evas_Object *obj, void *event_info, ElmNotepad *np)
{
  // TODO
}

static void
my_notepad_bt_3(Evas_Object *obj, void *event_info, ElmNotepad *np)
{
  // TODO
}
...
int main (int argc, char **argv)
{
  ...
  li->append("Bg Plain", my_bt_1, NULL);
  li->append("Bg Image", my_bt_2, NULL);
  li->append("Icon Transparent", my_bt_3, NULL);
  ...
  li->append("Entry", my_bt_13, NULL);
  li->append("Entry Scrolled", my_bt_14, NULL);
  li->append("Notepad", my_bt_15, NULL);
