...
cdef extern from "Emotion.h":
    ...
    void emotion_object_play_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool play)
    evas.c_evas.Eina_Bool emotion_object_play_get(evas.c_evas.Evas_Object *obj)
    ...
    evas.c_evas.Eina_Bool emotion_object_video_handled_get(evas.c_evas.Evas_Object *obj)
    evas.c_evas.Eina_Bool emotion_object_audio_handled_get(evas.c_evas.Evas_Object *obj)
    evas.c_evas.Eina_Bool emotion_object_seekable_get(evas.c_evas.Evas_Object *obj)
    ...
    void emotion_object_audio_mute_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool mute)
    evas.c_evas.Eina_Bool emotion_object_audio_mute_get(evas.c_evas.Evas_Object *obj)
    ...
    void emotion_object_video_mute_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool mute)
    evas.c_evas.Eina_Bool emotion_object_video_mute_get(evas.c_evas.Evas_Object *obj)
    ...
    void emotion_object_spu_mute_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool mute)
    evas.c_evas.Eina_Bool emotion_object_spu_mute_get(evas.c_evas.Evas_Object *obj)
