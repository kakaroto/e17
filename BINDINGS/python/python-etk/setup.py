...
setup(name = 'python-etk',
      ...
      install_requires = ['python-evas>=0.2.1', 'python-ecore>=0.2.1', 'python-edje>=0.2.1', 'edje>=0.9.9.050', 'virtkeys>=0.50'],
      setup_requires = ['python-evas>=0.2.1', 'python-ecore>=0.2.1', 'python-edje>=0.2.1', 'edje>=0.9.9.050', 'virtkeys>=0.50'],
      headers = headers,
