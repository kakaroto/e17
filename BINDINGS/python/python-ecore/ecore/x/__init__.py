...
ECORE_X_EVENT_MASK_NONE = 0                         # 0L
ECORE_X_EVENT_MASK_KEY_DOWN = 1                     # (1L << 0)
ECORE_X_EVENT_MASK_KEY_UP = 2                       # (1L << 1)
ECORE_X_EVENT_MASK_MOUSE_DOWN = 4                   # (1L << 2)
ECORE_X_EVENT_MASK_MOUSE_UP = 8                     # (1L << 3)
ECORE_X_EVENT_MASK_MOUSE_IN = 16                    # (1L << 4)
ECORE_X_EVENT_MASK_MOUSE_OUT = 32                   # (1L << 5)
ECORE_X_EVENT_MASK_MOUSE_MOVE = 64                  # (1L << 6)
ECORE_X_EVENT_MASK_WINDOW_DAMAGE = 32768            # (1L << 15)
ECORE_X_EVENT_MASK_WINDOW_VISIBILITY = 65536        # (1L << 16)
ECORE_X_EVENT_MASK_WINDOW_CONFIGURE = 131072        # (1L << 17)
ECORE_X_EVENT_MASK_WINDOW_RESIZE_MANAGE = 262144    # (1L << 18)
ECORE_X_EVENT_MASK_WINDOW_MANAGE = 524288           # (1L << 19)
ECORE_X_EVENT_MASK_WINDOW_CHILD_CONFIGURE = 1048576 # (1L << 20)
ECORE_X_EVENT_MASK_WINDOW_FOCUS_CHANGE = 2097152    # (1L << 21)
ECORE_X_EVENT_MASK_WINDOW_PROPERTY = 4194304        # (1L << 22)
ECORE_X_EVENT_MASK_WINDOW_COLORMAP = 8388608        # (1L << 23)
ECORE_X_EVENT_MASK_WINDOW_GRAB = 16777216           # (1L << 24)
ECORE_X_EVENT_MASK_MOUSE_WHEEL = 536870912          # (1L << 29)
ECORE_X_EVENT_MASK_WINDOW_FOCUS_IN = 1073741824     # (1L << 30)
ECORE_X_EVENT_MASK_WINDOW_FOCUS_OUT = 2147483648    # (1L << 31)
...
ECORE_X_RANDR_ORIENTATION_ROT_0 = 1   # 1 << 0
ECORE_X_RANDR_ORIENTATION_ROT_9 = 2   # 1 << 1
ECORE_X_RANDR_ORIENTATION_ROT_180 = 4 # 1 << 2
ECORE_X_RANDR_ORIENTATION_ROT_270 = 8 # 1 << 3
ECORE_X_RANDR_ORIENTATION_FLIP_X = 16 # 1 << 4
ECORE_X_RANDR_ORIENTATION_FLIP_Y = 32 # 1 << 5
