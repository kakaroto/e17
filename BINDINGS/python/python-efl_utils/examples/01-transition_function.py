...
ee.title = "Transition test: Function"
...
effect = transitions.ContainerEffectFunction(
    transitions.create_composite_effect(transitions.create_effect_slide(1, -1),
                                        transitions.effect_alpha,
                                        transitions.create_effect_scale(0, 0,
                                                                        0, 0),
                                        ),
    1.0)
