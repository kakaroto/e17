...
cdef public class Bubble(Layout) [object PyElementaryBubble, type PyElementaryBubble_Type]:
    ...
    The bubble widget contains 5 important visual elements:
      ...
      - The C{label} is a text which appears to the right of the icon if the
        corner is B{top_left} or B{bottom_left} and is right aligned to the frame
        otherwise.
