...
cdef extern from "Elementary.h":
    ...
    # Config
    evas.c_evas.Eina_Bool    elm_config_save()
    void                     elm_config_reload()
    void                     elm_config_all_flush()
    char                    *elm_config_profile_get()
    char                    *elm_config_profile_dir_get(char *profile, evas.c_evas.Eina_Bool is_user)
    void                     elm_config_profile_dir_free(char *p_dir)
    evas.c_evas.Eina_List   *elm_config_profile_list_get()
    void                     elm_config_profile_list_free(evas.c_evas.Eina_List *l)
    void                     elm_config_profile_set(char *profile)
    evas.c_evas.Eina_Bool    elm_config_scroll_bounce_enabled_get()
    void                     elm_config_scroll_bounce_enabled_set(evas.c_evas.Eina_Bool enabled)
    ...
    evas.c_evas.Eina_Bool    elm_config_scroll_thumbscroll_enabled_get()
    void                     elm_config_scroll_thumbscroll_enabled_set(evas.c_evas.Eina_Bool enabled)
    ...
    evas.c_evas.Eina_Bool    elm_config_password_show_last_get()
    void                     elm_config_password_show_last_set(evas.c_evas.Eina_Bool password_show_last)
    ...
    evas.c_evas.Eina_List   *elm_config_text_classes_list_get()
    void                     elm_config_text_classes_list_free(evas.c_evas.Eina_List *list)
    evas.c_evas.Eina_List   *elm_config_font_overlay_list_get()
    ...
    evas.c_evas.Eina_Bool    elm_config_cache_flush_enabled_get()
    void                     elm_config_cache_flush_enabled_set(evas.c_evas.Eina_Bool enabled)
    ...
    evas.c_evas.Eina_Bool    elm_config_mirrored_get()
    void                     elm_config_mirrored_set(evas.c_evas.Eina_Bool mirrored)
    ...
    evas.c_evas.Eina_List   *elm_theme_overlay_list_get(Elm_Theme *th)
    void                     elm_theme_extension_add(Elm_Theme *th, char *item)
    void                     elm_theme_extension_del(Elm_Theme *th, char *item)
    evas.c_evas.Eina_List   *elm_theme_extension_list_get(Elm_Theme *th)
    void                     elm_theme_set(Elm_Theme *th, char *theme)
    char                    *elm_theme_get(Elm_Theme *th)
    evas.c_evas.Eina_List   *elm_theme_list_get(Elm_Theme *th)
    char                    *elm_theme_list_item_path_get(char *f, evas.c_evas.Eina_Bool *in_search_path)
    void                     elm_theme_flush(Elm_Theme *th)
    void                     elm_theme_full_flush()
    evas.c_evas.Eina_List   *elm_theme_name_available_list_new()
    void                     elm_theme_name_available_list_free(evas.c_evas.Eina_List *list)
    ...
    void                     elm_object_access_info_set(evas.c_evas.Evas_Object *obj, char *txt)
    evas.c_evas.Evas_Object *elm_object_name_find(evas.c_evas.Evas_Object *obj, char *name, int recurse)
    ...
    void                     elm_object_signal_emit(evas.c_evas.Evas_Object *obj, char *emission, char *source)
    #void                     elm_object_signal_callback_add(evas.c_evas.Evas_Object *obj, char *emission, char *source, Edje_Signal_Cb func, void *data)
    #void                    *elm_object_signal_callback_del(evas.c_evas.Evas_Object *obj, char *emission, char *source, Edje_Signal_Cb func)
    ...
    char                    *elm_object_cursor_get(evas.c_evas.Evas_Object *obj)
    ...
    evas.c_evas.Eina_Bool    elm_object_mirrored_get(evas.c_evas.Evas_Object *obj)
    void                     elm_object_mirrored_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool mirrored)
    evas.c_evas.Eina_Bool    elm_object_mirrored_automatic_get(evas.c_evas.Evas_Object *obj)
    void                     elm_object_mirrored_automatic_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool automatic)
    ...
    void                     elm_object_scroll_lock_x_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool lock)
    void                     elm_object_scroll_lock_y_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool lock)
    evas.c_evas.Eina_Bool    elm_object_scroll_lock_x_get(evas.c_evas.Evas_Object *obj)
    evas.c_evas.Eina_Bool    elm_object_scroll_lock_y_get(evas.c_evas.Evas_Object *obj)

    # Object - Theme (elm_theme.h)
    void                     elm_object_theme_set(evas.c_evas.Evas_Object *obj, Elm_Theme *th)
    Elm_Theme               *elm_object_theme_get(evas.c_evas.Evas_Object *obj)
    ...
    void                     elm_object_tooltip_domain_translatable_text_set(evas.c_evas.Evas_Object *obj, char *domain, char *text)
    void                     elm_object_tooltip_translatable_text_set(evas.c_evas.Evas_Object *obj, char *text)
    ...
    evas.c_evas.Eina_Bool    elm_object_tooltip_window_mode_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool disable)
    ...
    void                     elm_object_item_content_set(Elm_Object_Item *it, evas.c_evas.Evas_Object* content)
    evas.c_evas.Evas_Object *elm_object_item_part_content_get(Elm_Object_Item *it, const_char_ptr part)
    evas.c_evas.Evas_Object *elm_object_item_content_get(Elm_Object_Item *it)
    evas.c_evas.Evas_Object *elm_object_item_part_content_unset(Elm_Object_Item *it, const_char_ptr part)
    evas.c_evas.Evas_Object *elm_object_item_content_unset(Elm_Object_Item *it)
    ...
    evas.c_evas.Eina_Bool    elm_object_item_tooltip_window_mode_set(Elm_Object_Item *it, evas.c_evas.Eina_Bool disable)
    evas.c_evas.Eina_Bool    elm_object_item_tooltip_window_mode_get(Elm_Object_Item *it)
    ...
    void                     elm_entry_file_get(evas.c_evas.Evas_Object *obj, const_char_ptr *file, Elm_Text_Format *format)
    ...
    # Generic List (api:TODO  cb:DONE  test:TODO  doc:DONE)
    ...
    evas.c_evas.Eina_Bool    elm_genlist_multi_select_get(evas.c_evas.Evas_Object *obj)
    ...
    void                     elm_genlist_bounce_get(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool *h_bounce, evas.c_evas.Eina_Bool *v_bounce)
    ...
    Elm_Object_Item         *elm_genlist_item_sorted_insert(evas.c_evas.Evas_Object *obj, Elm_Genlist_Item_Class *itc, void *data, Elm_Object_Item *parent, Elm_Genlist_Item_Type flags, evas.c_evas.Eina_Compare_Cb comp, evas.c_evas.Evas_Smart_Cb func, void *func_data)
    ...
    void                     elm_genlist_scroller_policy_set(evas.c_evas.Evas_Object *obj, Elm_Scroller_Policy policy_h, Elm_Scroller_Policy policy_v)
    void                     elm_genlist_scroller_policy_get(evas.c_evas.Evas_Object *obj, Elm_Scroller_Policy *policy_h, Elm_Scroller_Policy *policy_v)
    ...
    void                     elm_genlist_realized_items_update(evas.c_evas.Evas_Object *obj)
    unsigned int             elm_genlist_items_count(evas.c_evas.Evas_Object *obj)
    ...
    evas.c_evas.Eina_Bool    elm_genlist_item_tooltip_window_mode_set(Elm_Object_Item *it, evas.c_evas.Eina_Bool disable)
    evas.c_evas.Eina_Bool    elm_genlist_item_tooltip_window_mode_get(Elm_Object_Item *it)
    ...
    evas.c_evas.Eina_Bool    elm_genlist_homogeneous_get(evas.c_evas.Evas_Object *obj)
    void                     elm_genlist_block_count_set(evas.c_evas.Evas_Object *obj, int n)
    int                      elm_genlist_block_count_get(evas.c_evas.Evas_Object *obj)
    void                     elm_genlist_longpress_timeout_set(evas.c_evas.Evas_Object *obj, double timeout)
    double                   elm_genlist_longpress_timeout_get(evas.c_evas.Evas_Object *obj)
    ...
    void                     elm_genlist_item_all_contents_unset(Elm_Object_Item *it, evas.c_evas.Eina_List **l)
    ...
    void                     elm_genlist_item_decorate_mode_set(Elm_Object_Item *it, char *decorate_it_type, evas.c_evas.Eina_Bool decorate_it_set)
    char                    *elm_genlist_item_decorate_mode_get(Elm_Object_Item *it)
    Elm_Object_Item         *elm_genlist_decorated_item_get(evas.c_evas.Evas_Object *obj)
    void                     elm_genlist_reorder_mode_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool reorder_mode)
    evas.c_evas.Eina_Bool    elm_genlist_reorder_mode_get(evas.c_evas.Evas_Object *obj)
    Elm_Genlist_Item_Type    elm_genlist_item_type_get(Elm_Object_Item *it)
    void                     elm_genlist_decorate_mode_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool decorated)
    evas.c_evas.Eina_Bool    elm_genlist_decorate_mode_get(evas.c_evas.Evas_Object *obj)
    void                     elm_genlist_item_flip_set(Elm_Object_Item *it, evas.c_evas.Eina_Bool flip)
    evas.c_evas.Eina_Bool    elm_genlist_item_flip_get(Elm_Object_Item *it)
    void                     elm_genlist_tree_effect_enabled_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool enabled)
    evas.c_evas.Eina_Bool    elm_genlist_tree_effect_enabled_get(evas.c_evas.Evas_Object *obj)
    ...
    void                     elm_genlist_highlight_mode_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool highlight)
    evas.c_evas.Eina_Bool    elm_genlist_highlight_mode_get(evas.c_evas.Evas_Object *obj)
    void                     elm_genlist_select_mode_set(evas.c_evas.Evas_Object *obj, Elm_Object_Select_Mode mode)
    Elm_Object_Select_Mode   elm_genlist_select_mode_get(evas.c_evas.Evas_Object *obj)
    ...
    # Hoversel object (api:DONE  cb:DONE  test:TODO  doc:TODO)
    evas.c_evas.Evas_Object *elm_hoversel_add(evas.c_evas.Evas_Object *parent)
    void                     elm_hoversel_horizontal_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool horizontal)
    evas.c_evas.Eina_Bool    elm_hoversel_horizontal_get(evas.c_evas.Evas_Object *obj)
    void                     elm_hoversel_hover_parent_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Evas_Object *parent)
    evas.c_evas.Evas_Object *elm_hoversel_hover_parent_get(evas.c_evas.Evas_Object *obj)
    void                     elm_hoversel_hover_begin(evas.c_evas.Evas_Object *obj)
    void                     elm_hoversel_hover_end(evas.c_evas.Evas_Object *obj)
    evas.c_evas.Eina_Bool    elm_hoversel_expanded_get(evas.c_evas.Evas_Object *obj)
    void                     elm_hoversel_clear(evas.c_evas.Evas_Object *obj)
    evas.c_evas.Eina_List   *elm_hoversel_items_get(evas.c_evas.Evas_Object *obj)
    ...
    # Layout object (api:TODO  cb:DONE  test:TODO  doc:TODO)
    ...
    void                     elm_layout_signal_emit(evas.c_evas.Evas_Object *obj, char *emission, char *source)
    #void                    elm_layout_signal_callback_add(evas.c_evas.Evas_Object *obj, char *emission, char *source, Edje_Signal_Cb func, void *data)
    #void                   *elm_layout_signal_callback_del(evas.c_evas.Evas_Object *obj, char *emission, char *source, Edje_Signal_Cb func)
    evas.c_evas.Eina_Bool    elm_layout_box_append(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Evas_Object *child)
    evas.c_evas.Eina_Bool    elm_layout_box_prepend(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Evas_Object *child)
    evas.c_evas.Eina_Bool    elm_layout_box_insert_before(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Evas_Object *child, evas.c_evas.Evas_Object *reference)
    evas.c_evas.Eina_Bool    elm_layout_box_insert_at(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Evas_Object *child, unsigned int pos)
    evas.c_evas.Evas_Object *elm_layout_box_remove(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Evas_Object *child)
    evas.c_evas.Eina_Bool    elm_layout_box_remove_all(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Eina_Bool clear)
    evas.c_evas.Eina_Bool    elm_layout_table_pack(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Evas_Object *child_obj, unsigned short col, unsigned short row, unsigned short colspan, unsigned short rowspan)
    evas.c_evas.Evas_Object *elm_layout_table_unpack(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Evas_Object *child_obj)
    evas.c_evas.Eina_Bool    elm_layout_table_clear(evas.c_evas.Evas_Object *obj, char *part, evas.c_evas.Eina_Bool clear)
    evas.c_evas.Evas_Object *elm_layout_edje_get(evas.c_evas.Evas_Object *obj)
    char                    *elm_layout_data_get(evas.c_evas.Evas_Object *obj, char *key)
    void                     elm_layout_sizing_eval(evas.c_evas.Evas_Object *obj)
    evas.c_evas.Eina_Bool    elm_layout_part_cursor_set(evas.c_evas.Evas_Object *obj, char *part_name, char *cursor)
    char                    *elm_layout_part_cursor_get(evas.c_evas.Evas_Object *obj, char *part_name)
    evas.c_evas.Eina_Bool    elm_layout_part_cursor_unset(evas.c_evas.Evas_Object *obj, char *part_name)
    evas.c_evas.Eina_Bool    elm_layout_part_cursor_style_set(evas.c_evas.Evas_Object *obj, char *part_name, char *style)
    char                    *elm_layout_part_cursor_style_get(evas.c_evas.Evas_Object *obj, char *part_name)
    evas.c_evas.Eina_Bool    elm_layout_part_cursor_engine_only_set(evas.c_evas.Evas_Object *obj, char *part_name, evas.c_evas.Eina_Bool engine_only)
    evas.c_evas.Eina_Bool    elm_layout_part_cursor_engine_only_get(evas.c_evas.Evas_Object *obj, char *part_name)
    evas.c_evas.Eina_Bool    elm_layout_content_set(evas.c_evas.Evas_Object *obj, char *swallow, evas.c_evas.Evas_Object *content)
    ...
    evas.c_evas.Eina_Bool    elm_layout_text_set(evas.c_evas.Evas_Object *obj, char *part, char *text)
    ...
    # List object (api:TODO  cb:DONE  test:TODO  doc:TODO)
    ...
    Elm_Object_Select_Mode   elm_list_select_mode_get(evas.c_evas.Evas_Object *obj)
    void                     elm_list_bounce_set(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool h_bounce, evas.c_evas.Eina_Bool v_bounce)
    void                     elm_list_bounce_get(evas.c_evas.Evas_Object *obj, evas.c_evas.Eina_Bool *h_bounce, evas.c_evas.Eina_Bool *v_bounce)
    void                     elm_list_scroller_policy_set(evas.c_evas.Evas_Object *obj, Elm_Scroller_Policy policy_h, Elm_Scroller_Policy policy_v)
    void                     elm_list_scroller_policy_get(evas.c_evas.Evas_Object *obj, Elm_Scroller_Policy *policy_h, Elm_Scroller_Policy *policy_v)
    ...
    Elm_Object_Item         *elm_list_item_sorted_insert(evas.c_evas.Evas_Object *obj, char *label, evas.c_evas.Evas_Object *icon, evas.c_evas.Evas_Object *end, void (*func) (void *data, evas.c_evas.Evas_Object *obj, void *event_info), void *data, evas.c_evas.Eina_Compare_Cb cmp_func)
    ...
    void                     elm_list_item_separator_set(Elm_Object_Item *it, evas.c_evas.Eina_Bool setting)
    evas.c_evas.Eina_Bool    elm_list_item_separator_get(Elm_Object_Item *it)
    ...
    Elm_Object_Item         *elm_list_first_item_get(evas.c_evas.Evas_Object *obj)
    Elm_Object_Item         *elm_list_last_item_get(evas.c_evas.Evas_Object *obj)
    ...
    Elm_Object_Item         *elm_naviframe_item_push(evas.c_evas.Evas_Object *obj, char *title_label, evas.c_evas.Evas_Object *prev_btn, evas.c_evas.Evas_Object *next_btn, evas.c_evas.Evas_Object *content, char *item_style)
    ...
    evas.c_evas.Eina_Bool    elm_naviframe_prev_btn_auto_pushed_get(evas.c_evas.Evas_Object *obj)
    ...
    evas.c_evas.const_Evas_Object *elm_win_icon_object_get(evas.c_evas.Evas_Object*)
