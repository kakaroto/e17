...
cdef extern from "Elementary.h":
    ...
    Eina_Bool                elm_icon_file_set(Evas_Object *obj, char *file, char *group)
    #Eina_Bool                elm_icon_memfile_set(Evas_Object *obj, void *img, size_t size, char *format, char *key);
    void                    *elm_icon_file_get(Evas_Object *obj, char **file, char **group)
    ...
    Eina_Bool                elm_icon_smooth_get(Evas_Object *obj)
    void                     elm_icon_no_scale_set(Evas_Object *obj, Eina_Bool no_scale)
    Eina_Bool                elm_icon_no_scale_get(Evas_Object *obj)
    void                     elm_icon_resizable_set(Evas_Object *obj, Eina_Bool scale_up, Eina_Bool scale_down)
    void                     elm_icon_resizable_get(Evas_Object *obj, Eina_Bool *scale_up, Eina_Bool *scale_down)
    void                     elm_icon_size_get(Evas_Object *obj, int *w, int *h)
    void                     elm_icon_fill_outside_set(Evas_Object *obj, Eina_Bool fill_outside)
    Eina_Bool                elm_icon_fill_outside_get(Evas_Object *obj)
    void                     elm_icon_prescale_set(Evas_Object *obj, int size)
    int                      elm_icon_prescale_get(Evas_Object *obj)
    ...
    Eina_Bool                elm_icon_animated_available_get(Evas_Object *obj)
    void                     elm_icon_animated_set(Evas_Object *obj, Eina_Bool animated)
    Eina_Bool                elm_icon_animated_get(Evas_Object *obj)
    void                     elm_icon_animated_play_set(Evas_Object *obj, Eina_Bool play)
    Eina_Bool                elm_icon_animated_play_get(Evas_Object *obj)
    void                     elm_icon_aspect_fixed_set(Evas_Object *obj, Eina_Bool fixed)
    Eina_Bool                elm_icon_aspect_fixed_get(Evas_Object *obj)
