...
cdef extern from "Elementary.h":
    ...
    char *elm_toolbar_item_label_get(Elm_Object_Item *item)
    void  elm_toolbar_item_label_set(Elm_Object_Item *item, char *label)
    void *elm_toolbar_item_data_get(Elm_Object_Item *item)
    void  elm_toolbar_item_data_set(Elm_Object_Item *item, void *data)
    void  elm_toolbar_item_del(Elm_Object_Item *item)
    void  elm_toolbar_item_del_cb_set(Elm_Object_Item *it, void (*func)(void *data, evas.c_evas.Evas_Object *obj, void *event_info))
    ...
    evas.c_evas.Eina_Bool elm_toolbar_item_disabled_get(Elm_Object_Item *item)
    Elm_Object_Item *elm_toolbar_selected_item_get(evas.c_evas.Evas_Object *obj)
    void  elm_toolbar_item_disabled_set(Elm_Object_Item *item, evas.c_evas.Eina_Bool disabled)
    ...
    void         elm_toolbar_item_tooltip_text_set(Elm_Object_Item *item, char *text)
    void         elm_toolbar_item_tooltip_content_cb_set(Elm_Object_Item *item, Elm_Tooltip_Item_Content_Cb func, void *data, evas.c_evas.Evas_Smart_Cb del_cb)
    void         elm_toolbar_item_tooltip_unset(Elm_Object_Item *item)
    void         elm_toolbar_item_tooltip_style_set(Elm_Object_Item *item, char *style)
    char*        elm_toolbar_item_tooltip_style_get(Elm_Object_Item *item)
    void         elm_toolbar_item_cursor_set(Elm_Object_Item *item, char *cursor)
    void         elm_toolbar_item_cursor_unset(Elm_Object_Item *item)
    void         elm_toolbar_item_cursor_style_set(Elm_Object_Item *item, char *style)
    char*        elm_toolbar_item_cursor_style_get(Elm_Object_Item *item)
    void         elm_toolbar_item_cursor_engine_only_set(Elm_Object_Item *item, evas.c_evas.Eina_Bool engine_only)
    evas.c_evas.Eina_Bool elm_toolbar_item_cursor_engine_only_get(Elm_Object_Item *item)
    ...
    void         elm_list_item_del(Elm_Object_Item *item)
    void         elm_list_item_del_cb_set(Elm_Object_Item *item, void (*func)(void *data, evas.c_evas.Evas_Object *obj, void *event_info))
    void  *elm_list_item_data_get(Elm_Object_Item *item)
    evas.c_evas.Evas_Object *elm_list_item_icon_get(Elm_Object_Item *item)
    evas.c_evas.Evas_Object *elm_list_item_end_get(Elm_Object_Item *item)
    evas.c_evas.Evas_Object *elm_list_item_object_get(Elm_Object_Item *item)
    char* elm_list_item_label_get(Elm_Object_Item *item)
    void elm_list_item_label_set(Elm_Object_Item *item, char* text)
    Elm_Object_Item *elm_list_item_prev(Elm_Object_Item *it)
    Elm_Object_Item *elm_list_item_next(Elm_Object_Item *it)
    void         elm_list_item_tooltip_text_set(Elm_Object_Item *item, char *text)
    void         elm_list_item_tooltip_content_cb_set(Elm_Object_Item *item, Elm_Tooltip_Item_Content_Cb func, void *data, evas.c_evas.Evas_Smart_Cb del_cb)
    void         elm_list_item_tooltip_unset(Elm_Object_Item *item)
    void         elm_list_item_tooltip_style_set(Elm_Object_Item *item, char *style)
    char*        elm_list_item_tooltip_style_get(Elm_Object_Item *item)
    void         elm_list_item_cursor_set(Elm_Object_Item *item, char *cursor)
    void         elm_list_item_cursor_unset(Elm_Object_Item *item)
    void         elm_list_item_cursor_style_set(Elm_Object_Item *item, char *style)
    char*        elm_list_item_cursor_style_get(Elm_Object_Item *item)
    void         elm_list_item_cursor_engine_only_set(Elm_Object_Item *item, evas.c_evas.Eina_Bool engine_only)
    evas.c_evas.Eina_Bool elm_list_item_cursor_engine_only_get(Elm_Object_Item *item)
    ...
    evas.c_evas.Evas_Object *elm_genlist_item_genlist_get(Elm_Object_Item *item)
    ...
    void elm_genlist_item_disabled_set(Elm_Object_Item *item, evas.c_evas.Eina_Bool disabled)
    evas.c_evas.Eina_Bool elm_genlist_item_disabled_get(Elm_Object_Item *item)
    ...
    void elm_genlist_item_del(Elm_Object_Item *item)
    void *elm_genlist_item_data_get(Elm_Object_Item *item)
    void elm_genlist_item_data_set(Elm_Object_Item *it, void *data)
    ...
    evas.c_evas.Evas_Object *elm_gengrid_item_gengrid_get(Elm_Object_Item *item)
