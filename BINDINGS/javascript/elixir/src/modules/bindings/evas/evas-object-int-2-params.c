...
FAST_CALL_PARAMS_SPEC(evas_object_size_hint_min_set, elixir_evas_object_int_2_params, _evas_object_polygon_double_int_params);
FAST_CALL_PARAMS_SPEC(evas_object_size_hint_max_set, elixir_evas_object_int_2_params, _evas_object_polygon_double_int_params);
FAST_CALL_PARAMS_SPEC(evas_object_size_hint_request_set, elixir_evas_object_int_2_params, _evas_object_polygon_double_int_params);
