...
void cb_seek_time(Etk_Object *object, Etk_Event_Mouse_Up_Down *event,
                  void *data);
...
void cb_emphasis_bindings_key(Etk_Object *object, Etk_Event_Key_Up_Down *event, 
                              void *data);
void cb_mlib_bindings_key(Etk_Object *object, Etk_Event_Key_Up_Down *event,
                          void *data);


void cb_pls_contextual_menu(Etk_Object *object, Etk_Event_Mouse_Up_Down *event, 
                            void *data);
