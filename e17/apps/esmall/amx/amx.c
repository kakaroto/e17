...
#endif							/*  */ if (amx->callback == NULL) return AMX_ERR_CALLBACK; amx->flags &= ~AMX_FLAG_BROWSE;
...
int amx_SetString(cell * dest, char *source, int pack) {	/* the memory blocks should not overlap */
