...
void                on_new_icon_clicked(GtkButton * button, gpointer user_data);

void                on_new_text_clicked(GtkButton * button, gpointer user_data);

void                on_raise_clicked(GtkButton * button, gpointer user_data);

void                on_lower_clicked(GtkButton * button, gpointer user_data);
...
void
             ...
             on_browse_clicked_clicked(GtkButton * button, gpointer user_data);

void
 
             on_borwse_hilited_clicked(GtkButton * button, gpointer user_data);

void
               on_browse_normal_clicked(GtkButton * button, gpointer user_data);

void
 
             on_browse_disabled_clicked(GtkButton * button, gpointer user_data);
...
void                on_zoomin_clicked(GtkButton * button, gpointer user_data);

void                on_zoomout_clicked(GtkButton * button, gpointer user_data);
...
void                on_file_ok_clicked(GtkButton * button, gpointer user_data);

void
               on_file_cancel_clicked(GtkButton * button, gpointer user_data);

void                on_software_clicked(GtkButton * button, gpointer user_data);
...
void
             ...
             on_browse_selected_clicked(GtkButton * button, gpointer user_data);
...
void
               on_add_state_p_clicked(GtkButton * button, gpointer user_data);
