...
create_toplevel(void)
{
	...
	gtk_tooltips_set_tip(tooltips, draft, _("Toggle draft display mode"),
			     NULL);
	...
	content_alignment_h_adj =
		gtk_adjustment_new(0, -9999, 9999, 0.1, 10, 10);
	content_alignment_h =
		gtk_spin_button_new(GTK_ADJUSTMENT(content_alignment_h_adj), 1,
				    2);
	...
	content_alignment_v_adj =
		gtk_adjustment_new(0, -9999, 9999, 0.1, 10, 10);
	content_alignment_v =
		gtk_spin_button_new(GTK_ADJUSTMENT(content_alignment_v_adj), 1,
				    2);
	...
	use_contents_h =
		gtk_check_button_new_with_label(_
						("Use Horizontal Size of Contents"));
	...
	gtk_clist_set_selection_mode(GTK_CLIST(sync_list),
	...
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Close"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Iconify"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Raise"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Lower"));
	class_combo_items =
	...
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Shade"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Menu"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Resize"));
	class_combo_items =
		g_list_append(class_combo_items,
			      (gpointer) _("Resize_Horizontal"));
	class_combo_items =
		g_list_append(class_combo_items,
			      (gpointer) _("Resize_Vertical"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Icon"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("State"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Load"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Geometry"));
	class_combo_items =
		g_list_append(class_combo_items,
			      (gpointer) _("Scrollbar_Trough"));
	class_combo_items =
		g_list_append(class_combo_items, (gpointer) _("Scrollbar_Bar"));
	class_combo_items =
		g_list_append(class_combo_items,
			      (gpointer) _("Scrollbar_Arrow1"));
	class_combo_items =
		g_list_append(class_combo_items,
			      (gpointer) _("Scrollbar_Arrow2"));
	gtk_combo_set_popdown_strings(GTK_COMBO(class_combo),
				      class_combo_items);
	...
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Title BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Title FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Border BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Border FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Border Button BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Border Button FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Button BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Button FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Pointer BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Pointer FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Background BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Background FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Selected BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Selected FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Sticky BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Sticky FG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Disabled BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Disabled FG"));
	color_class_combo_items =
	...
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Viewport BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Viewport FG"));
	color_class_combo_items =
	...
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Gadget BG"));
	color_class_combo_items =
		g_list_append(color_class_combo_items,
			      (gpointer) _("Gadget FG"));
	...
	tile_h_combo_items =
		g_list_append(tile_h_combo_items, (gpointer) _("Fill"));
	tile_h_combo_items =
		g_list_append(tile_h_combo_items, (gpointer) _("Tile"));
	tile_h_combo_items =
		g_list_append(tile_h_combo_items, (gpointer) _("Tile Integer"));
	gtk_combo_set_popdown_strings(GTK_COMBO(tile_h_combo),
				      tile_h_combo_items);
	...
	tile_v_combo_items =
		g_list_append(tile_v_combo_items, (gpointer) _("Fill"));
	tile_v_combo_items =
		g_list_append(tile_v_combo_items, (gpointer) _("Tile"));
	tile_v_combo_items =
		g_list_append(tile_v_combo_items, (gpointer) _("Tile Integer"));
	gtk_combo_set_popdown_strings(GTK_COMBO(tile_v_combo),
				      tile_v_combo_items);
	...
	bit_inset_l =
		gtk_spin_button_new(GTK_ADJUSTMENT(bit_inset_l_adj), 1, 0);
	...
	bit_inset_r =
		gtk_spin_button_new(GTK_ADJUSTMENT(bit_inset_r_adj), 1, 0);
	...
	bit_inset_t =
		gtk_spin_button_new(GTK_ADJUSTMENT(bit_inset_t_adj), 1, 0);
	...
	bit_inset_b =
		gtk_spin_button_new(GTK_ADJUSTMENT(bit_inset_b_adj), 1, 0);
	...
	gtk_tooltips_set_tip(tooltips, zoomin, _("Click to zoom in further"),
			     NULL);
...
create_render_method(void)
{
	...
	gtk_window_set_wmclass(GTK_WINDOW(render_method), "RenderMethod",
			       "Etcher");

	dialog_vbox1 = GTK_DIALOG(render_method)->vbox;
	gtk_object_set_data(GTK_OBJECT(render_method), "dialog_vbox1",
			    dialog_vbox1);
	...
	gtk_box_pack_start(GTK_BOX(dialog_action_area1), hbuttonbox2, TRUE,
			   TRUE, 0);
...
create_preferences(void)
{
	...
	gtk_window_set_wmclass(GTK_WINDOW(preferences), "Preferences",
			       "Etcher");

	dialog_vbox2 = GTK_DIALOG(preferences)->vbox;
	gtk_object_set_data(GTK_OBJECT(preferences), "dialog_vbox2",
			    dialog_vbox2);
	...
	render2 =
		gtk_radio_button_new_with_label(render_group,
						_
						("Use 3D accelerated display method"));
	...
	gtk_tooltips_set_tip(tooltips, entry1,
			     _("The image used to tile in the background"),
			     NULL);
	...
	gtk_box_pack_start(GTK_BOX(dialog_action_area2), hbuttonbox3, TRUE,
			   TRUE, 0);
