...
create_toplevel (void)
{
  ...
  GtkWidget *use_smart_size;
  GtkWidget *smartsize_set;
  GtkWidget *label8;
  ...
  gtk_object_set_data_full (GTK_OBJECT (toplevel), "scrolledwindow5", scrolledwindow5,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_table_attach (GTK_TABLE (table3), use_contents_h, 0, 2, 5, 6,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table3), use_contents_v, 0, 2, 6, 7,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  use_smart_size = gtk_check_button_new_with_label (_("Smart Size"));
  gtk_widget_ref (use_smart_size);
  gtk_object_set_data_full (GTK_OBJECT (toplevel), "use_smart_size", use_smart_size,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (use_smart_size);
  gtk_table_attach (GTK_TABLE (table3), use_smart_size, 2, 3, 5, 6,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);

  smartsize_set = gtk_button_new_with_label (_("Smart Size"));
  gtk_widget_ref (smartsize_set);
  gtk_object_set_data_full (GTK_OBJECT (toplevel), "smartsize_set", smartsize_set,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (smartsize_set);
  gtk_table_attach (GTK_TABLE (table3), smartsize_set, 2, 3, 6, 7,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (toplevel), "state_entry_ok", state_entry_ok,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (toplevel), "scrolledwindow6", scrolledwindow6,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  bit_pref_h_adj = gtk_adjustment_new (1, 0, 999999, 1, 10, 10);
  ...
  bit_pref_v_adj = gtk_adjustment_new (1, 0, 999999, 1, 10, 10);
  ...
  gtk_signal_connect (GTK_OBJECT (images), "unselect_row",
                      GTK_SIGNAL_FUNC (on_images_unselect_row),
                      NULL);
  ...
  gtk_signal_connect (GTK_OBJECT (states), "unselect_row",
                      GTK_SIGNAL_FUNC (on_states_unselect_row),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (add_state), "clicked",
                      GTK_SIGNAL_FUNC (on_add_state_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (remove_state), "clicked",
                      GTK_SIGNAL_FUNC (on_remove_state_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (use_smart_size), "clicked",
                      GTK_SIGNAL_FUNC (on_use_smart_size_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (smartsize_set), "clicked",
                      GTK_SIGNAL_FUNC (on_smartsize_set_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (browse_state), "clicked",
                      GTK_SIGNAL_FUNC (on_browse_state_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (state_entry_ok), "clicked",
                      GTK_SIGNAL_FUNC (on_state_entry_ok_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (states2), "select_row",
                      GTK_SIGNAL_FUNC (on_states2_select_row),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (states2), "unselect_row",
                      GTK_SIGNAL_FUNC (on_states2_unselect_row),
                      NULL);
...
create_add_state (void)
{
  ...
  gtk_object_set_data_full (GTK_OBJECT (add_state), "add_state_entry", add_state_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_tooltips_set_tip (tooltips, add_state_ok, _("Add state name to the ebits."), NULL);

  add_state_cancel = gtk_button_new_with_label (_("Cancel"));
  gtk_widget_ref (add_state_cancel);
  gtk_object_set_data_full (GTK_OBJECT (add_state), "add_state_cancel", add_state_cancel,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_signal_connect (GTK_OBJECT (add_state), "delete_event",
                      GTK_SIGNAL_FUNC (on_add_state_delete_event),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (add_state_ok), "clicked",
                      GTK_SIGNAL_FUNC (on_add_state_ok_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (add_state_cancel), "clicked",
                      GTK_SIGNAL_FUNC (on_add_state_cancel_clicked),
                      NULL);
...
create_window1 (void)
{
  ...
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook2), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook2), 0), label77);
  ...
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook2), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook2), 2), label79);
