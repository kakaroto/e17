...
create_toplevel(void)
{
   ...
   GtkWidget          *tile_h;
   GtkWidget          *label72;
   GtkWidget          *browse_state;
   GtkWidget          *state_entry_ok;
   ...
   GtkWidget          *label81;
   GtkObject          *bit_pref_h_adj;
   GtkWidget          *bit_pref_h;
   GtkObject          *bit_pref_v_adj;
   GtkWidget          *bit_pref_v;
   GtkWidget          *label52;
   ...
   preferences1 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(preferences1)->child),
				   _("_Preferences..."));
   gtk_widget_add_accelerator(preferences1, "activate_item", file1_menu_accels,
			      tmp_key, 0, 0);
   ...
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(delete1)->child),
				   _("_Delete"));
   gtk_widget_add_accelerator(delete1, "activate_item", edit1_menu_accels,
			      tmp_key, 0, 0);
   ...
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(undo1)->child),
				   _("_Undo"));
   gtk_widget_add_accelerator(undo1, "activate_item", edit1_menu_accels,
			      tmp_key, 0, 0);
   ...
   redo1 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(redo1)->child),
				   _("_Redo"));
   gtk_widget_add_accelerator(redo1, "activate_item", edit1_menu_accels,
			      tmp_key, 0, 0);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "themenotebook",
			    themenotebook, (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "scrolledwindow1",
			    scrolledwindow1,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   reset = gtk_toolbar_append_element(GTK_TOOLBAR(toolbar3),
				      ...
				      _("Reset"),
				      _
				      ("Reset packing area to default size and location"),
   ...
   gtk_tooltips_set_tip(tooltips, prop_apply,
			_("Apply current bit settings to the bit"), NULL);
   ...
   gtk_tooltips_set_tip(tooltips, prop_reset,
			_("Reset bit settings to current value"), NULL);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "scrolledwindow3",
			    scrolledwindow3,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "table10", table10,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "scrolledwindow5",
			    scrolledwindow5,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(scrolledwindow5);
   gtk_table_attach(GTK_TABLE(table10), scrolledwindow5, 0, 2, 0, 1,
   ...
   gtk_container_add(GTK_CONTAINER(scrolledwindow5), states);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "label69", label69,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(label69);
   gtk_clist_set_column_widget(GTK_CLIST(states), 0, label69);

   add_state = gtk_button_new_with_label(_("Add"));
   gtk_widget_ref(add_state);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "add_state", add_state,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(add_state);
   gtk_table_attach(GTK_TABLE(table10), add_state, 0, 1, 1, 2,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 4, 4);

   remove_state = gtk_button_new_with_label(_("Remove"));
   gtk_widget_ref(remove_state);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "remove_state", remove_state,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(remove_state);
   gtk_table_attach(GTK_TABLE(table10), remove_state, 1, 2, 1, 2,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 4, 4);
   ...
   gtk_entry_set_text(GTK_ENTRY(file), _("new.bits.db"));
   ...
   gtk_notebook_set_tab_label(GTK_NOTEBOOK(properties),
   ...
   content_alignment_h =
      gtk_spin_button_new(GTK_ADJUSTMENT(content_alignment_h_adj), 1, 2);
   gtk_widget_ref(content_alignment_h);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "content_alignment_h",
			    content_alignment_h,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   content_alignment_v =
      gtk_spin_button_new(GTK_ADJUSTMENT(content_alignment_v_adj), 1, 2);
   gtk_widget_ref(content_alignment_v);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "content_alignment_v",
			    content_alignment_v,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   use_contents_h =
      gtk_check_button_new_with_label(_("Use Horizontal Size of Contents"));
   gtk_widget_ref(use_contents_h);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "use_contents_h",
			    use_contents_h,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   use_contents_v =
      gtk_check_button_new_with_label(_("Use Vertical Size of Contents"));
   gtk_widget_ref(use_contents_v);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "use_contents_v",
			    use_contents_v,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "scrolledwindow4",
			    scrolledwindow4,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_table_attach(GTK_TABLE(table2), class_combo, 1, 2, 1, 2,
		    ...
		    (GtkAttachOptions) (0), 0, 0);
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Decoration"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Title_Bar"));
   class_combo_items = g_list_append(class_combo_items, (gpointer) _("Close"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Iconify"));
   ...
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Raise_Lower"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Max_Size"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Full_Screen"));
   ...
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Resize_Horizontal"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Resize_Vertical"));
   ...
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Geometry"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Scrollbar_Trough"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Scrollbar_Bar"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Scrollbar_Arrow1"));
   class_combo_items =
      g_list_append(class_combo_items, (gpointer) _("Scrollbar_Arrow2"));
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "color_class_combo",
			    color_class_combo,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) "");
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Title BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Title FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Border BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Border FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Border Button BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Border Button FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Button BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Button FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Pointer BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Pointer FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Background BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Background FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Selected BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Selected FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Sticky BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Sticky FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Disabled BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Disabled FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("List BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("List FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Menu BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Menu FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Viewport BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Viewport FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Base BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Base FG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Gadget BG"));
   color_class_combo_items =
      g_list_append(color_class_combo_items, (gpointer) _("Gadget FG"));
   gtk_combo_set_popdown_strings(GTK_COMBO(color_class_combo),
				 color_class_combo_items);
   ...
   table7 = gtk_table_new(6, 6, FALSE);
   ...
   gtk_table_attach(GTK_TABLE(table7), border_l, 2, 3, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), border_r, 3, 4, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), label61, 2, 3, 5, 6,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), tile_h_combo, 3, 4, 5, 6,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   tile_h_combo_items =
      g_list_append(tile_h_combo_items, (gpointer) _("Tile Integer"));
   ...
   label72 = gtk_label_new(_("File"));
   gtk_widget_ref(label72);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "label72", label72,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(label72);
   gtk_table_attach(GTK_TABLE(table7), label72, 0, 1, 2, 3,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   gtk_misc_set_alignment(GTK_MISC(label72), 1, 0.5);

   browse_state = gtk_button_new_with_label(_("Browse..."));
   gtk_widget_ref(browse_state);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "browse_state", browse_state,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(browse_state);
   gtk_table_attach(GTK_TABLE(table7), browse_state, 4, 5, 2, 3,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   gtk_widget_set_sensitive(browse_state, FALSE);

   state_entry_ok = gtk_button_new_with_label(_("Ok"));
   gtk_widget_ref(state_entry_ok);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "state_entry_ok",
			    state_entry_ok,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(state_entry_ok);
   gtk_table_attach(GTK_TABLE(table7), state_entry_ok, 5, 6, 2, 3,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), border_t, 4, 5, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), label62, 4, 5, 5, 6,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), border_b, 5, 6, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), tile_v_combo, 5, 6, 5, 6,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   tile_v_combo_items =
      g_list_append(tile_v_combo_items, (gpointer) _("Tile Integer"));
   ...
   states_entry = gtk_entry_new();
   gtk_widget_ref(states_entry);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "states_entry", states_entry,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(states_entry);
   gtk_table_attach(GTK_TABLE(table7), states_entry, 1, 4, 2, 3,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   gtk_widget_set_sensitive(states_entry, FALSE);
   ...
   gtk_table_attach(GTK_TABLE(table7), label41, 0, 2, 4, 5,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), label60, 0, 2, 5, 6,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "scrolledwindow6",
			    scrolledwindow6,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(scrolledwindow6);
   gtk_table_attach(GTK_TABLE(table7), scrolledwindow6, 0, 6, 1, 2,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
   gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(scrolledwindow6),
				  GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);

   states2 = gtk_clist_new(1);
   gtk_widget_ref(states2);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "states2", states2,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(states2);
   gtk_container_add(GTK_CONTAINER(scrolledwindow6), states2);
   gtk_clist_set_column_width(GTK_CLIST(states2), 0, 80);
   gtk_clist_column_titles_hide(GTK_CLIST(states2));

   label73 = gtk_label_new(_("States"));
   gtk_widget_ref(label73);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "label73", label73,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(label73);
   gtk_clist_set_column_widget(GTK_CLIST(states2), 0, label73);

   label74 = gtk_label_new(_("States"));
   gtk_widget_ref(label74);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "label74", label74,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(label74);
   gtk_table_attach(GTK_TABLE(table7), label74, 0, 6, 0, 1,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table7), hseparator7, 0, 6, 3, 4,
		    (GtkAttachOptions) (GTK_FILL),
   ...
   table9 = gtk_table_new(7, 5, FALSE);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_pad_l, 1, 2, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_pad_r, 2, 3, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_pad_t, 3, 4, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_pad_b, 4, 5, 4, 5,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_inset_l, 1, 2, 5, 6,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_inset_r, 2, 3, 5, 6,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_inset_t, 3, 4, 5, 6,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_inset_b, 4, 5, 5, 6,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), label57, 0, 1, 4, 5,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (GTK_FILL), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), label58, 0, 1, 5, 6,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (GTK_FILL), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), label63, 0, 1, 6, 7,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_step_h, 1, 3, 6, 7,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table9), bit_step_v, 3, 5, 6, 7,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);

   label81 = gtk_label_new(_("Pref Size"));
   gtk_widget_ref(label81);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "label81", label81,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(label81);
   gtk_table_attach(GTK_TABLE(table9), label81, 0, 1, 3, 4,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   gtk_misc_set_alignment(GTK_MISC(label81), 0, 0.5);

   bit_pref_h_adj = gtk_adjustment_new(1, 0, 100, 1, 10, 10);
   bit_pref_h = gtk_spin_button_new(GTK_ADJUSTMENT(bit_pref_h_adj), 1, 0);
   gtk_widget_ref(bit_pref_h);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "bit_pref_h", bit_pref_h,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(bit_pref_h);
   gtk_table_attach(GTK_TABLE(table9), bit_pref_h, 1, 3, 3, 4,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);

   bit_pref_v_adj = gtk_adjustment_new(1, 0, 100, 1, 10, 10);
   bit_pref_v = gtk_spin_button_new(GTK_ADJUSTMENT(bit_pref_v_adj), 1, 0);
   gtk_widget_ref(bit_pref_v);
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "bit_pref_v", bit_pref_v,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(bit_pref_v);
   gtk_table_attach(GTK_TABLE(table9), bit_pref_v, 3, 5, 3, 4,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_tooltips_set_tip(tooltips, zoomout, _("Click to zoom out further"),
			NULL);
   gtk_widget_set_events(zoomout,
			 GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK);
   ...
   gtk_notebook_set_tab_label(GTK_NOTEBOOK(themenotebook),
			      gtk_notebook_get_nth_page(GTK_NOTEBOOK
							(themenotebook), 0),
			      guinotebook);
   ...
   gtk_object_set_data_full(GTK_OBJECT(toplevel), "cursornotebook",
			    cursornotebook,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_signal_connect(GTK_OBJECT(toplevel), "delete_event",
		      GTK_SIGNAL_FUNC(on_main_delete_event), NULL);
   gtk_signal_connect(GTK_OBJECT(open1), "activate",
		      GTK_SIGNAL_FUNC(on_open1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(save1), "activate",
		      GTK_SIGNAL_FUNC(on_save1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(save_as1), "activate",
		      GTK_SIGNAL_FUNC(on_save_as1_activate), NULL);
   ...
   gtk_signal_connect(GTK_OBJECT(recent0), "activate",
		      GTK_SIGNAL_FUNC(on_recent0_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(recent1), "activate",
		      GTK_SIGNAL_FUNC(on_recent1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(recent2), "activate",
		      GTK_SIGNAL_FUNC(on_recent2_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(recent3), "activate",
		      GTK_SIGNAL_FUNC(on_recent3_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(recent4), "activate",
		      GTK_SIGNAL_FUNC(on_recent4_activate), NULL);
   ...
   gtk_signal_connect(GTK_OBJECT(delete1), "activate",
		      GTK_SIGNAL_FUNC(on_delete1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(undo1), "activate",
		      GTK_SIGNAL_FUNC(on_undo1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(redo1), "activate",
		      GTK_SIGNAL_FUNC(on_redo1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(about1), "activate",
		      GTK_SIGNAL_FUNC(on_about1_activate), NULL);
   ...
   gtk_signal_connect(GTK_OBJECT(view), "button_release_event",
		      GTK_SIGNAL_FUNC(on_view_button_release_event), NULL);
   gtk_signal_connect(GTK_OBJECT(view), "expose_event",
		      GTK_SIGNAL_FUNC(on_view_expose_event), NULL);
   gtk_signal_connect(GTK_OBJECT(view), "motion_notify_event",
		      GTK_SIGNAL_FUNC(on_view_motion_notify_event), NULL);
   gtk_signal_connect(GTK_OBJECT(view), "configure_event",
		      GTK_SIGNAL_FUNC(on_view_configure_event), NULL);
   gtk_signal_connect(GTK_OBJECT(view), "enter_notify_event",
		      GTK_SIGNAL_FUNC(on_view_enter_notify_event), NULL);
   gtk_signal_connect(GTK_OBJECT(view), "leave_notify_event",
		      GTK_SIGNAL_FUNC(on_view_leave_notify_event), NULL);
   gtk_signal_connect(GTK_OBJECT(new_image), "clicked",
		      GTK_SIGNAL_FUNC(on_new_image_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(new_icon), "clicked",
		      GTK_SIGNAL_FUNC(on_new_icon_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(new_text), "clicked",
		      GTK_SIGNAL_FUNC(on_new_text_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(raise), "clicked",
		      GTK_SIGNAL_FUNC(on_raise_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(lower), "clicked",
		      GTK_SIGNAL_FUNC(on_lower_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(delete), "clicked",
		      GTK_SIGNAL_FUNC(on_delete_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(reset), "clicked",
		      GTK_SIGNAL_FUNC(on_reset_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(prop_apply), "clicked",
		      GTK_SIGNAL_FUNC(on_prop_apply_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(prop_reset), "clicked",
		      GTK_SIGNAL_FUNC(on_prop_reset_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(draft), "toggled",
		      GTK_SIGNAL_FUNC(on_draft_toggled), NULL);
   gtk_signal_connect(GTK_OBJECT(images), "select_row",
		      GTK_SIGNAL_FUNC(on_images_select_row), NULL);
   gtk_signal_connect(GTK_OBJECT(images), "unselect_row",
		      GTK_SIGNAL_FUNC(on_images_unselect_row), NULL);
   gtk_signal_connect(GTK_OBJECT(states), "select_row",
		      GTK_SIGNAL_FUNC(on_states_select_row), NULL);
   gtk_signal_connect(GTK_OBJECT(states), "unselect_row",
		      GTK_SIGNAL_FUNC(on_states_unselect_row), NULL);
   gtk_signal_connect(GTK_OBJECT(add_state), "clicked",
		      GTK_SIGNAL_FUNC(on_add_state_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(remove_state), "clicked",
		      GTK_SIGNAL_FUNC(on_remove_state_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(browse_state), "clicked",
		      GTK_SIGNAL_FUNC(on_browse_state_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(state_entry_ok), "clicked",
		      GTK_SIGNAL_FUNC(on_state_entry_ok_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(states2), "select_row",
		      GTK_SIGNAL_FUNC(on_states2_select_row), NULL);
   gtk_signal_connect(GTK_OBJECT(states2), "unselect_row",
		      GTK_SIGNAL_FUNC(on_states2_unselect_row), NULL);
   gtk_signal_connect(GTK_OBJECT(zoom), "expose_event",
		      GTK_SIGNAL_FUNC(on_zoom_expose_event), NULL);
   gtk_signal_connect(GTK_OBJECT(zoom), "configure_event",
		      GTK_SIGNAL_FUNC(on_zoom_configure_event), NULL);
...
create_filesel(void)
{
   ...
   gtk_signal_connect(GTK_OBJECT(filesel), "delete_event",
		      GTK_SIGNAL_FUNC(on_filesel_delete_event), NULL);
   gtk_signal_connect(GTK_OBJECT(file_ok), "clicked",
		      GTK_SIGNAL_FUNC(on_file_ok_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(file_cancel), "clicked",
		      GTK_SIGNAL_FUNC(on_file_cancel_clicked), NULL);
...
create_render_method(void)
{
   ...
   gtk_object_set_data(GTK_OBJECT(render_method), "render_method",
		       render_method);
   gtk_window_set_title(GTK_WINDOW(render_method),
			_("Select your display method"));
   ...
   gtk_object_set_data(GTK_OBJECT(render_method), "dialog_action_area1",
		       dialog_action_area1);
   ...
   gtk_object_set_data_full(GTK_OBJECT(render_method), "hbuttonbox2",
   ...
   gtk_object_set_data_full(GTK_OBJECT(render_method), "_3d_hardware",
			    _3d_hardware, (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_signal_connect(GTK_OBJECT(software), "clicked",
		      GTK_SIGNAL_FUNC(on_software_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(_3d_hardware), "clicked",
		      GTK_SIGNAL_FUNC(on_3d_hardware_clicked), NULL);
...
create_preferences(void)
{
   ...
   render1 =
      gtk_radio_button_new_with_label(render_group,
				      _
				      ("Use software rendered display method"));
   ...
   render2 =
      gtk_radio_button_new_with_label(render_group,
				      _("Use 3D accelerated display method"));
   ...
   label64 =
      gtk_label_new(_
		    ("If you change your display preferences you will\nhave to restart Etcher for them to take effect."));
   ...
   zoom1 =
      gtk_radio_button_new_with_label(zoom_group,
				      _
				      ("Use smooth zoom display\n(use pixmaps for zooming)"));
   ...
   zoom2 =
      gtk_radio_button_new_with_label(zoom_group,
				      _
				      ("Zoom directly in the framebuffer\n(If you use Xinerama select this)"));
   ...
   gtk_tooltips_set_tip(tooltips, entry1,
			_("The image used to tile in the background"), NULL);
   ...
   gtk_tooltips_set_tip(tooltips, button2,
			_
			("Select an Image file to tile as a background patterm"),
			NULL);
   ...
   gtk_object_set_data(GTK_OBJECT(preferences), "dialog_action_area2",
		       dialog_action_area2);
   ...
   gtk_signal_connect(GTK_OBJECT(preferences), "delete_event",
		      GTK_SIGNAL_FUNC(on_preferences_delete_event), NULL);
   gtk_signal_connect(GTK_OBJECT(pref_da), "expose_event",
		      GTK_SIGNAL_FUNC(on_pref_da_expose_event), NULL);
   gtk_signal_connect(GTK_OBJECT(entry1), "changed",
		      GTK_SIGNAL_FUNC(on_gridimage_changed), NULL);
   gtk_signal_connect(GTK_OBJECT(button2), "clicked",
		      GTK_SIGNAL_FUNC(on_selectimage_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(button1), "clicked",
		      GTK_SIGNAL_FUNC(on_tintcolor_button_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(ok), "clicked",
		      GTK_SIGNAL_FUNC(on_ok_clicked), NULL);
...
GtkWidget          *
create_add_state(void)
{
   GtkWidget          *add_state;
   GtkWidget          *table11;
   GtkWidget          *add_state_entry;
   GtkWidget          *label68;
   GtkWidget          *hbuttonbox4;
   GtkWidget          *add_state_ok;
   GtkWidget          *add_state_cancel;
   GtkTooltips        *tooltips;

   tooltips = gtk_tooltips_new();

   add_state = gtk_window_new(GTK_WINDOW_TOPLEVEL);
   gtk_object_set_data(GTK_OBJECT(add_state), "add_state", add_state);
   gtk_window_set_title(GTK_WINDOW(add_state), _("Add State"));

   table11 = gtk_table_new(3, 2, FALSE);
   gtk_widget_ref(table11);
   gtk_object_set_data_full(GTK_OBJECT(add_state), "table11", table11,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(table11);
   gtk_container_add(GTK_CONTAINER(add_state), table11);

   add_state_entry = gtk_entry_new();
   gtk_widget_ref(add_state_entry);
   gtk_object_set_data_full(GTK_OBJECT(add_state), "add_state_entry",
			    add_state_entry,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(add_state_entry);
   gtk_table_attach(GTK_TABLE(table11), add_state_entry, 0, 2, 1, 2,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 5, 5);

   label68 = gtk_label_new(_("State Name"));
   gtk_widget_ref(label68);
   gtk_object_set_data_full(GTK_OBJECT(add_state), "label68", label68,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(label68);
   gtk_table_attach(GTK_TABLE(table11), label68, 0, 2, 0, 1,
		    (GtkAttachOptions) (GTK_FILL),
   ...
   gtk_object_set_data_full(GTK_OBJECT(add_state), "hbuttonbox4", hbuttonbox4,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(hbuttonbox4);
   gtk_table_attach(GTK_TABLE(table11), hbuttonbox4, 0, 2, 2, 3,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   gtk_button_box_set_layout(GTK_BUTTON_BOX(hbuttonbox4), GTK_BUTTONBOX_END);
   gtk_button_box_set_spacing(GTK_BUTTON_BOX(hbuttonbox4), 12);
   gtk_button_box_set_child_ipadding(GTK_BUTTON_BOX(hbuttonbox4), 0, 0);

   add_state_ok = gtk_button_new_with_label(_("Add"));
   gtk_widget_ref(add_state_ok);
   gtk_object_set_data_full(GTK_OBJECT(add_state), "add_state_ok", add_state_ok,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(add_state_ok);
   gtk_container_add(GTK_CONTAINER(hbuttonbox4), add_state_ok);
   GTK_WIDGET_SET_FLAGS(add_state_ok, GTK_CAN_DEFAULT);
   gtk_tooltips_set_tip(tooltips, add_state_ok,
			_("Add state name to the ebits."), NULL);

   add_state_cancel = gtk_button_new_with_label(_("Cancel"));
   gtk_widget_ref(add_state_cancel);
   gtk_object_set_data_full(GTK_OBJECT(add_state), "add_state_cancel",
			    add_state_cancel,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(add_state_cancel);
   gtk_container_add(GTK_CONTAINER(hbuttonbox4), add_state_cancel);
   GTK_WIDGET_SET_FLAGS(add_state_cancel, GTK_CAN_DEFAULT);
   gtk_tooltips_set_tip(tooltips, add_state_cancel, _("Cancel"), NULL);

   gtk_signal_connect(GTK_OBJECT(add_state), "delete_event",
		      GTK_SIGNAL_FUNC(on_add_state_delete_event), NULL);
   gtk_signal_connect(GTK_OBJECT(add_state_ok), "clicked",
		      GTK_SIGNAL_FUNC(on_add_state_ok_clicked), NULL);
   gtk_signal_connect(GTK_OBJECT(add_state_cancel), "clicked",
		      GTK_SIGNAL_FUNC(on_add_state_cancel_clicked), NULL);

   gtk_widget_grab_focus(add_state_entry);
   gtk_object_set_data(GTK_OBJECT(add_state), "tooltips", tooltips);
...
create_window1(void)
{
   ...
   gtk_window_set_title(GTK_WINDOW(window1), _("Etcher"));

   table12 = gtk_table_new(3, 1, FALSE);
   gtk_widget_ref(table12);
   gtk_object_set_data_full(GTK_OBJECT(window1), "table12", table12,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(table12);
   gtk_container_add(GTK_CONTAINER(window1), table12);

   menubar2 = gtk_menu_bar_new();
   gtk_widget_ref(menubar2);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menubar2", menubar2,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menubar2);
   gtk_table_attach(GTK_TABLE(table12), menubar2, 0, 1, 0, 1,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);

   menuitem21 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem21)->child),
				   _("_File"));
   gtk_widget_add_accelerator(menuitem21, "activate_item", accel_group,
			      tmp_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
   gtk_widget_ref(menuitem21);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem21", menuitem21,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem21);
   gtk_container_add(GTK_CONTAINER(menubar2), menuitem21);

   menu3 = gtk_menu_new();
   gtk_widget_ref(menu3);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menu3", menu3,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_menu_item_set_submenu(GTK_MENU_ITEM(menuitem21), menu3);
   menu3_accels = gtk_menu_ensure_uline_accel_group(GTK_MENU(menu3));

   menuitem22 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem22)->child),
				   _("_Open..."));
   gtk_widget_add_accelerator(menuitem22, "activate_item", menu3_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem22);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem22", menuitem22,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem22);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem22);
   gtk_widget_add_accelerator(menuitem22, "activate", accel_group,
			      GDK_o, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem23 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem23)->child),
				   _("_Save"));
   gtk_widget_add_accelerator(menuitem23, "activate_item", menu3_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem23);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem23", menuitem23,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem23);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem23);
   gtk_widget_add_accelerator(menuitem23, "activate", accel_group,
			      GDK_s, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem24 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem24)->child),
				   _("Save _As..."));
   gtk_widget_add_accelerator(menuitem24, "activate_item", menu3_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem24);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem24", menuitem24,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem24);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem24);
   gtk_widget_add_accelerator(menuitem24, "activate", accel_group,
			      GDK_s, GDK_CONTROL_MASK | GDK_SHIFT_MASK,
			      GTK_ACCEL_VISIBLE);

   menuitem25 = gtk_menu_item_new();
   gtk_widget_ref(menuitem25);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem25", menuitem25,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem25);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem25);
   gtk_widget_set_sensitive(menuitem25, FALSE);

   menuitem26 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem26)->child),
				   _("_Preferences..."));
   gtk_widget_add_accelerator(menuitem26, "activate_item", menu3_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem26);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem26", menuitem26,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem26);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem26);

   menuitem27 = gtk_menu_item_new();
   gtk_widget_ref(menuitem27);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem27", menuitem27,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem27);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem27);
   gtk_widget_set_sensitive(menuitem27, FALSE);

   menuitem28 = gtk_menu_item_new_with_label(_("item2"));
   gtk_widget_ref(menuitem28);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem28", menuitem28,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem28);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem28);
   gtk_widget_add_accelerator(menuitem28, "activate", accel_group,
			      GDK_1, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem29 = gtk_menu_item_new_with_label(_("item3"));
   gtk_widget_ref(menuitem29);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem29", menuitem29,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem29);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem29);
   gtk_widget_add_accelerator(menuitem29, "activate", accel_group,
			      GDK_2, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem30 = gtk_menu_item_new_with_label(_("item4"));
   gtk_widget_ref(menuitem30);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem30", menuitem30,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem30);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem30);
   gtk_widget_add_accelerator(menuitem30, "activate", accel_group,
			      GDK_3, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem31 = gtk_menu_item_new_with_label(_("item5"));
   gtk_widget_ref(menuitem31);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem31", menuitem31,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem31);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem31);
   gtk_widget_add_accelerator(menuitem31, "activate", accel_group,
			      GDK_4, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem32 = gtk_menu_item_new_with_label(_("item6"));
   gtk_widget_ref(menuitem32);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem32", menuitem32,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem32);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem32);
   gtk_widget_add_accelerator(menuitem32, "activate", accel_group,
			      GDK_5, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem33 = gtk_menu_item_new();
   gtk_widget_ref(menuitem33);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem33", menuitem33,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem33);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem33);
   gtk_widget_set_sensitive(menuitem33, FALSE);

   menuitem34 = gtk_menu_item_new_with_label(_("Exit"));
   gtk_widget_ref(menuitem34);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem34", menuitem34,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem34);
   gtk_container_add(GTK_CONTAINER(menu3), menuitem34);

   menuitem35 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem35)->child),
				   _("_Edit"));
   gtk_widget_add_accelerator(menuitem35, "activate_item", accel_group,
			      tmp_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
   gtk_widget_ref(menuitem35);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem35", menuitem35,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem35);
   gtk_container_add(GTK_CONTAINER(menubar2), menuitem35);

   menu4 = gtk_menu_new();
   gtk_widget_ref(menu4);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menu4", menu4,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_menu_item_set_submenu(GTK_MENU_ITEM(menuitem35), menu4);
   menu4_accels = gtk_menu_ensure_uline_accel_group(GTK_MENU(menu4));

   menuitem36 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem36)->child),
				   _("_Delete"));
   gtk_widget_add_accelerator(menuitem36, "activate_item", menu4_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem36);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem36", menuitem36,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   menuitem37 = gtk_menu_item_new();
   gtk_widget_ref(menuitem37);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem37", menuitem37,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem37);
   gtk_container_add(GTK_CONTAINER(menu4), menuitem37);
   gtk_widget_set_sensitive(menuitem37, FALSE);

   menuitem38 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem38)->child),
				   _("_Undo"));
   gtk_widget_add_accelerator(menuitem38, "activate_item", menu4_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem38);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem38", menuitem38,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem38);
   gtk_container_add(GTK_CONTAINER(menu4), menuitem38);
   gtk_widget_add_accelerator(menuitem38, "activate", accel_group,
			      GDK_z, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem39 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem39)->child),
				   _("_Redo"));
   gtk_widget_add_accelerator(menuitem39, "activate_item", menu4_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem39);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem39", menuitem39,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem39);
   gtk_container_add(GTK_CONTAINER(menu4), menuitem39);
   gtk_widget_add_accelerator(menuitem39, "activate", accel_group,
			      GDK_r, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

   menuitem40 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem40)->child),
				   _("_Help"));
   gtk_widget_add_accelerator(menuitem40, "activate_item", accel_group,
			      tmp_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
   gtk_widget_ref(menuitem40);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem40", menuitem40,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem40);
   gtk_container_add(GTK_CONTAINER(menubar2), menuitem40);
   gtk_menu_item_right_justify(GTK_MENU_ITEM(menuitem40));

   menu5 = gtk_menu_new();
   gtk_widget_ref(menu5);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menu5", menu5,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_menu_item_set_submenu(GTK_MENU_ITEM(menuitem40), menu5);
   menu5_accels = gtk_menu_ensure_uline_accel_group(GTK_MENU(menu5));

   menuitem41 = gtk_menu_item_new_with_label("");
   tmp_key = gtk_label_parse_uline(GTK_LABEL(GTK_BIN(menuitem41)->child),
				   _("_About"));
   gtk_widget_add_accelerator(menuitem41, "activate_item", menu5_accels,
			      tmp_key, 0, 0);
   gtk_widget_ref(menuitem41);
   gtk_object_set_data_full(GTK_OBJECT(window1), "menuitem41", menuitem41,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(menuitem41);
   gtk_container_add(GTK_CONTAINER(menu5), menuitem41);

   statusbar4 = gtk_statusbar_new();
   gtk_widget_ref(statusbar4);
   gtk_object_set_data_full(GTK_OBJECT(window1), "statusbar4", statusbar4,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(statusbar4);
   gtk_table_attach(GTK_TABLE(table12), statusbar4, 0, 1, 2, 3,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table12), notebook2, 0, 1, 1, 2,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 5, 5);

   table13 = gtk_table_new(3, 3, FALSE);
   gtk_widget_ref(table13);
   gtk_object_set_data_full(GTK_OBJECT(window1), "table13", table13,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(table13);
   gtk_container_add(GTK_CONTAINER(notebook2), table13);

   label80 = gtk_label_new(_("Filename"));
   gtk_widget_ref(label80);
   gtk_object_set_data_full(GTK_OBJECT(window1), "label80", label80,
			    (GtkDestroyNotify) gtk_widget_unref);
   gtk_widget_show(label80);
   gtk_table_attach(GTK_TABLE(table13), label80, 0, 1, 0, 1,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 0, 0);
   ...
   gtk_table_attach(GTK_TABLE(table13), entry2, 1, 2, 0, 1,
		    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
		    (GtkAttachOptions) (0), 7, 5);
   ...
   gtk_table_attach(GTK_TABLE(table13), button3, 2, 3, 0, 1,
		    (GtkAttachOptions) (GTK_FILL),
		    (GtkAttachOptions) (0), 5, 0);

   label77 = gtk_label_new(_("File"));
   gtk_widget_ref(label77);
   gtk_object_set_data_full(GTK_OBJECT(window1), "label77", label77,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_object_set_data_full(GTK_OBJECT(window1), "label78", label78,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_object_set_data_full(GTK_OBJECT(window1), "label79", label79,
			    (GtkDestroyNotify) gtk_widget_unref);
   ...
   gtk_signal_connect(GTK_OBJECT(menuitem22), "activate",
		      GTK_SIGNAL_FUNC(on_open1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem23), "activate",
		      GTK_SIGNAL_FUNC(on_save1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem24), "activate",
		      GTK_SIGNAL_FUNC(on_save_as1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem26), "activate",
		      GTK_SIGNAL_FUNC(on_preferences1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem28), "activate",
		      GTK_SIGNAL_FUNC(on_recent0_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem29), "activate",
		      GTK_SIGNAL_FUNC(on_recent1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem30), "activate",
		      GTK_SIGNAL_FUNC(on_recent2_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem31), "activate",
		      GTK_SIGNAL_FUNC(on_recent3_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem32), "activate",
		      GTK_SIGNAL_FUNC(on_recent4_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem34), "activate",
		      GTK_SIGNAL_FUNC(on_exit1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem36), "activate",
		      GTK_SIGNAL_FUNC(on_delete1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem38), "activate",
		      GTK_SIGNAL_FUNC(on_undo1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem39), "activate",
		      GTK_SIGNAL_FUNC(on_redo1_activate), NULL);
   gtk_signal_connect(GTK_OBJECT(menuitem41), "activate",
		      GTK_SIGNAL_FUNC(on_about1_activate), NULL);
