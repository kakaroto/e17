...
view_scroll_info(gpointer data)
{
   ...
   if (!o_info1)
	...
	o_info4 = evas_add_text(splash_evas, "nationff", 20, 
...
void show_splash(Evas evas, gint *idle, GtkFunction redraw_func)
{
  ...
  o_logo = evas_add_image_from_file(splash_evas, PACKAGE_DATA_DIR"/pixmaps/etcher.png");
