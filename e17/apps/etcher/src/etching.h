...
int                      etching_get_current_state(Etching *e);
void                     etching_set_current_state(Etching *e, int state);
Ebits_Object_Bit_State   etching_get_selected_item(Etching *e);
void                     etching_set_selected_item(Etching *e, Ebits_Object_Bit_State item);
