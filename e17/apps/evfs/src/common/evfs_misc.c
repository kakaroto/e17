...
int evfs_file_path_compare(evfs_filereference* file1, evfs_filereference* file2) {
...
Ecore_List* evfs_file_list_sort(Ecore_List* file_list) {
    ...
    */
   heap = ecore_sheap_new(ECORE_COMPARE_CB(evfs_file_path_compare), ecore_list_nodes(file_list));
