...
Ecore_List *
add_list(Ecore_List *list, char *tmp)
{
   int i, r;
   char *name;
   ...
   i = 0;
   r = 0;
   if (!ecore_list_nodes(list))
      ecore_list_prepend(list, tmp);
