 ...
 * of bytes.
 */
void entranced_md5_update(Entranced_MD5_Context *ctx, unsigned char const *buf, unsigned len)
{
    u_int32_t t;
 ...
 */
void entranced_md5_final(unsigned char digest[16], Entranced_MD5_Context *ctx)
{
    unsigned count;
    unsigned char *p;
 ...
 */
void entranced_md5_transform(u_int32_t buf[4], u_int32_t const in[16])
{
