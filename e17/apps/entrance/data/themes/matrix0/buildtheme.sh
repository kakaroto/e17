...
edb_ed $DB add /entrance/welcome/font/name str "swissbc.ttf"
...
edb_ed $DB add /entrance/passwd/font/name str "swissbc.ttf"
...
edb_ed $DB add /entrance/entry/font/name str "abadi.ttf"
...
edb_ed $DB add /entrance/date/font/name str "abadi.ttf"
...
edb_ed $DB add /entrance/time/font/name str "abadi.ttf"
