...
void ewl_list_file_paste_cb(Ewl_Widget *w , void *ev_data , void *user_data ) {
	Ecore_List* selected;
	entropy_generic_file* file;
...
void ewl_list_file_copy_cb(Ewl_Widget *w , void *ev_data , void *user_data ) {
...
void icon_properties_cb(Ewl_Widget *w , void *ev_data , void *user_data ) {
	...
	gui_file* local_file = ecore_hash_get( viewer->icon_hash, EWL_ICONBOX(viewer->list)->select_icon);
