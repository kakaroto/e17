...
void
esmart_text_entry_edje_part_set(Evas_Object * o, Evas_Object * edje, char *part)
{
   Esmart_Text_Entry *e = NULL;
...
esmart_text_entry_smart_get(void)
{
   ...
   s = evas_smart_new("Text Entry", esmart_text_entry_add, esmart_text_entry_del,
                      esmart_text_entry_layer_set, esmart_text_entry_raise,
                      esmart_text_entry_lower, esmart_text_entry_stack_above,
