...
void
e_dbus_request_name(DBusConnection *conn, const char *name, unsigned int flags, E_DBus_Method_Return_Cb cb_return, E_DBus_Error_Cb cb_error, void *data)
{
  DBusMessage *msg;
...
void
e_dbus_release_name(DBusConnection *conn, const char *name, E_DBus_Method_Return_Cb cb_return, E_DBus_Error_Cb cb_error, void *data)
{
  DBusMessage *msg;
