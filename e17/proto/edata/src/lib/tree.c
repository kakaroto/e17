 ...
 */
EAPI int edata_tree_init(Edata_Tree *new_tree, Edata_Compare_Cb compare_func)
{
...
EAPI int edata_tree_node_destroy(Edata_Tree_Node *node,
		Edata_Free_Cb value_free, Edata_Free_Cb key_free)
{
 ...
 */
static int tree_for_each_node(Edata_Tree_Node * node,
		Edata_For_Each for_each_func, void *user_data)
{
	CHECK_PARAM_POINTER_RETURN("node", node, FALSE);
