...
etk "etk_button_new_with_label \"Bash Owns\""
BUTTON=$RESULT

# create another button + label and save the result
etk "etk_button_new_with_label \"Bash Rules\""
BUTTON2=$RESULT

# create a vertical box and save the result
etk "etk_vbox_new $ETK_FALSE 0"
VBOX=$RESULT
...
etk "etk_progress_bar_new"
PBAR=$RESULT
etk "etk_progress_bar_text_set $PBAR \"Downloading...\""

# create another button + label and save the result
etk "etk_button_new_with_label \"Get Text\""
BUTTON3=$RESULT
