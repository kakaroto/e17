...
void 
ew_notice_button_add(Entrance_Dialog ew, const char *name, int response_id, void (*response_event)(void *, void *), void *data)
{
	Etk_Widget *btn = etk_dialog_button_add(ETK_DIALOG(ew->owner), name, response_id);
	if(response_event)
		etk_signal_connect("clicked", ETK_OBJECT(btn), ETK_CALLBACK(response_event), data);
}

void 
ew_notice_close_button_add(Entrance_Dialog ew, void (*response_event)(void *, void *), void *data)
{
	ew_notice_button_add(ew, _("Close"), EW_NOTICE_CLOSE_BUTTON, response_event, data);
}

void 
ew_notice_apply_button_add(Entrance_Dialog ew, void (*response_event)(void *, void *), void *data)
{
	ew_notice_button_add(ew, _("Apply"), EW_NOTICE_APPLY_BUTTON, response_event, data);
}

void 
ew_notice_ok_button_add(Entrance_Dialog ew, void (*response_event)(void *, void *), void *data)
{
	ew_notice_button_add(ew, _("Ok"), EW_NOTICE_OK_BUTTON, response_event, data);
}

void
ew_notice_yes_button_add(Entrance_Dialog ew, void (*response_event)(void *, void *), void *data) {
	ew_notice_button_add(ew, _("Yes"), EW_NOTICE_YES_BUTTON, response_event, data);
}

void
ew_notice_no_button_add(Entrance_Dialog ew, void (*response_event)(void *, void *), void *data) {
	ew_notice_button_add(ew, _("No"), EW_NOTICE_NO_BUTTON, response_event, data);
}

void
ew_notice_cancel_button_add(Entrance_Dialog ew, void (*response_event)(void *, void *), void *data) {
