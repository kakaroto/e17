                            ...
                            else if (!strncmp(cur_end,"font",4))
			      {
				     ...
				     etox_color_set_member(cur_text_color, "fg",  
							   ...
							   color.b, color.a);
                                 ...
                                 etox_color_set_member(cur_text_color,
"ol",  
							   color.r, color.g,  
							   color.b, color.a);
                                   }
                       ...
                       else
                         {
                            ...
                            if (!strncmp(cur_end,"style",5))          
                              ...
                              {  
                                 cb = etox_color_get_bit(e->color, "fg");
                                 etox_color_set_member(cur_text_color, "fg",
                                                       cb->r, cb->g,
                                                       cb->b, cb->a);
                              }                                  
                              ...
                              {                                    
                                 cb = etox_color_get_bit(e->color, "sh");    
                                 etox_color_set_member(cur_text_color, "sh",
                                                       cb->r, cb->g,
                                                       cb->b, cb->a);
                              }                                  
                              ...
                              { 
                                 cb = etox_color_get_bit(e->color, "ol");    
        ...
        if (!(cur_end || cur_beg) || (last_token == 1))
          {
             ...
             if (cur_line)
               {
                  last_line_height = dump_line(cur_line, cur_line_bit_count, e,
                                               cur_align, cur_vertical_align, 
                                               cur_line[0]->x, cur_w);
                  free(cur_line);
                  cur_line = NULL;
                  cur_line_bit_count = 0; 
