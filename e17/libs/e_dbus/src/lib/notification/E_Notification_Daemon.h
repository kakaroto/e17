...
/* daemon */
E_Notification_Daemon *e_notification_daemon_add(const char *name, const char *vendor);
...
void  e_notification_daemon_data_set(E_Notification_Daemon *daemon, void *data);
void *e_notification_daemon_data_get(E_Notification_Daemon *daemon);

void e_notification_daemon_callback_notify_set(E_Notification_Daemon *daemon, E_Notification_Daemon_Callback_Notify func);
void e_notification_daemon_callback_close_notification_set(E_Notification_Daemon *daemon, E_Notification_Daemon_Callback_Close_Notification func);


void e_notification_daemon_signal_notification_closed(E_Notification_Daemon *daemon, unsigned int id, E_Notification_Closed_Reason reason);
void e_notification_daemon_signal_action_invoked(E_Notification_Daemon *daemon, unsigned int notification_id, const char *action_id);
