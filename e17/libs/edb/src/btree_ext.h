...
int __bam_pgin __P((edb_pgno_t, void *, DBT *));
int __bam_pgout __P((edb_pgno_t, void *, DBT *));
int __bam_mswap __P((PAGE *));
int __bam_cprint __P((DB *));
int __bam_ca_delete __P((DB *, edb_pgno_t, u_int32_t, int));
void __bam_ca_di __P((DB *, edb_pgno_t, u_int32_t, int));
void __bam_ca_dup __P((DB *,
   edb_pgno_t, u_int32_t, u_int32_t, edb_pgno_t, u_int32_t));
void __bam_ca_rsplit __P((DB *, edb_pgno_t, edb_pgno_t));
void __bam_ca_split __P((DB *,
   edb_pgno_t, edb_pgno_t, edb_pgno_t, u_int32_t, int));
...
int __bam_lget
   __P((DBC *, int, edb_pgno_t, edb_lockmode_t, DB_LOCK *));
int __bam_iitem __P((DBC *,
   PAGE **, edb_indx_t *, DBT *, DBT *, u_int32_t, u_int32_t));
...
void __ram_ca __P((DB *, edb_recno_t, ca_recno_arg));
int __ram_getno __P((DBC *, const DBT *, edb_recno_t *, int));
int __bam_rsearch __P((DBC *, edb_recno_t *, u_int32_t, int, int *));
int __bam_adjust __P((DBC *, int32_t));
int __bam_nrecs __P((DBC *, edb_recno_t *));
edb_recno_t __bam_total __P((PAGE *));
int __bam_search __P((DBC *,
    const DBT *, u_int32_t, int, edb_recno_t *, int *));
...
int __bam_split_log
    ...
    DB_LSN *, u_int32_t, edb_pgno_t, DB_LSN *,
    const DBT *));
...
int __bam_rsplit_log
    __P((DB_LOG *, DB_TXN *, DB_LSN *, u_int32_t,
    u_int32_t, edb_pgno_t, const DBT *, edb_pgno_t,
    const DBT *, DB_LSN *));
...
int __bam_adj_log
    __P((DB_LOG *, DB_TXN *, DB_LSN *, u_int32_t,
    u_int32_t, edb_pgno_t, DB_LSN *, u_int32_t,
    u_int32_t, u_int32_t));
int __bam_adj_print
   __P((DB_LOG *, DBT *, DB_LSN *, int, void *));
