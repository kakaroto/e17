...
#ifndef lint
static const char sccsid[] = "@(#)edb_salloc.c	10.14 (Sleepycat) 11/16/98";
#endif /* not lint */
 ...
 *
 * PUBLIC: void __edb_shalloc_init __P((void *, size_t));
 */
void
__edb_shalloc_init(area, size)
	void *area;
	size_t size;
{
	struct __data *elp;
 ...
 *
 * PUBLIC: int __edb_shalloc __P((void *, size_t, size_t, void *));
 */
int
__edb_shalloc(p, len, align, retp)
	void *p, *retp;
	size_t len, align;
{
	struct __data *elp;
 ...
 *
 * PUBLIC: void __edb_shalloc_free __P((void *, void *));
 */
void
__edb_shalloc_free(regionp, ptr)
	void *regionp, *ptr;
{
 ...
 *
 * PUBLIC: size_t __edb_shalloc_count __P((void *));
 */
size_t
__edb_shalloc_count(addr)
	void *addr;
{
	struct __data *elp;
	size_t count;
 ...
 *
 * PUBLIC: size_t __edb_shsizeof __P((void *));
 */
size_t
__edb_shsizeof(ptr)
	void *ptr;
 ...
 * __edb_shalloc_dump --
 *
 * PUBLIC: void __edb_shalloc_dump __P((void *, FILE *));
 */
void
__edb_shalloc_dump(addr, fp)
	void *addr;
	FILE *fp;
{
	struct __data *elp;
