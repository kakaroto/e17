...
MAINTAINERCLEANFILES = INSTALL Makefile.in aclocal.m4 config.guess 		config.h.in config.sub configure install-sh loaderpath.h 		ltconfig ltmain.sh missing mkinstalldirs stamp-h.in
...
imlib2: $(imlib2_OBJECTS) $(imlib2_DEPENDENCIES)
	@rm -f imlib2
	$(LINK) $(imlib2_LDFLAGS) $(imlib2_OBJECTS) $(imlib2_LDADD) $(LIBS)
...
uninstall-am: uninstall-pkgLTLIBRARIES uninstall-binPROGRAMS
...
installdirs-am:
	$(mkinstalldirs)  $(DESTDIR)$(pkgdir) $(DESTDIR)$(bindir)
...
mostlyclean-am:  mostlyclean-hdr mostlyclean-pkgLTLIBRARIES \
...
clean-am:  clean-hdr clean-pkgLTLIBRARIES clean-compile clean-libtool \
		clean-binPROGRAMS clean-tags clean-depend clean-generic \
		mostlyclean-am

clean: clean-recursive

distclean-am:  distclean-hdr distclean-pkgLTLIBRARIES distclean-compile \
...
mostlyclean-pkgLTLIBRARIES distclean-pkgLTLIBRARIES \
