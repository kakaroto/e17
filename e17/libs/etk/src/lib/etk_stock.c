...
static const Etk_Stock_Item _etk_stock_items[] =
{
   ...
   { "actions/edit-select-all_16", "actions/edit-select-all_22", "actions/edit-select-all_48", "Select All" },            
   { "actions/folder-new_16", "actions/folder-new_22", "actions/folder-new_48", "" },   
   ...
   { "actions/list-add_16", "actions/list-add_22", "actions/list-add_48", "" },   
   { "actions/list-remove_16", "actions/list-remove_22", "actions/list-remove_48", "" },      
   { "actions/mail-message-new_16", "actions/mail-message-new_22", "actions/mail-message-new_48", "" },
   { "actions/mail-forward_16", "actions/mail-forward_22", "actions/mail-forward_48", "" },   
   { "actions/mail-mark-junk_16", "actions/mail-mark-junk_22", "actions/mail-mark-junk_48", "" },   
   { "actions/mail-reply-all_16", "actions/mail-reply-all_22", "actions/mail-reply-all_48", "" },      
   { "actions/mail-reply-sender_16", "actions/mail-reply-sender_22", "actions/mail-reply-sender_48", "" },      
   { "actions/mail-send-receive_16", "actions/mail-send-receive_22", "actions/mail-send-receive_48", "" },         
   { "actions/media-eject_16", "actions/media-eject_22", "actions/media-eject_48", "" },   
   ...
   { "actions/system-lock-screen_16", "actions/system-lock-screen_22", "actions/system-lock-screen_48", "" },
   ...
   { "categories/preferences-desktop-locale_16", "categories/preferences-desktop-locale_22", "categories/preferences-desktop-locale_48", "" },
