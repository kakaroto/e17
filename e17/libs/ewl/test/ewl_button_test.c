...
__create_button_test_window(Ewl_Widget * w, void *ev_data, void *user_data)
{
	...
	ewl_container_append_child(EWL_CONTAINER(button_win), button[0]);
	...
	ewl_container_append_child(EWL_CONTAINER(button_win), button[1]);
	...
	ewl_container_append_child(EWL_CONTAINER(button_win), separator[0]);
	...
	ewl_container_append_child(EWL_CONTAINER(button_win),
				   check_button[0]);
	...
	ewl_container_append_child(EWL_CONTAINER(button_win), separator[1]);
