...
__create_combo_test_window(Ewl_Widget * w, void *ev_data, void *user_data)
{
	...
	ewl_window_set_title(EWL_WINDOW(combo_win), "Combo Test");
	ewl_window_set_name(EWL_WINDOW(combo_win), "EWL Test Application");
	ewl_window_set_class(EWL_WINDOW(combo_win), "EFL Test Application");
