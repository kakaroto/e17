...
static double timeout = 0.5;
static double start_val = 100.0;
...
create_about_dialog(void)
{
	...
	ewl_window_set_title(about_dialog.window, "EWL Glow Plugin: About");
...
unload(void)
{
	...
	glow.fx_cont = NULL;
	glow.fx_stop = NULL;
	glow.modifies = EWL_FX_MODIFIES_NONE;
	glow.name = NULL;
}
