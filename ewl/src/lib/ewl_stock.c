...
struct
{
        ...
        const char * const tooltip;
                ...
                {"Flip horizontal", EWL_ICON_OBJECT_FLIP_HORIZONTAL,  "Flip horizontal"},
                {"Flip vertical",  EWL_ICON_OBJECT_FLIP_VERTICAL,     "Flip vertical"},
                ...
                {"Rotate left",    EWL_ICON_OBJECT_ROTATE_LEFT,       "Rotate left"},
                {"Rotate right",   EWL_ICON_OBJECT_ROTATE_RIGHT,      "Rotate right"},
