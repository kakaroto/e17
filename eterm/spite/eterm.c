...
create_contexts(void)
{
  ...
  ic_background = (Imageclass *)malloc(sizeof(Imageclass));
  ic_trough =  (Imageclass *)malloc(sizeof(Imageclass));
  ic_anchor = (Imageclass *)malloc(sizeof(Imageclass));
  ic_thumb = (Imageclass *)malloc(sizeof(Imageclass));
  ic_up_arrow= (Imageclass *)malloc(sizeof(Imageclass));
  ic_down_arrow = (Imageclass *)malloc(sizeof(Imageclass));
  ic_menu = (Imageclass *)malloc(sizeof(Imageclass));
  ic_submenu = (Imageclass *)malloc(sizeof(Imageclass));
  ic_button_bar = (Imageclass *)malloc(sizeof(Imageclass));
  ic_button = (Imageclass *)malloc(sizeof(Imageclass));
