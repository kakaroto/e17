...
void calendar_face_prev_year(void *data, Evas *e, Evas_Object *obj, void *event_info);
void calendar_face_next_year(void *data, Evas *e, Evas_Object *obj, void *event_info);
void calendar_face_next_month(void *data, Evas *e, Evas_Object *obj, void *event_info);
void calendar_face_prev_month(void *data, Evas *e, Evas_Object *obj, void *event_info);
...
void calendar_face_cb_mouse_down(void *data, Evas *e, Evas_Object *obj, void *event_info);
void calendar_face_cb_gmc_change(void *data, E_Gadman_Client *gmc, E_Gadman_Change change);
