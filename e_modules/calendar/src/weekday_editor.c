...
_basic_create_widgets(E_Config_Dialog *cfd, Evas *evas, void *data)
{
   ...
   Evas_Object *wd_today;
    weekday = e_widget_framelist_add(evas, _("Weekday"),1);
    wd_today = e_widget_table_add(evas, 0);
    e_widget_table_object_append(wd_today, e_widget_label_add(evas, _("Red:")),0,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(wd_today, e_widget_label_add(evas, _("Blue:")),2,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(wd_today,e_widget_label_add(evas, _("Green:")),0,1,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(wd_today,e_widget_label_add(evas, _("Alpha:")),2,1,1,1,0,0,0,0);
...
// weekday Font colors
    ...
    weekday_f = e_widget_framelist_add(evas, _("Weekday Font"),1);
    e_widget_table_object_append(tablef_wd, e_widget_label_add(evas,_("Red:")),0,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_wd,e_widget_label_add(evas, _("Blue:")),2,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_wd,e_widget_label_add(evas,_("Green:")),0,1,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_wd,e_widget_label_add(evas,_("Alpha:")),2,1,1,1,0,0,0,0);
...
_color_edit_advanced_create_widgets(E_Config_Dialog *cfd, Evas *evas, void *data)
{
   ...
   Evas_Object *o,*weekday;
   Evas_Object *slider_red, *slider_green, *slider_alpha, *slider_blue;
   Evas_Object *s_r_tf, *s_g_tf, *s_a_tf, *s_b_tf, *s_r_tf_o, *s_b_tf_o, *s_g_tf_o, *s_a_tf_o, *s_r_tf_s, *s_b_tf_s, *s_g_tf_s, *s_a_tf_s, *weekday_f ;
...
// weekday Font colors
  ...
  e_widget_table_object_append(tablef_wd, e_widget_label_add(evas,
