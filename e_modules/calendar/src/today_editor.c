...
_basic_create_widgets(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *data)
{
   ...
   c_array *TBC_Ptr = data->calendar->conf->Today_s_back_colors->data;
   c_array *TTC_Ptr = data->calendar->conf->Today_s_text_colors->data;
   ...
   today = e_widget_framelist_add(evas, D_("Today"), 1);
   table_today = e_widget_table_add(evas, 0);
   e_widget_table_object_append(table_today, e_widget_label_add(evas, D_("Red:")), 0, 0, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(table_today, e_widget_label_add(evas, D_("Blue:")), 2, 0, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(table_today, e_widget_label_add(evas, D_("Green:")), 0, 1, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(table_today, e_widget_label_add(evas, D_("Alpha:")), 2, 1, 1, 1, 0, 0, 0, 0);
   ...
   today_f = e_widget_framelist_add(evas, D_("Today Font"), 1);
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("Red:")), 0, 0, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("Blue:")), 2, 0, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("Green:")), 0, 1, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("Alpha:")), 2, 1, 1, 1, 0, 0, 0, 0);
...
_color_edit_advanced_create_widgets(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *data)
{
   ...
   Evas_Object *s_r_tf, *s_g_tf, *s_a_tf, *s_b_tf, *s_r_tf_o, *s_b_tf_o,
      *s_g_tf_o, *s_a_tf_o, *s_r_tf_s, *s_b_tf_s, *s_g_tf_s, *s_a_tf_s, *today_f;
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("R Outline:")), 0, 2, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("B Outline:")), 2, 2, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("G Outline:")), 0, 3, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("A Outline:")), 2, 3, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("R Shadow:")), 0, 4, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("B Shadow:")), 2, 4, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("G Shadow:")), 0, 5, 1, 1, 0, 0, 0, 0);
   ...
   e_widget_table_object_append(tablef_today, e_widget_label_add(evas, D_("A Shadow:")), 2, 5, 1, 1, 0, 0, 0, 0);
