...
_basic_create_widgets(E_Config_Dialog * cfd, Evas * evas, void *data)
{
   ...
   c_array            *TBC_Ptr =
       cfdata->calendar->conf->Today_s_back_colors->data;
   c_array            *TTC_Ptr =
       cfdata->calendar->conf->Today_s_text_colors->data;
   ...
   e_widget_table_object_append(table_today,
                                e_widget_label_add(evas, _("Red:")), 0, 0, 1, 1,
                                0, 0, 0, 0);
   slider_red =
       e_widget_slider_add(evas, 1, 0, _("%1.0f"), 0, 254, 1, 0, NULL,
                           &(TBC_Ptr->red), 60);
   e_widget_table_object_append(table_today, slider_red, 1, 0, 1, 1, 0, 0, 0,
                                0);
   e_widget_table_object_append(table_today,
   ...
   slider_blue =
       e_widget_slider_add(evas, 1, 0, _("%1.0f"), 0, 254, 1, 0, NULL,
                           &(TBC_Ptr->blue), 60);
   e_widget_table_object_append(table_today, slider_blue, 3, 0, 1, 1, 0, 0, 0,
                                0);
   e_widget_table_object_append(table_today,
   ...
   slider_green =
       e_widget_slider_add(evas, 1, 0, _("%1.0f"), 0, 254, 1, 0, NULL,
                           &(TBC_Ptr->green), 60);
   e_widget_table_object_append(table_today, slider_green, 1, 1, 1, 1, 0, 0, 0,
                                0);
   e_widget_table_object_append(table_today,
   ...
   slider_alpha =
       e_widget_slider_add(evas, 1, 0, _("%1.0f"), 0, 254, 1, 0, NULL,
                           &(TBC_Ptr->alpha), 60);
   e_widget_table_object_append(table_today, slider_alpha, 3, 1, 1, 1, 0, 0, 0,
                                0);
   ...
   e_widget_table_object_append(tablef_today,
                                e_widget_label_add(evas, _("Red:")), 0, 0, 1, 1,
                                0, 0, 0, 0);
   s_r_tf =
       e_widget_slider_add(evas, 1, 0, _("%1.0f"), 0, 254, 1, 0, NULL,
