...
//set weekday colors
	for (x = 0; x<35;x++)
	{
              edje_object_color_class_set(face->weekday_object[x]->obj,"day_colors",WdBC_Ptr->red,
                  WdBC_Ptr->green,   WdBC_Ptr->blue,  WdBC_Ptr->alpha,  WdBC_Ptr->red_o,
                  WdBC_Ptr->green_o, WdBC_Ptr->blue_o,WdBC_Ptr->alpha_o,WdBC_Ptr->red_s,
                  WdBC_Ptr->green_s, WdBC_Ptr->blue_s,WdBC_Ptr->alpha_s);

              edje_object_color_class_set(face->weekday_object[x]->obj,"text_colors",WdTC_Ptr->red,
                  WdTC_Ptr->green,   WdTC_Ptr->blue,  WdTC_Ptr->alpha,  WdTC_Ptr->red_o,
                  WdTC_Ptr->green_o, WdTC_Ptr->blue_o,WdTC_Ptr->alpha_o,WdTC_Ptr->red_s,
...
//Set weekend colors
	for (x = 0; x<35;x++)
	{
             edje_object_color_class_set(face->weekend_object[x]->obj,"text_colors",WeTC_Ptr->red,
                  WeTC_Ptr->green,   WeTC_Ptr->blue,  WeTC_Ptr->alpha,  WeTC_Ptr->red_o,
                  WeTC_Ptr->green_o, WeTC_Ptr->blue_o,WeTC_Ptr->alpha_o,WeTC_Ptr->red_s,
                  WeTC_Ptr->green_s, WeTC_Ptr->blue_s,WeTC_Ptr->alpha_s);

              edje_object_color_class_set(face->weekend_object[x]->obj,"day_colors",WeBC_Ptr->red,
                  WeBC_Ptr->green,   WeBC_Ptr->blue,  WeBC_Ptr->alpha,  WeBC_Ptr->red_o,
                  WeBC_Ptr->green_o, WeBC_Ptr->blue_o,WeBC_Ptr->alpha_o,WeBC_Ptr->red_s,
                  WeBC_Ptr->green_s, WeBC_Ptr->blue_s,WeBC_Ptr->alpha_s);
	}
//Set Today colors
	for (x = 0; x<35;x++)
	{
       	   edje_object_color_class_set(face->today_object[x]->obj,"text_colors",TTC_Ptr->red,
             TTC_Ptr->green,   TTC_Ptr->blue,  TTC_Ptr->alpha,  TTC_Ptr->red_o,
             TTC_Ptr->green_o, TTC_Ptr->blue_o,TTC_Ptr->alpha_o,TTC_Ptr->red_s,
             TTC_Ptr->green_s, TTC_Ptr->blue_s,TTC_Ptr->alpha_s);

           edje_object_color_class_set(face->today_object[x]->obj,"day_colors",TBC_Ptr->red,
             TBC_Ptr->green,   TBC_Ptr->blue,  TBC_Ptr->alpha,  TBC_Ptr->red_o,
             TBC_Ptr->green_o, TBC_Ptr->blue_o,TBC_Ptr->alpha_o,TBC_Ptr->red_s,
             TBC_Ptr->green_s, TBC_Ptr->blue_s,TBC_Ptr->alpha_s);
	}
//Set Label colors
        edje_object_color_class_set(face->label_object,"YearMonth_colors",
	     YNC_Ptr->red,  YNC_Ptr->green,   YNC_Ptr->blue,  YNC_Ptr->alpha,
