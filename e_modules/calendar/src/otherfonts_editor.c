...
_basic_create_widgets(E_Config_Dialog *cfd, Evas *evas, void *data)
{
   ...
   o = e_widget_table_add(evas, 0);
    ...
    e_widget_table_object_append(tablef_ym, e_widget_label_add(evas,_("Red:")),0,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_ym,e_widget_label_add(evas, _("Blue:")),2,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_ym,e_widget_label_add(evas,_("Green:")),0,1,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_ym,e_widget_label_add(evas,_("Alpha:")),2,1,1,1,0,0,0,0);
...
//////////////////////////////////////////////////////////////////////////////
    ...
    e_widget_table_object_append(tablef_day, e_widget_label_add(evas,_("Red:")),0,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_day,e_widget_label_add(evas, _("Blue:")),2,0,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_day,e_widget_label_add(evas,_("Green:")),0,1,1,1,0,0,0,0);
    ...
    e_widget_table_object_append(tablef_day,e_widget_label_add(evas,_("Alpha:")),2,1,1,1,0,0,0,0);
...
_color_edit_advanced_create_widgets(E_Config_Dialog *cfd, Evas *evas, void *data)
{
   /* generate the core widget layout for a basic dialog */
   Evas_Object *o;
   Evas_Object *s_r_tf, *s_g_tf, *s_a_tf, *s_b_tf, *s_r_tf_o, *s_b_tf_o, *s_g_tf_o, *s_a_tf_o, *s_r_tf_s, *s_b_tf_s, *s_g_tf_s, *s_a_tf_s;
   Evas_Object *ym, *day_text;
...
//////////////////////////////////////////////////////////////////////////////
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas,_("R Out:")),0,2,1,1,0,0,0,0);
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas, _("B Out:")),2,2,1,1,0,0,0,0);
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas, _("G Out:")),0,3,1,1,0,0,0,0);
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas, _("A Out:")),2,3,1,1,0,0,0,0);
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas, _("R Shad:")),0,4,1,1,0,0,0,0);
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas, _("B Shad:")),2,4,1,1,0,0,0,0);
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas, _("G Shad:")),0,5,1,1,0,0,0,0);
   ...
   e_widget_table_object_append(tablef_day, e_widget_label_add(evas, _("A Shad:")),2,5,1,1,0,0,0,0);
