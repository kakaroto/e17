...
//Store fonts
   ...
   if (!calendar->conf)
   {
	...
	calendar->conf->TopImage_path=(char *)evas_stringshare_add(PACKAGE_DATA_DIR"/topimage.edj");
	calendar->conf->Background_path=(char *)evas_stringshare_add(PACKAGE_DATA_DIR"/backimage.edj");
	calendar->conf->today_path = (char *)evas_stringshare_add(PACKAGE_DATA_DIR"/today.edj");
	calendar->conf->weekend_path = (char *)evas_stringshare_add(PACKAGE_DATA_DIR"/weekend.edj");
	calendar->conf->weekday_path = (char *)evas_stringshare_add(PACKAGE_DATA_DIR"/weekday.edj");
	calendar->conf->label_path = (char *)evas_stringshare_add(PACKAGE_DATA_DIR"/label.edj");
	calendar->conf->arrow_path = (char *)evas_stringshare_add(PACKAGE_DATA_DIR"/arrow.edj");
	calendar->conf->ConfigFile_path = "";	

        calendar->conf->Today_s_text_colors = evas_list_append(calendar->conf->Today_s_text_colors, Temp_Ptr);
        calendar->conf->Today_s_back_colors = evas_list_append(calendar->conf->Today_s_back_colors, Temp_Ptr1);
        calendar->conf->Weekend_text_colors = evas_list_append(calendar->conf->Weekend_text_colors, Temp_Ptr2);
        calendar->conf->Weekend_back_colors = evas_list_append(calendar->conf->Weekend_back_colors, Temp_Ptr3);
        calendar->conf->WeekDay_text_colors = evas_list_append(calendar->conf->WeekDay_text_colors, Temp_Ptr4);
        calendar->conf->WeekDay_back_colors = evas_list_append(calendar->conf->WeekDay_back_colors, Temp_Ptr5);
        calendar->conf->YearMon_numb_colors = evas_list_append(calendar->conf->YearMon_numb_colors, Temp_Ptr6);
        calendar->conf->DayWeek_text_colors = evas_list_append(calendar->conf->DayWeek_text_colors, Temp_Ptr7);

	calendar->conf->YM_text_class = evas_list_append(calendar->conf->YM_text_class, Temp_ClassPtr);
	calendar->conf->Day_text_class = evas_list_append(calendar->conf->Day_text_class, Temp_ClassPtr1);
	calendar->conf->text_class = evas_list_append(calendar->conf->text_class, Temp_ClassPtr2);
...
//Add Timer
   calendar->date_check_timer = ecore_timer_add(60, _date_cb_check,calendar);
   return calendar;
}
/***************************************************
...
_date_cb_check(void *data)
{
   ...
   else
   {
	...
	set_day_label(face->label_object,calendar->conf->DayofWeek_Start, date.tm_mon,
                                                                         date.tm_year);
      }
   } 
   return 1;
