...
static void _mbar_bar_motion_handle (MBar_Bar * mbb, Evas_Coord mx,
				     Evas_Coord my);
...
static void _mbar_bar_cb_gmc_change (void *data, E_Gadman_Client * gmc,
				     E_Gadman_Change change);
static void _mbar_bar_cb_intercept_move (void *data, Evas_Object * o,
					 Evas_Coord x, Evas_Coord y);
static void _mbar_bar_cb_intercept_resize (void *data, Evas_Object * o,
					   Evas_Coord w, Evas_Coord h);
static void _mbar_bar_cb_mouse_in (void *data, Evas * e, Evas_Object * obj,
				   void *event_info);
static void _mbar_bar_cb_mouse_out (void *data, Evas * e, Evas_Object * obj,
				    void *event_info);
static void _mbar_bar_cb_mouse_down (void *data, Evas * e, Evas_Object * obj,
				     void *event_info);
static void _mbar_bar_cb_mouse_up (void *data, Evas * e, Evas_Object * obj,
				   void *event_info);
static void _mbar_bar_cb_mouse_move (void *data, Evas * e, Evas_Object * obj,
				     void *event_info);
...
static void _mbar_icon_cb_intercept_move (void *data, Evas_Object * o,
					  Evas_Coord x, Evas_Coord y);
static void _mbar_icon_cb_intercept_resize (void *data, Evas_Object * o,
					    Evas_Coord w, Evas_Coord h);
static void _mbar_icon_cb_mouse_in (void *data, Evas * e, Evas_Object * obj,
				    void *event_info);
static void _mbar_icon_cb_mouse_out (void *data, Evas * e, Evas_Object * obj,
				     void *event_info);
static void _mbar_icon_cb_mouse_down (void *data, Evas * e, Evas_Object * obj,
				      void *event_info);
static void _mbar_icon_cb_mouse_up (void *data, Evas * e, Evas_Object * obj,
				    void *event_info);
static void _mbar_icon_cb_mouse_move (void *data, Evas * e, Evas_Object * obj,
				      void *event_info);
...
static void _mbar_bar_cb_menu_configure (void *data, E_Menu * m,
					 E_Menu_Item * mi);
static void _mbar_drag_cb_intercept_move (void *data, Evas_Object * o,
					  Evas_Coord x, Evas_Coord y);
static void _mbar_drag_cb_intercept_resize (void *data, Evas_Object * o,
					    Evas_Coord w, Evas_Coord h);
  ...
  if (!mb->conf)
    {
      ...
      snprintf (buf, sizeof (buf), "%s/.e/e/applications/%s", getenv ("HOME"),
		mb->conf->appdir);
      ...
      for (l2 = man->containers; l2; l2 = l2->next)
	{
	  ...
	  if (mbb)
	      ...
	      if (!cl)
		{
		  ...
		  mbb->conf->enabled = 1;
		  mb->conf->bars =
		    evas_list_append (mb->conf->bars, mbb->conf);
		}
	      else
		{
		  mbb->conf = cl->data;
...
_mbar_free (MBar * mb)
{
  ...
  if (mb->conf->appdir)
    evas_stringshare_del (mb->conf->appdir);
...
_mbar_bar_new (MBar * mb, E_Container * con)
{
  ...
  if (!e_theme_edje_object_set
      (o, "base/theme/modules/mbar", "modules/mbar/main"))
    {
  ...
  if (mbb->mbar->conf->follower)
    {
      ...
      if (!e_theme_edje_object_set
	  (o, "base/theme/modules/mbar", "modules/mbar/follower"))
	{
	  snprintf (buf, sizeof (buf), PACKAGE_DATA_DIR "/mbar.edj");
  ...
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_IN,
				  _mbar_bar_cb_mouse_in, mbb);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_OUT,
				  _mbar_bar_cb_mouse_out, mbb);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_DOWN,
				  _mbar_bar_cb_mouse_down, mbb);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_UP,
				  _mbar_bar_cb_mouse_up, mbb);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_MOVE,
				  _mbar_bar_cb_mouse_move, mbb);
  evas_object_show (o);

  o = e_box_add (mbb->evas);
  mbb->box_object = o;
  evas_object_intercept_move_callback_add (o, _mbar_bar_cb_intercept_move,
					   mbb);
  evas_object_intercept_resize_callback_add (o, _mbar_bar_cb_intercept_resize,
					     mbb);
  e_box_freeze (o);
  ...
  o = edje_object_add (mbb->evas);
  if (!e_theme_edje_object_set
      (o, "base/theme/modules/mbar", "modules/mbar/icon"))
    {
      snprintf (buf, sizeof (buf), PACKAGE_DATA_DIR "/mbar.edj");
  ...
  mbb->drop_handler = e_drop_handler_add (mbb,
					  ...
					  _mbar_bar_cb_move,
					  _mbar_bar_cb_leave,
					  _mbar_bar_cb_drop, drop, 1,
					  mbb->x + mbb->bar_inset.l,
					  mbb->y + mbb->bar_inset.t,
					  mbb->w - (mbb->bar_inset.l +
						    mbb->bar_inset.r),
					  mbb->h - (mbb->bar_inset.t +
						    mbb->bar_inset.b));

  mbb->gmc = e_gadman_client_new (mbb->con->gadman);
  e_gadman_client_domain_set (mbb->gmc, "module.mbar", bar_count++);
  policy =
    E_GADMAN_POLICY_EDGES | E_GADMAN_POLICY_HMOVE | E_GADMAN_POLICY_VMOVE;
...
_mbar_icon_new (MBar_Bar * mbb, E_App * a)
{
  ...
  evas_object_repeat_events_set (o, 1);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_IN,
				  _mbar_icon_cb_mouse_in, ic);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_OUT,
				  _mbar_icon_cb_mouse_out, ic);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_DOWN,
				  _mbar_icon_cb_mouse_down, ic);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_UP,
				  _mbar_icon_cb_mouse_up, ic);
  evas_object_event_callback_add (o, EVAS_CALLBACK_MOUSE_MOVE,
				  _mbar_icon_cb_mouse_move, ic);
  evas_object_show (o);

  o = edje_object_add (mbb->evas);
  ic->bg_object = o;
  evas_object_intercept_move_callback_add (o, _mbar_icon_cb_intercept_move,
					   ic);
  evas_object_intercept_resize_callback_add (o,
					     _mbar_icon_cb_intercept_resize,
					     ic);
  if (!e_theme_edje_object_set
      (o, "base/theme/modules/mbar", "modules/mbar/icon"))
    {
  ...
  o = edje_object_add (mbb->evas);
  ic->icon_object = o;
  evas_object_resize (o, mbb->mbar->conf->iconsize,
		      mbb->mbar->conf->iconsize);
  ...
  evas_object_intercept_resize_callback_add (o,
					     ...
					     ic);
  if (!e_theme_edje_object_set
      (o, "base/theme/modules/mbar", "modules/mbar/icon_overlay"))
    {
      snprintf (buf, sizeof (buf), PACKAGE_DATA_DIR "/mbar.edj");
...
_mbar_icon_free (MBar_Icon * ic)
{
  ...
  if (ic->bg_object)
    evas_object_del (ic->bg_object);
  if (ic->overlay_object)
    evas_object_del (ic->overlay_object);
  if (ic->icon_object)
    evas_object_del (ic->icon_object);
  if (ic->event_object)
    evas_object_del (ic->event_object);
  while (ic->extra_icons)
    {
      ...
      ic->extra_icons =
	evas_list_remove_list (ic->extra_icons, ic->extra_icons);
      evas_object_del (o);
    }
...
_mbar_icon_reorder_before (MBar_Icon * ic, MBar_Icon * before)
{
  ...
  if (before)
    {
      ic->mbb->icons =
	evas_list_prepend_relative (ic->mbb->icons, ic, before);
      e_box_pack_before (ic->mbb->box_object, ic->bg_object,
			 before->bg_object);
    }
  else
    {
...
_mbar_icon_reorder_after (MBar_Icon * ic, MBar_Icon * after)
{
  ...
  w =
    ic->mbb->mbar->conf->iconsize + ic->mbb->icon_inset.l +
    ic->mbb->icon_inset.r;
  h =
    ic->mbb->mbar->conf->iconsize + ic->mbb->icon_inset.t +
    ic->mbb->icon_inset.b;
  e_box_pack_options_set (ic->bg_object, 1, 1,	/* fill */
			  0, 0,	/* expand */
			  0.5, 0.5,	/* align */
...
_mbar_bar_frame_resize (MBar_Bar * mbb)
{
  ...
  if ((mbb->x == -1) || (mbb->y == -1) || (mbb->w == -1) || (mbb->h == -1))
    return;
...
_mbar_bar_edge_change (MBar_Bar * mbb, int edge)
{
  ...
  else if ((edge == E_GADMAN_EDGE_LEFT) || (edge == E_GADMAN_EDGE_RIGHT))
    {
...
_mbar_bar_motion_handle (MBar_Bar * mbb, Evas_Coord mx, Evas_Coord my)
{
  ...
  if (w > 0)
    relx = (double) (mx - x) / (double) w;
  else
    relx = 0.0;
  if (h > 0)
    rely = (double) (my - y) / (double) h;
  else
    rely = 0.0;
...
static void
_mbar_icon_cb_intercept_move (void *data, Evas_Object * o, Evas_Coord x,
			      Evas_Coord y)
{
  MBar_Icon *ic;
...
static void
_mbar_icon_cb_intercept_resize (void *data, Evas_Object * o, Evas_Coord w,
				Evas_Coord h)
{
  MBar_Icon *ic;
...
static void
_mbar_bar_cb_intercept_move (void *data, Evas_Object * o, Evas_Coord x,
			     Evas_Coord y)
{
  MBar_Bar *mbb;
...
static void
_mbar_bar_cb_intercept_resize (void *data, Evas_Object * o, Evas_Coord w,
			       Evas_Coord h)
{
  MBar_Bar *mbb;
...
static void
_mbar_icon_cb_mouse_in (void *data, Evas * e, Evas_Object * obj,
			void *event_info)
{
...
static void
_mbar_icon_cb_mouse_out (void *data, Evas * e, Evas_Object * obj,
			 void *event_info)
{
...
static void
_mbar_icon_cb_mouse_down (void *data, Evas * e, Evas_Object * obj,
			  void *event_info)
{
...
static void
_mbar_icon_cb_mouse_up (void *data, Evas * e, Evas_Object * obj,
			void *event_info)
{
  ...
  if (ev->button == 1)
      ...
      if (!drag)
	{
	  _mbar_exe_exit_handler =
	    ecore_event_handler_add (ECORE_EXE_EVENT_DEL, _mbar_exe_cb_exit,
				     NULL);
#ifdef HAVE_LINUX
...
static void
_mbar_icon_cb_mouse_move (void *data, Evas * e, Evas_Object * obj,
			  void *event_info)
{
  ...
  if (drag_start)
	  ...
	  (e_config->drag_resist * e_config->drag_resist))
	{
	  ...
	  evas_object_geometry_get (ic->icon_object, &x, &y, &w, &h);
	  d =
	    e_drag_new (ic->mbb->con, x, y, drag_types, 1, ic->app, -1,
			_mbar_bar_cb_finished);
	  ...
	  evas_event_feed_mouse_up (ic->mbb->evas, 1, EVAS_BUTTON_NONE,
				    ev->timestamp, NULL);
	  e_app_remove (ic->app);
	}
    }
...
static void
_mbar_bar_cb_mouse_in (void *data, Evas * e, Evas_Object * obj,
		       void *event_info)
{
  Evas_Event_Mouse_In *ev;
  MBar_Bar *mbb;
...
static void
_mbar_bar_cb_mouse_out (void *data, Evas * e, Evas_Object * obj,
			void *event_info)
{
  Evas_Event_Mouse_Out *ev;
  MBar_Bar *mbb;
...
static void
_mbar_bar_cb_mouse_down (void *data, Evas * e, Evas_Object * obj,
			 void *event_info)
{
  Evas_Event_Mouse_Down *ev;
  MBar_Bar *mbb;
...
static void
_mbar_bar_cb_mouse_up (void *data, Evas * e, Evas_Object * obj,
		       void *event_info)
{
  Evas_Event_Mouse_Up *ev;
  MBar_Bar *mbb;
...
static void
_mbar_bar_cb_mouse_move (void *data, Evas * e, Evas_Object * obj,
			 void *event_info)
{
  Evas_Event_Mouse_Move *ev;
  MBar_Bar *mbb;
...
_mbar_bar_cb_timer (void *data)
{
  ...
  if (dif < 0)
    dif = -dif;
  if (dif < 0.001)
    mbb->align = mbb->align_req;

  dif2 = mbb->follow - mbb->follow_req;
  if (dif2 < 0)
    dif2 = -dif2;
  if (dif2 < 0.001)
    mbb->follow = mbb->follow_req;
...
_mbar_bar_cb_animator (void *data)
{
  ...
  if ((e_gadman_client_edge_get (mbb->gmc) == E_GADMAN_EDGE_BOTTOM)
      ...
      if (mbb->overlay_object)
	{
	  ...
	  evas_object_move (mbb->overlay_object,
			    x + (w * mbb->follow) - (mw / 2), y);
	}
    }
  else if ((e_gadman_client_edge_get (mbb->gmc) == E_GADMAN_EDGE_LEFT) ||
	   (e_gadman_client_edge_get (mbb->gmc) == E_GADMAN_EDGE_RIGHT))
      ...
      if (mbb->overlay_object)
	{
	  ...
	  evas_object_move (mbb->overlay_object, x,
			    y + (h * mbb->follow) - (mh / 2));
	}
    }
  if (mbb->timer)
...
_mbar_bar_cb_enter (void *data, const char *type, void *event)
{
  ...
  evas_object_intercept_move_callback_add (o, _mbar_drag_cb_intercept_move,
					   o2);
  evas_object_intercept_resize_callback_add (o,
					     _mbar_drag_cb_intercept_resize,
					     o2);
  if (!e_theme_edje_object_set
      (o, "base/theme/modules/mbar", "modules/mbar/drop"))
    {
      snprintf (buf, sizeof (buf), PACKAGE_DATA_DIR "/mbar.edj");
      edje_object_file_set (o, buf, "modules/mbar/drop");
    }
  if (!e_theme_edje_object_set
      (o2, "base/theme/modules/mbar", "modules/mbar/drop_overlay"))
    {
      snprintf (buf, sizeof (buf), PACKAGE_DATA_DIR "/mbar.edj");
      edje_object_file_set (o2, buf, "modules/mbar/drop_overlay");
    }
  edje_object_signal_emit (o, "set_orientation",
			   _mbar_main_orientation[e_gadman_client_edge_get
						  (mbb->gmc)]);
  ...
  w = mbb->mbar->conf->iconsize + mbb->icon_inset.l + mbb->icon_inset.r;
  h = mbb->mbar->conf->iconsize + mbb->icon_inset.t + mbb->icon_inset.b;
  e_box_pack_options_set (mbb->drag_object, 1, 1,	/* fill */
			  0, 0,	/* expand */
			  0.5, 0.5,	/* align */
			  w, h,	/* min */
			  w, h	/* max */
...
static void
_mbar_bar_cb_gmc_change (void *data, E_Gadman_Client * gmc,
			 E_Gadman_Change change)
{
  MBar_Bar *mbb;
  ...
  switch (change)
    ...
    case E_GADMAN_CHANGE_MOVE_RESIZE:
      e_gadman_client_geometry_get (mbb->gmc, &mbb->x, &mbb->y, &mbb->w,
				    &mbb->h);
...
_mbar_bar_cb_follower (void *data)
{
  ...
  if (enabled)
      ...
      for (l = mb->bars; l; l = l->next)
	{
	  ...
	  edje_object_signal_emit (o, "set_orientation",
				   _mbar_main_orientation
				   [e_gadman_client_edge_get (mbb->gmc)]);
	  edje_object_message_signal_process (o);
...
_mbar_bar_cb_iconsize_change (void *data)
{
  ...
  for (l = mb->bars; l; l = l->next)
      ...
      for (ll = mbb->icons; ll; ll = ll->next)
	{
	  ...
	  w =
	    mbb->mbar->conf->iconsize + mbb->icon_inset.l + mbb->icon_inset.r;
	  h =
	    mbb->mbar->conf->iconsize + mbb->icon_inset.t + mbb->icon_inset.b;
	  e_box_pack_options_set (ic->bg_object, 1, 1,	/* fill */
				  0, 0,	/* expand */
				  0.5, 0.5,	/* align */
				  w, h,	/* min */
...
static void
_mbar_drag_cb_intercept_move (void *data, Evas_Object * o, Evas_Coord x,
			      Evas_Coord y)
{
  evas_object_move (o, x, y);
...
static void
_mbar_drag_cb_intercept_resize (void *data, Evas_Object * o, Evas_Coord w,
				Evas_Coord h)
{
  evas_object_resize (o, w, h);
...
_mbar_exe_cb_exit (void *data, int type, void *event)
{
  ...
  if (!strcmp (tag, "Unmount"))
    {
      if (mounted)
	e_module_dialog_show (NULL, _("Mount Bar Module"),
			      _("Unmount Failed."));
    }
  ...
  *s = 0;
  for (; fgets (s, sizeof (s), f);)
      ...
      if (u)
	{
	  ...
	  snprintf (path, sizeof (path), "%s/.e/e/applications/%s/%s.eap",
		    getenv ("HOME"), mb->conf->appdir, basename (info[0]));
	  if (!ecore_file_exists (path))
	    {
	      ...
	      a->image =
		evas_stringshare_add (PACKAGE_DATA_DIR "/module_icon.png");
	      a->startup_notify = 1;
	      e_app_fields_save (a);
...
static void
_mbar_mtab_update (void *data, Ecore_File_Monitor * monitor,
		   Ecore_File_Event event, const char *path)
{
  MBar *mb;
  Evas_List *l, *il;
