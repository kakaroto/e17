...
static int
_e_eap_edit_basic_apply_data (E_Config_Dialog * cfd,
			      E_Config_Dialog_Data * data)
{
  App_Edit *editor;
  E_App *eap;
...
static Evas_Object *
_e_eap_edit_basic_create_widgets (E_Config_Dialog * cfd, Evas * evas,
				  E_Config_Dialog_Data * data)
{
  App_Edit *editor;
  E_App *eap;
  ...
  editor->img_widget =
    e_widget_iconsel_add (evas, editor->img, 48, 48, &(data->image));
  ...
  e_widget_frametable_object_append (o, editor->img_widget, 0, 0, 1, 1, 1, 1,
				     1, 1);
  e_widget_table_object_append (ol, o, 0, 0, 1, 1, 1, 1, 1, 1);

  o = e_widget_frametable_add (evas, _("General"), 0);
  e_widget_frametable_object_append (o,
				     e_widget_label_add (evas, _("Device")),
				     0, 0, 1, 1, 1, 1, 1, 1);
  ...
  e_widget_frametable_object_append (o, e_widget_label_add (evas, _("Label")),
				     0, 2, 1, 1, 1, 1, 1, 1);
  e_widget_frametable_object_append (o,
				     e_widget_entry_add (evas,
							 &(data->comment)), 1,
				     2, 1, 1, 1, 1, 1, 1);
  e_widget_frametable_object_append (o,
				     e_widget_label_add (evas, _("Execute")),
				     0, 3, 1, 1, 1, 1, 1, 1);
  e_widget_frametable_object_append (o,
				     e_widget_entry_add (evas, &(data->exe)),
				     1, 3, 1, 1, 1, 1, 1, 1);
