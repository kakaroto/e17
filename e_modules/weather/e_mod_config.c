		       ...
		       E_Config_Dialog_Data * cfdata)
{
  ...
  of = e_widget_frametable_add(evas, D_("Yahoo Weather Code"), 0);
  ob = e_widget_label_add(evas, D_("Yahoo Weather Code/US Zip Code"));
  ...
  ob = e_widget_label_add(evas, D_("Get your Yahoo Weather Code code at:"));
