   ...
   if (emu_face)
     {
        ...
        if ((!e_theme_edje_object_set(o, "base/theme/modules/emu_gadcon", "modules/emu_gadcon/main")) /*&& (_emu_module_edje)*/)
           edje_object_file_set(o, (char *)_emu_module_edje, "modules/emu_gadcon/main");
