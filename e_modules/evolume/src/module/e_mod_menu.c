...
static void _volume_cb_menu_edit(void *data, E_Menu* mn __UNUSED__,
...
static void _volume_remove_face_cb(void *data, E_Menu* mn __UNUSED__,
		E_Menu_Item* mi __UNUSED__)
{
	Volume_Face *face;
	Volume		*volume;
...
/* Orient callbacks */
static void _volume_orient_horiz_cb(void *data, E_Menu* mn __UNUSED__,
		E_Menu_Item* mi __UNUSED__)
{
	Volume_Face* face;
//	int w, h;
...
static void _volume_orient_vert_cb(void *data, E_Menu* mn __UNUSED__,
		E_Menu_Item* mi __UNUSED__)
{
	Volume_Face* face;
//	int w, h;
...
static void _volume_cb_configure(void *data, E_Menu* mn __UNUSED__,
		E_Menu_Item* mi __UNUSED__)
{
