...
Mixer_Slider *e_volume_slider_create(Mixer_Elem *melem, Evas *ev, int balance, int orient, Volume_Face *face, int ref);

Mixer_Slider *e_volume_slider_create_from_conf(Config_Mixer_Elem *conf, Volume_Face *face, int ref);
