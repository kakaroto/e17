...
static void  _ci_fill_data(Config_Item *ci, E_Config_Dialog_Data *cfdata);
static void *_ci_create_data(E_Config_Dialog *cfd);
static void _ci_free_data(E_Config_Dialog *cfd, E_Config_Dialog_Data *cfdata);
static Evas_Object *_ci_basic_create_widgets(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *cfdata);
static int _ci_basic_apply_data(E_Config_Dialog *cfd, E_Config_Dialog_Data *cfdata);
...
static int
_ci_basic_apply_data(E_Config_Dialog *cfd, E_Config_Dialog_Data *cfdata)
{
   Config_Item *ci;
